...
class RequirementsNotFound(SmartHubError):
...
async def async_process_requirements(
    hass: SmartHub, name: str, requirements: list[str]
) -> None:
...
async def async_load_installed_versions(
    hass: SmartHub, requirements: set[str]
) -> None:
...
def _async_get_manager(hass: SmartHub) -> RequirementsManager:
    """Get the requirements manager."""
    return RequirementsManager(hass)


@callback
def async_clear_install_history(hass: SmartHub) -> None:
