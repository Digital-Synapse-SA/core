...
from smarthub.const import CONF_HOST, CONF_ID, CONF_PORT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: AirzoneConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AirzoneConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: AirzoneConfigEntry) -> bool:
