...
from smarthub.core import CALLBACK_TYPE, Event, SmartHub
...
class QbusControllerCoordinator(DataUpdateCoordinator[list[QbusMqttOutput]]):
    ...
    def __init__(self, hass: SmartHub, entry: QbusConfigEntry) -> None:
...
class QbusConfigCoordinator:
    ...
    @classmethod
    def get_or_create(cls, hass: SmartHub) -> QbusConfigCoordinator:
