...
from smarthub.components.mqtt import async_wait_for_mqtt_client
...
async def async_setup_entry(hass: SmartHub, entry: QbusConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: QbusConfigEntry) -> bool:
...
def _cleanup(hass: SmartHub, entry: QbusConfigEntry) -> None:
