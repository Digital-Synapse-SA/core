...
from smarthub.config_entries import SOURCE_REAUTH, ConfigFlowResult, OptionsFlow
...
class OAuth2FlowHandler(
    ...
    Web Auth is the preferred method by SmartHub and Google, and a benefit
    is that the same credentials may be used across many Google integrations in
    SmartHub. Web Auth is now easier for user to setup using my.smart-hub.io
    redirect urls.
