...
from smarthub.components.application_credentials import AuthImplementation
...
class GoogleHybridAuth(AuthImplementation):
    ...
    async def async_resolve_external_data(self, external_data: Any) -> dict:
        """Resolve a Google API Credentials object to SmartHub token."""
...
async def async_create_device_flow(
    hass: SmartHub, client_id: str, client_secret: str, access: FeatureAccess
) -> DeviceFlow:
