...
from smarthub.components.ffmpeg import (
...
from smarthub.components.ffmpeg_motion.binary_sensor import FFmpegBinarySensor
...
class FFmpegNoise(FFmpegBinarySensor[ffmpeg_sensor.SensorNoise]):
    ...
    def __init__(
        self, hass: SmartHub, manager: FFmpegManager, config: dict[str, Any]
    ) -> None:
