...
async def async_setup_entry(hass: SmartHub, entry: UpnpConfigEntry) -> bool:
    ...
    async def update_listener(hass: SmartHub, entry: UpnpConfigEntry):
...
async def async_unload_entry(hass: SmartHub, entry: UpnpConfigEntry) -> bool:
