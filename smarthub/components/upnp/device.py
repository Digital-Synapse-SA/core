"""SmartHub representation of an UPnP/IGD."""
...
async def async_get_mac_address_from_host(hass: SmartHub, host: str) -> str | None:
...
async def async_create_device(
    hass: SmartHub, location: str, force_poll: bool
) -> Device:
...
class Device:
    """SmartHub representation of a UPnP/IGD device."""

    def __init__(
        self, hass: SmartHub, igd_device: IgdDevice, force_poll: bool
    ) -> None:
