...
from smarthub.components.websocket_api import ERR_NOT_SUPPORTED, ERR_UNKNOWN_ERROR
from smarthub.config_entries import ConfigEntry
from smarthub.const import (  # noqa: F401
    ATTR_ENTITY_PICTURE,
...
from smarthub.core import SmartHub, SupportsResponse
...
@bind_hass
def is_on(hass: SmartHub, entity_id: str | None = None) -> bool:
...
class MediaPlayerImageView(SmartHubView):
...
async def async_fetch_image(
    logger: logging.Logger, hass: SmartHub, url: str
) -> tuple[bytes | None, str | None]:
    """Retrieve an image."""
