...
import pychromecast
from pychromecast.controllers.smarthub import SmartHubController
...
from smarthub.components import media_source, zeroconf
...
from smarthub.core import CALLBACK_TYPE, Event, SmartHub, callback
...
from smarthub.helpers.network import NoURLAvailableError, get_url, is_hass_url
from smarthub.util import dt as dt_util
from smarthub.util.logging import async_create_catching_coro
...
CAST_SPLASH = "https://www.smart-hub.io/images/cast/splash.png"
...
def api_error[_CastDeviceT: CastDevice, **_P, _R](
    ...
    """Handle PyChromecastError and reraise a SmartHubError."""
...
@callback
def _async_create_cast_device(hass: SmartHub, info: ChromecastInfo):
...
class CastDevice:
    ...
    def __init__(self, hass: SmartHub, cast_info: ChromecastInfo) -> None:
...
class CastMediaPlayerEntity(CastDevice, MediaPlayerEntity):
    ...
    def __init__(self, hass: SmartHub, cast_info: ChromecastInfo) -> None:
        ...
        self._hass_cast_controller: SmartHubController | None = None
    ...
    def media_position_updated_at(self):
        ...
        Returns value from smarthub.util.dt.utcnow().
        """
        if self.app_id == CAST_APP_ID_HOMEASSISTANT_LOVELACE:
            return None
        ...
        if self._hass_cast_controller is None:
            ...
            def unregister() -> None:
                ...
                if not self._hass_cast_controller or not self._chromecast:
                    return
                _LOGGER.debug(
                    "[%s %s] Unregistering SmartHubController",
                    self.entity_id,
                    self._cast_info.friendly_name,
                )
