"""SmartHub Cast integration for Cast."""

from __future__ import annotations

import voluptuous as vol

from smarthub import auth, config_entries, core
from smarthub.const import ATTR_ENTITY_ID
from smarthub.exceptions import SmartHubError
from smarthub.helpers import config_validation as cv, dispatcher, instance_id
...
from .const import DOMAIN, SIGNAL_HASS_CAST_SHOW_VIEW, SmartHubControllerData

SERVICE_SHOW_VIEW = "show_lovelace_view"
ATTR_VIEW_PATH = "view_path"
ATTR_URL_PATH = "dashboard_path"
CAST_USER_NAME = "SmartHub Cast"
NO_URL_AVAILABLE_ERROR = (
    "SmartHub Cast requires your instance to be reachable via HTTPS. Enable Home"
    " Assistant Cloud or set up an external URL with valid SSL certificates"
)


async def async_setup_ha_cast(
    hass: core.SmartHub, entry: config_entries.ConfigEntry
):
    """Set up SmartHub Cast."""
    ...
    async def handle_show_view(call: core.ServiceCall) -> None:
        ...
        try:
            ...
            raise SmartHubError(NO_URL_AVAILABLE_ERROR) from err

        hass_uuid = await instance_id.async_get(hass)

        controller_data = SmartHubControllerData(
            # If you are developing SmartHub Cast, uncomment and set to
            # your dev app id.
            # app_id="5FE44367",
            hass_url=hass_url,
            hass_uuid=hass_uuid,
