...
# Dispatcher signal fired when a Chromecast should show a SmartHub Cast view.
SIGNAL_HASS_CAST_SHOW_VIEW: SignalType[
    SmartHubControllerData, str, str, str | None
...
class SmartHubControllerData(TypedDict):
    """Data for creating a SmartHubController."""
