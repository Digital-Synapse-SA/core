...
def discover_chromecast(
    hass: SmartHub, cast_info: pychromecast.models.CastInfo
) -> None:
...
def _remove_chromecast(hass: SmartHub, info: ChromecastInfo) -> None:
    # Removed chromecast
...
def setup_internal_discovery(hass: SmartHub, config_entry: ConfigEntry) -> None:
...
async def config_entry_updated(hass: SmartHub, config_entry: ConfigEntry) -> None:
