...
from smarthub.const import CONF_DELAY, CONF_HOST, CONF_NAME, CONF_PASSWORD
...
AUTH_HELP_URL_VALUE = (
    "https://www.smart-hub.io/integrations/roomba/#retrieving-your-credentials"
)
...
async def _async_discover_roombas(
    hass: SmartHub, host: str | None = None
) -> list[RoombaInfo]:
