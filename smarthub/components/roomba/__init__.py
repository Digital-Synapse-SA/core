...
async def async_disconnect_or_timeout(hass: SmartHub, roomba: Roomba) -> None:
...
async def async_update_options(hass: SmartHub, config_entry: ConfigEntry) -> None:
    """Update options."""
