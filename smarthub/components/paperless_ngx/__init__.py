...
from smarthub.const import CONF_API_KEY, CONF_URL, CONF_VERIFY_SSL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: PaperlessConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: PaperlessConfigEntry) -> bool:
