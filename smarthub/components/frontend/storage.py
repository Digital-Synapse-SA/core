...
async def async_setup_frontend_storage(hass: SmartHub) -> None:
...
async def async_user_store(hass: SmartHub, user_id: str) -> UserStore:
    """Access a user store."""
...
class UserStore:
    ...
    def __init__(self, hass: SmartHub, user_id: str) -> None:
...
def with_user_store(
    orig_func: Callable[
        [SmartHub, ActiveConnection, dict[str, Any], UserStore],
