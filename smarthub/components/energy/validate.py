...
from smarthub.components import recorder, sensor
...
def _get_placeholders(hass: SmartHub, issue_type: str) -> dict[str, str] | None:
...
def _async_validate_auto_generated_cost_entity(
    hass: SmartHub, energy_entity_id: str, issues: ValidationIssues
) -> None:
...
async def async_validate(hass: SmartHub) -> EnergyPreferencesValidation:
