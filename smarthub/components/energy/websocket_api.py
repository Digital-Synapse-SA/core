...
from smarthub.components import recorder, websocket_api
from smarthub.components.recorder.statistics import StatisticsRow
...
type EnergyWebSocketCommandHandler = Callable[
    [SmartHub, websocket_api.ActiveConnection, dict[str, Any], EnergyManager],
    None,
]
