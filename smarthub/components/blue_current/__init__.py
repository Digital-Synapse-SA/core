...
from smarthub.const import ATTR_NAME, CONF_API_TOKEN, Platform
...
async def async_setup_entry(
    hass: SmartHub, config_entry: BlueCurrentConfigEntry
) -> bool:
...
class Connector:
    ...
    def __init__(
        self, hass: SmartHub, config: BlueCurrentConfigEntry, client: Client
    ) -> None:
        """Initialize."""
        self.config = config
        self.hass = hass
