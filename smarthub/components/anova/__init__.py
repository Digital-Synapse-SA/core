...
from smarthub.const import CONF_DEVICES, CONF_PASSWORD, CONF_USERNAME, Platform
...
async def async_setup_entry(hass: SmartHub, entry: AnovaConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AnovaConfigEntry) -> bool:
...
async def async_migrate_entry(hass: SmartHub, entry: AnovaConfigEntry) -> bool:
    """Migrate entry."""
