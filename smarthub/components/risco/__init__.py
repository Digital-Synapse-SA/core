...
async def _async_setup_local_entry(hass: SmartHub, entry: ConfigEntry) -> bool:
    data = entry.data
...
async def _async_setup_cloud_entry(hass: SmartHub, entry: ConfigEntry) -> bool:
    data = entry.data
...
async def _update_listener(hass: SmartHub, entry: ConfigEntry) -> None:
