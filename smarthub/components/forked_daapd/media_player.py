...
from smarthub.components.spotify import (
...
async def update_listener(hass: SmartHub, entry: ForkedDaapdConfigEntry) -> None:
...
class ForkedDaapdMaster(MediaPlayerEntity):
    ...
    async def async_play_media(
        ...
        # See https://github.com/smart-hub/architecture/issues/765
