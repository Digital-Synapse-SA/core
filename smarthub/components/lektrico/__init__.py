...
from smarthub.const import CONF_TYPE, Platform
...
async def async_setup_entry(hass: SmartHub, entry: LektricoConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: LektricoConfigEntry) -> bool:
