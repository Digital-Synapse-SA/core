...
from smarthub.const import CONF_PASSWORD, CONF_TIMEOUT, CONF_USERNAME, Platform
...
async def async_setup_entry(hass: SmartHub, entry: CanaryConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: CanaryConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def _async_update_listener(hass: SmartHub, entry: CanaryConfigEntry) -> None:
