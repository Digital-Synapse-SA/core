...
from smarthub.components.thread import async_add_dataset, async_get_dataset
...
def async_get_otbr_data(
    orig_func: Callable[
        [SmartHub, websocket_api.ActiveConnection, dict, OTBRData],
        Coroutine[Any, Any, None],
    ],
) -> Callable[
    [SmartHub, websocket_api.ActiveConnection, dict], Coroutine[Any, Any, None]
]:
