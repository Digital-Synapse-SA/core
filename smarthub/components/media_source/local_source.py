...
from smarthub.components.http import require_admin
from smarthub.components.media_player import BrowseError, MediaClass
from smarthub.core import SmartHub, callback
from smarthub.util import raise_if_invalid_filename, raise_if_invalid_path
...
class LocalMediaView(http.SmartHubView):
    ...
    def __init__(self, hass: SmartHub, source: LocalSource) -> None:
...
class UploadMediaView(http.SmartHubView):
