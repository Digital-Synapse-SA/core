...
EARLY_ACCESS_URL = (
    "https://www.smart-hub.io/integrations/unifiprotect#software-support"
)
...
async def async_setup_entry(hass: SmartHub, entry: UFPConfigEntry) -> bool:
    ...
    if auth_user and auth_user.cloud_account:
        ir.async_create_issue(
            ...
            is_fixable=True,
            is_persistent=False,
            learn_more_url="https://www.smart-hub.io/integrations/unifiprotect/#local-user",
    ...
    try:
        ...
        if await nvr_info.get_is_prerelease():
            ...
            ir.async_create_issue(
                ...
                is_fixable=False,
                is_persistent=False,
                learn_more_url="https://www.smart-hub.io/integrations/unifiprotect#about-unifi-early-access",
                severity=IssueSeverity.ERROR,
...
async def _async_options_updated(hass: SmartHub, entry: UFPConfigEntry) -> None:
    """Update options."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: UFPConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: UFPConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
