...
from smarthub.components.climate import DOMAIN as DOMAIN_CLIMATE
...
async def async_setup_entry(hass: SmartHub, entry: ViCareConfigEntry) -> bool:
...
def setup_vicare_api(hass: SmartHub, entry: ViCareConfigEntry) -> PyViCare:
    """Set up PyVicare API."""
...
async def async_unload_entry(hass: SmartHub, entry: ViCareConfigEntry) -> bool:
...
async def async_migrate_devices_and_entities(
    hass: SmartHub, entry: ViCareConfigEntry, device: ViCareDevice
) -> None:
    """Migrate old entry."""
