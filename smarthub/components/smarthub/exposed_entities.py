...
from smarthub.core import CALLBACK_TYPE, SmartHub, callback, split_entity_id
from smarthub.exceptions import SmartHubError
from smarthub.helpers import entity_registry as er
from smarthub.helpers.entity import get_device_class
...
class ExposedEntities:
    ...
    def async_get_entity_settings(self, entity_id: str) -> dict[str, Mapping[str, Any]]:
        ...
        if registry_entry := entity_registry.async_get(entity_id):
            ...
            raise SmartHubError("Unknown entity")
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "smarthub/expose_entity",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "smarthub/expose_entity/list",
    }
)
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "smarthub/expose_new_entities/get",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "smarthub/expose_new_entities/set",
        vol.Required("assistant"): vol.In(KNOWN_ASSISTANTS),
...
@callback
def async_listen_entity_updates(
    hass: SmartHub, assistant: str, listener: Callable[[], None]
) -> CALLBACK_TYPE:
    """Listen for updates to entity expose settings."""
    exposed_entities = hass.data[DATA_EXPOSED_ENTITIES]
...
@callback
def async_should_expose(hass: SmartHub, assistant: str, entity_id: str) -> bool:
    """Return True if an entity should be exposed to an assistant."""
    exposed_entities = hass.data[DATA_EXPOSED_ENTITIES]
...
@callback
def async_set_assistant_option(
    hass: SmartHub, assistant: str, entity_id: str, option: str, value: Any
) -> None:
    """Set an option for an assistant.
