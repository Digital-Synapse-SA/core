...
from smarthub.const import CONF_HOST, CONF_PIN, CONF_PORT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: MotionMountConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: MotionMountConfigEntry
) -> bool:
