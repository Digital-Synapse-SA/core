...
async def async_setup_entry(hass: SmartHub, entry: SensiboConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SensiboConfigEntry) -> bool:
    """Unload Sensibo config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: SensiboConfigEntry) -> bool:
    """Migrate old entry."""
...
async def async_remove_config_entry_device(
    hass: SmartHub, entry: SensiboConfigEntry, device: DeviceEntry
) -> bool:
