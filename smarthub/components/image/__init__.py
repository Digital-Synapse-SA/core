...
from smarthub.components.http import KEY_AUTHENTICATED, KEY_HASS, SmartHubView
from smarthub.config_entries import ConfigEntry
from smarthub.const import CONTENT_TYPE_MULTIPART, EVENT_HOMEASSISTANT_STOP
...
from smarthub.helpers.httpx_client import get_async_client
...
class ImageContentTypeError(SmartHubError):
...
class ImageEntity(Entity, cached_properties=CACHED_PROPERTIES_WITH_ATTR_):
    ...
    def __init__(self, hass: SmartHub, verify_ssl: bool = False) -> None:
...
async def async_handle_snapshot_service(
    ...
    try:
        ...
        raise SmartHubError("Can't write image to file") from err
