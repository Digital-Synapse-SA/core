...
from smarthub.const import ATTR_NAME, CONF_API_KEY, CONF_TIMEOUT, CONTENT_TYPE_JSON
...
class MicrosoftFace:
    """Microsoft Face api for SmartHub."""
    ...
    async def call_api(self, method, function, data=None, binary=False, params=None):
        ...
        try:
            ...
            raise SmartHubError(answer["error"]["message"])
        ...
        raise SmartHubError("Network error on microsoft face api.")
