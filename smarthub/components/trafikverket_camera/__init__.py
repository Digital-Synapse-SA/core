...
async def async_setup_entry(hass: SmartHub, entry: TVCameraConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: TVCameraConfigEntry) -> bool:
    """Unload Trafikverket Camera config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: TVCameraConfigEntry) -> bool:
    """Migrate old entry."""
