...
from smarthub.const import CONF_ADDRESS, CONF_PORT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: AuroraAbbConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AuroraAbbConfigEntry) -> bool:
