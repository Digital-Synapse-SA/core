...
async def async_setup_entry(hass: SmartHub, entry: TeslemetryConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: TeslemetryConfigEntry) -> bool:
    """Unload Teslemetry Config."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(
    hass: SmartHub, config_entry: TeslemetryConfigEntry
) -> bool:
...
async def async_setup_stream(
    hass: SmartHub, entry: TeslemetryConfigEntry, vehicle: TeslemetryVehicleData
):
