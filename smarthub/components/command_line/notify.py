...
from smarthub.components.notify import BaseNotificationService
from smarthub.const import CONF_COMMAND
from smarthub.core import SmartHub
from smarthub.helpers.typing import ConfigType, DiscoveryInfoType
from smarthub.util.process import kill_subprocess
