...
async def build_context_async(
    hass: SmartHub, hapid: str | None, authtoken: str | None
):
    """Create a HomematicIP context object."""
    ssl_ctx = smarthub.util.ssl.get_default_context()
...
class HomematicipAuth:
    ...
    def __init__(self, hass: SmartHub, config: dict[str, str]) -> None:
    ...
    async def get_auth(self, hass: SmartHub, hapid, pin):
...
class HomematicipHAP:
    ...
    def __init__(
        self, hass: SmartHub, config_entry: HomematicIPConfigEntry
    ) -> None:
    ...
    async def get_state(self) -> None:
        """Update HMIP state and tell SmartHub."""
    ...
    def set_all_to_unavailable(self) -> None:
        """Set all devices to unavailable and tell SmartHub."""
