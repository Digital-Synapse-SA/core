...
from smarthub.const import CONF_NAME, EVENT_HOMEASSISTANT_STOP
...
async def async_setup_entry(hass: SmartHub, entry: HomematicIPConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: HomematicIPConfigEntry
) -> bool:
...
def _async_remove_obsolete_entities(
    hass: SmartHub, entry: HomematicIPConfigEntry, hap: HomematicipHAP
):
