"""SmartHub Hardware base firmware update entity."""
...
from smarthub.core import CALLBACK_TYPE, callback
...
class FirmwareUpdateEntityDescription(UpdateEntityDescription):
    """Describes SmartHub Hardware firmware update entity."""
...
class FirmwareUpdateExtraStoredData(ExtraStoredData):
    """Extra stored data for SmartHub Hardware firmware update entity."""
...
class BaseFirmwareUpdateEntity(
    ...
    """Base SmartHub Hardware firmware update entity."""
        ...
        async with self._temporarily_stop_hardware_owners(device):
            try:
                try:
                    ...
                    raise SmartHubError("Failed to flash firmware") from err
