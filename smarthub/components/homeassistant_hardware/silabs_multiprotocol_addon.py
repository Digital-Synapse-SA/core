...
STORAGE_KEY = "smarthub_hardware.silabs"
...
class MultiprotocolAddonManager(WaitingAddonManager):
    ...
    async def _register_multipan_platform(
        self, hass: SmartHub, integration_domain: str, platform: MultipanProtocol
    ) -> None:
...
@callback
def get_flasher_addon_manager(hass: SmartHub) -> WaitingAddonManager:
...
class OptionsFlowHandler(OptionsFlow, ABC):
    ...
    def __init__(self, config_entry: ConfigEntry) -> None:
        ...
        from smarthub.components.zha.radio_manager import (  # noqa: PLC0415
    ...
    async def async_step_configure_addon(
        ...
        from smarthub.components.zha import DOMAIN as ZHA_DOMAIN  # noqa: PLC0415
        from smarthub.components.zha.radio_manager import (  # noqa: PLC0415
            ZhaMultiPANMigrationHelper,
        )
        from smarthub.components.zha.silabs_multiprotocol import (  # noqa: PLC0415
...
async def check_multi_pan_addon(hass: SmartHub) -> None:
...
async def multi_pan_addon_using_device(hass: SmartHub, device_path: str) -> bool:
