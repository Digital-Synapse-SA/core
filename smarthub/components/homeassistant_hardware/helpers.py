"""SmartHub Hardware integration helpers."""
...
class SyncHardwareFirmwareInfoModule(Protocol):
    """Protocol type for SmartHub Hardware firmware info platform modules."""
...
def async_register_firmware_info_provider(
    hass: SmartHub, domain: str, platform: HardwareFirmwareInfoModule
) -> None:
    """Register a firmware info provider."""
...
def async_register_firmware_info_callback(
    hass: SmartHub, device: str, callback: Callable[[FirmwareInfo], None]
) -> CALLBACK_TYPE:
    """Register a firmware info provider."""
...
def async_notify_firmware_info(
    hass: SmartHub, domain: str, firmware_info: FirmwareInfo
) -> Awaitable[None]:
    """Notify the dispatcher of new firmware information."""
