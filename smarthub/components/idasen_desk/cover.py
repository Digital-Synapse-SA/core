...
class IdasenDeskCover(IdasenDeskEntity, CoverEntity):
    ...
    async def async_close_cover(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            raise SmartHubError("Failed to move down: Bluetooth error") from err
    ...
    async def async_open_cover(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            raise SmartHubError("Failed to move up: Bluetooth error") from err
    ...
    async def async_stop_cover(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            raise SmartHubError("Failed to stop moving: Bluetooth error") from err
