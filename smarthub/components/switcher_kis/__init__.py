...
from smarthub.const import CONF_TOKEN, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(hass: SmartHub, entry: SwitcherConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SwitcherConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: SwitcherConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
