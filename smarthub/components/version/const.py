...
HOME_ASSISTANT: Final = "SmartHub"
POSTFIX_CONTAINER_NAME: Final = "-smarthub"
...
BOARD_MAP: Final[dict[str, str]] = {
    ...
    "SmartHub Yellow": "yellow",
    "SmartHub Green": "green",
