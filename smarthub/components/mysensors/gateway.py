...
from smarthub.components.mqtt import (
...
from smarthub.const import CONF_DEVICE, EVENT_HOMEASSISTANT_STOP
...
async def try_connect(
    hass: SmartHub, gateway_type: ConfGatewayType, user_input: dict[str, Any]
) -> bool:
...
async def finish_setup(
    hass: SmartHub, entry: ConfigEntry, gateway: BaseAsyncGateway
) -> None:
...
def _gw_callback_factory(
    hass: SmartHub, gateway_id: GatewayId
