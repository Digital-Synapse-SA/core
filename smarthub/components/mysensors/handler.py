...
from smarthub.util import decorator
...
HANDLERS: decorator.Registry[
    str, Callable[[SmartHub, GatewayId, Message], None]
] = decorator.Registry()


@HANDLERS.register("set")
@callback
def handle_set(hass: SmartHub, gateway_id: GatewayId, msg: Message) -> None:
...
@callback
def handle_internal(hass: SmartHub, gateway_id: GatewayId, msg: Message) -> None:
...
def handle_battery_level(
    hass: SmartHub, gateway_id: GatewayId, msg: Message
) -> None:
...
@callback
def handle_heartbeat(hass: SmartHub, gateway_id: GatewayId, msg: Message) -> None:
    """Handle an heartbeat."""
    _handle_node_update(hass, gateway_id, msg)
...
def _handle_child_update(
    hass: SmartHub, gateway_id: GatewayId, validated: dict[Platform, list[DevId]]
) -> None:
