...
from smarthub.helpers.httpx_client import create_async_httpx_client
...
async def async_setup_entry(hass: SmartHub, entry: DiscovergyConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: DiscovergyConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_reload_entry(hass: SmartHub, entry: DiscovergyConfigEntry) -> None:
