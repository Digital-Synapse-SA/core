...
from smarthub.const import CONF_ADDRESS, CONF_DEVICE
...
def get_insteon_config_entry(hass: SmartHub) -> ConfigEntry:
    """Return the Insteon configuration entry."""
    return hass.config_entries.async_entries(DOMAIN)[0]


def add_x10_device(hass: SmartHub, x10_device: X10DeviceConfig):
...
def remove_x10_device(hass: SmartHub, housecode: str, unitcode: int):
...
def add_device_overide(hass: SmartHub, override: DeviceOverride):
...
def remove_device_override(hass: SmartHub, address: Address):
