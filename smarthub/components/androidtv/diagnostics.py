...
from smarthub.const import ATTR_CONNECTIONS, ATTR_IDENTIFIERS, CONF_UNIQUE_ID
...
async def async_get_config_entry_diagnostics(
    hass: SmartHub, entry: AndroidTVConfigEntry
    ...
    # Gather information how this AndroidTV device is represented in SmartHub
