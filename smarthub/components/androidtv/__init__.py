...
def _setup_androidtv(
    hass: SmartHub, config: Mapping[str, Any]
...
async def async_setup_entry(hass: SmartHub, entry: AndroidTVConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AndroidTVConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: AndroidTVConfigEntry) -> None:
