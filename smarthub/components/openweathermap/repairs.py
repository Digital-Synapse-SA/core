...
from smarthub.const import CONF_API_KEY, CONF_MODE
...
@callback
def async_create_issue(hass: SmartHub, entry_id: str) -> None:
    ...
    ir.async_create_issue(
        ...
        learn_more_url="https://www.smart-hub.io/integrations/openweathermap/",
...
@callback
def async_delete_issue(hass: SmartHub, entry_id: str) -> None:
