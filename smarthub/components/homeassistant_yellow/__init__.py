"""The SmartHub Yellow integration."""
...
from smarthub.config_entries import SOURCE_HARDWARE, ConfigEntry
...
async def async_setup_entry(hass: SmartHub, entry: ConfigEntry) -> bool:
    """Set up a SmartHub Yellow config entry."""
    ...
    if os_info.get("board") != "yellow":
        # Not running on a SmartHub Yellow, SmartHub may have been migrated
        hass.async_create_task(hass.config_entries.async_remove(entry.entry_id))
        return False
