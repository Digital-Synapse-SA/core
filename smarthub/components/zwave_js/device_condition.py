...
from smarthub.components.device_automation import InvalidDeviceAutomationConfig
from smarthub.const import CONF_CONDITION, CONF_DEVICE_ID, CONF_DOMAIN, CONF_TYPE
...
def async_condition_from_config(
    ...
    @callback
    def test_node_status(hass: SmartHub, variables: TemplateVarsType) -> bool:
    ...
    @callback
    def test_config_parameter(hass: SmartHub, variables: TemplateVarsType) -> bool:
    ...
    @callback
    def test_value(hass: SmartHub, variables: TemplateVarsType) -> bool:
    ...
    raise SmartHubError(f"Unhandled condition type {condition_type}")
