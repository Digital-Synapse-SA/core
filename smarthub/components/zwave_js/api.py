...
def async_get_entry(
    orig_func: Callable[
        [SmartHub, ActiveConnection, dict[str, Any], ConfigEntry, Client, Driver],
        Coroutine[Any, Any, None],
    ],
) -> Callable[
    [SmartHub, ActiveConnection, dict[str, Any]], Coroutine[Any, Any, None]
]:
...
async def _async_get_node(
    hass: SmartHub, connection: ActiveConnection, msg: dict, device_id: str
) -> Node | None:
...
def async_get_node(
    orig_func: Callable[
        [SmartHub, ActiveConnection, dict[str, Any], Node],
        Coroutine[Any, Any, None],
    ],
) -> Callable[
    [SmartHub, ActiveConnection, dict[str, Any]], Coroutine[Any, Any, None]
...
def async_handle_failed_command[**_P](
    orig_func: Callable[
        Concatenate[SmartHub, ActiveConnection, dict[str, Any], _P],
        Coroutine[Any, Any, None],
    ],
) -> Callable[
    Concatenate[SmartHub, ActiveConnection, dict[str, Any], _P],
...
@callback
def async_register_api(hass: SmartHub) -> None:
...
async def websocket_get_config_parameters(
    hass: SmartHub, connection: ActiveConnection, msg: dict[str, Any], node: Node
) -> None:
...
class FirmwareUploadView(SmartHubView):
...
def _get_node_statistics_dict(
    hass: SmartHub, statistics: NodeStatistics
) -> dict[str, Any]:
