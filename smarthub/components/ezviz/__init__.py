...
from smarthub.const import CONF_TIMEOUT, CONF_TYPE, CONF_URL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: EzvizConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: EzvizConfigEntry) -> bool:
...
async def _async_update_listener(hass: SmartHub, entry: EzvizConfigEntry) -> None:
