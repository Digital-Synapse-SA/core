...
from smarthub.components.remote import RemoteEntityFeature
...
def get_accessory(  # noqa: C901
    hass: SmartHub, driver: HomeDriver, state: State, aid: int | None, config: dict
) -> HomeAccessory | None:
...
class HomeBridge(Bridge):  # type: ignore[misc]
    ...
    def __init__(self, hass: SmartHub, driver: HomeDriver, name: str) -> None:
