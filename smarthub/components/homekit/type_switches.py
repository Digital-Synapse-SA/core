...
from smarthub.components import button, input_button
from smarthub.components.input_select import ATTR_OPTIONS, SERVICE_SELECT_OPTION
...
class ValveSwitch(ValveBase):
    """Generate a Valve accessory from a SmartHub switch."""
...
class Valve(ValveBase):
    """Generate a Valve accessory from a SmartHub valve."""
