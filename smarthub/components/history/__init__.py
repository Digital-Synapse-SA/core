...
from smarthub.const import CONF_EXCLUDE, CONF_INCLUDE
from smarthub.core import SmartHub, valid_entity_id
from smarthub.helpers import config_validation as cv
from smarthub.helpers.entityfilter import INCLUDE_EXCLUDE_BASE_FILTER_SCHEMA
...
class HistoryPeriodView(SmartHubView):
