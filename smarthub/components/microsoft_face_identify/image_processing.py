...
from smarthub.components.image_processing import (
    ATTR_CONFIDENCE,
    CONF_CONFIDENCE,
...
from smarthub.components.microsoft_face import DATA_MICROSOFT_FACE, MicrosoftFace
from smarthub.const import ATTR_NAME, CONF_ENTITY_ID, CONF_NAME, CONF_SOURCE
