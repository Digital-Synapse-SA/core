...
This configuration flow supports the following:
  - SDM API with Web OAuth flow with redirect back to SmartHub
...
from smarthub.config_entries import SOURCE_REAUTH, ConfigFlowResult
...
from smarthub.util import get_random_string
...
TOPIC_FORMAT = "projects/{cloud_project_id}/topics/smart-hub-{rnd}"
SUBSCRIPTION_FORMAT = "projects/{cloud_project_id}/subscriptions/smart-hub-{rnd}"
RAND_LENGTH = 10

MORE_INFO_URL = "https://www.smart-hub.io/integrations/nest/#configuration"
