...
def async_get_coordinator(hass: SmartHub) -> PrivateDevicesCoordinator:
    """Create or return an existing PrivateDeviceManager.

    There should only be one per SmartHub instance. Associating private
