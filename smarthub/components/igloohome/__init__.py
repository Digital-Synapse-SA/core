...
from smarthub.const import CONF_CLIENT_ID, CONF_CLIENT_SECRET, Platform
from smarthub.core import SmartHub
from smarthub.exceptions import ConfigEntryError, ConfigEntryNotReady
...
async def async_setup_entry(hass: SmartHub, entry: IgloohomeConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: IgloohomeConfigEntry) -> bool:
