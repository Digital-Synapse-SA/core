...
async def async_setup_entry(
    hass: SmartHub, config_entry: MyUplinkConfigEntry
) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: MyUplinkConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: MyUplinkConfigEntry, device_entry: DeviceEntry
) -> bool:
