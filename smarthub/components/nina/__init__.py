...
async def async_setup_entry(hass: SmartHub, entry: NinaConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: NinaConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def _async_update_listener(hass: SmartHub, entry: NinaConfigEntry) -> None:
