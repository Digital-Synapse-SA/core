...
from smarthub.const import CONF_HOST, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(hass: SmartHub, entry: DenonavrConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, config_entry: DenonavrConfigEntry
) -> bool:
