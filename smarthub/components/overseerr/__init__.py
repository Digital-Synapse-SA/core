...
async def async_setup_entry(hass: SmartHub, entry: OverseerrConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: OverseerrConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_remove_entry(hass: SmartHub, entry: OverseerrConfigEntry) -> None:
...
class OverseerrWebhookManager:
    ...
    def __init__(self, hass: SmartHub, entry: OverseerrConfigEntry) -> None:
    ...
    async def handle_webhook(
        self, hass: SmartHub, webhook_id: str, request: Request
    ) -> Response:
        """Handle webhook."""
        ...
        return SmartHubView.json({"message": "ok"})
...
async def _async_cloudhook_generate_url(
    hass: SmartHub, entry: OverseerrConfigEntry
) -> str:
