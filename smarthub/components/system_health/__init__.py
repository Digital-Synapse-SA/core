...
class SystemHealthProtocol(Protocol):
    ...
    def async_register(
        self, hass: SmartHub, register: SystemHealthRegistration
    ) -> None:
...
def async_register_info(
    hass: SmartHub,
    domain: str,
    info_callback: Callable[[SmartHub], Awaitable[dict]],
) -> None:
...
def _register_system_health_platform(
    hass: SmartHub, integration_domain: str, platform: SystemHealthProtocol
) -> None:
...
async def get_integration_info(
    hass: SmartHub, registration: SystemHealthRegistration
) -> dict[str, Any]:
...
async def get_info(hass: SmartHub) -> dict[str, dict[str, str]]:
...
class SystemHealthRegistration:
    ...
    hass: SmartHub
    domain: str
    info_callback: Callable[[SmartHub], Awaitable[dict]] | None = None
...
async def async_check_can_reach_url(
    hass: SmartHub, url: str, more_info: str | None = None
) -> str | dict[str, str]:
