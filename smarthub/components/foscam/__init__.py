...
from smarthub.helpers.entity_registry import RegistryEntry, async_migrate_entries
...
async def async_setup_entry(hass: SmartHub, entry: FoscamConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FoscamConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: FoscamConfigEntry) -> bool:
    """Migrate old entry."""
...
async def async_migrate_entities(hass: SmartHub, entry: FoscamConfigEntry) -> None:
    """Migrate old entry."""
