...
async def async_setup_entry(hass: SmartHub, entry: TelegramBotConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: TelegramBotConfigEntry) -> None:
    """Handle options update."""
    entry.runtime_data.parse_mode = entry.options[ATTR_PARSER]


async def async_unload_entry(
    hass: SmartHub, entry: TelegramBotConfigEntry
) -> bool:
    """Unload Telegram app."""
