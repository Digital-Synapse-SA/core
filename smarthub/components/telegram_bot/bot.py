...
from smarthub.util.ssl import get_default_context, get_default_no_verify_context
...
class BaseTelegramBot:
    ...
    def __init__(self, hass: SmartHub, config: TelegramBotConfigEntry) -> None:
...
def initialize_bot(hass: SmartHub, p_config: MappingProxyType[str, Any]) -> Bot:
    ...
    if proxy_url is not None:
        ...
        if proxy_params is None:
            ...
            ir.create_issue(
                ...
                learn_more_url="https://github.com/smart-hub/core/pull/112778",
            )
        else:
            ir.create_issue(
                hass,
