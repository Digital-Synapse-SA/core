...
from smarthub.const import CONF_LANGUAGE, CONF_LATITUDE, CONF_LONGITUDE, Platform
...
async def async_setup_entry(hass: SmartHub, config_entry: ECConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, config_entry: ECConfigEntry) -> bool:
