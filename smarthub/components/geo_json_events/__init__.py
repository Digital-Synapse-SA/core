...
async def async_setup_entry(
    hass: SmartHub, config_entry: GeoJsonConfigEntry
) -> bool:
...
async def remove_orphaned_entities(hass: SmartHub, entry_id: str) -> None:
    ...
    current with the previous data. After a restart of SmartHub the integration
...
async def async_unload_entry(hass: SmartHub, entry: GeoJsonConfigEntry) -> bool:
