...
async def async_setup_entry(hass: SmartHub, entry: HiveConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: HiveConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_remove_entry(hass: SmartHub, entry: HiveConfigEntry) -> None:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: HiveConfigEntry, device_entry: DeviceEntry
) -> bool:
