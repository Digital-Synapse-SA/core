...
from smarthub.auth.permissions.events import SUBSCRIBE_ALLOWLIST
...
from smarthub.helpers import config_validation as cv, entity, template
...
from smarthub.helpers.json import (
    JSON_DUMP,
    ExtendedJSONEncoder,
...
from smarthub.util.json import format_unserializable_data
...
def async_register_commands(
    hass: SmartHub,
    async_reg: Callable[[SmartHub, const.WebSocketCommandHandler], None],
) -> None:
    """Register commands."""
...
def _async_get_allowed_states(
    hass: SmartHub, connection: ActiveConnection
) -> list[State]:
...
async def _async_get_all_descriptions_json(hass: SmartHub) -> bytes:
...
async def handle_subscribe_trigger(
    ...
    # Circular dep
    from smarthub.helpers import trigger  # noqa: PLC0415
...
async def handle_test_condition(
    ...
    # Circular dep
    from smarthub.helpers import condition  # noqa: PLC0415
...
async def handle_execute_script(
    ...
    # Circular dep
    from smarthub.helpers.script import (  # noqa: PLC0415
        Script,
...
async def handle_validate_config(
    ...
    # Circular dep
    from smarthub.helpers import condition, script, trigger  # noqa: PLC0415
