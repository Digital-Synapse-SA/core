...
type WebSocketCommandHandler = Callable[
    [SmartHub, ActiveConnection, dict[str, Any]], None
]
type AsyncWebSocketCommandHandler = Callable[
    [SmartHub, ActiveConnection, dict[str, Any]], Awaitable[None]
]
...
# Ideally we would use smarthub.const.MAX_EXPECTED_ENTITY_IDS
