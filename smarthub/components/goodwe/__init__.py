...
async def async_setup_entry(hass: SmartHub, entry: GoodweConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, config_entry: GoodweConfigEntry
) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(config_entry, PLATFORMS)


async def update_listener(hass: SmartHub, config_entry: GoodweConfigEntry) -> None:
