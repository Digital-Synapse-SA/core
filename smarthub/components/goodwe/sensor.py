...
# When the inverter has a battery connected, SmartHub will not reset the values but let the inverter reset them by looking at the unavailable state of the inverter.
