...
from smarthub.const import CONF_HOST, CONF_PORT, CONF_TOKEN, Platform
...
async def async_setup_entry(hass: SmartHub, entry: HyperionConfigEntry) -> bool:
...
async def _async_entry_updated(hass: SmartHub, entry: HyperionConfigEntry) -> None:
    """Handle entry updates."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: HyperionConfigEntry) -> bool:
