...
from smarthub.helpers.service_info.ssdp import ATTR_UPNP_SERIAL, SsdpServiceInfo
...
# entries, and as SmartHub only passes a single entry into the config flow, we can
