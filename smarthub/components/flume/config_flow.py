...
# we can use the oauth2 support built into SmartHub.
#
...
def _validate_input(
    hass: SmartHub, data: dict[str, Any], clear_token_file: bool
) -> FlumeDeviceList:
...
async def validate_input(
    hass: SmartHub, data: dict[str, Any], clear_token_file: bool = False
) -> dict[str, Any]:
