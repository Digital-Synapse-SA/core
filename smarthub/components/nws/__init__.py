...
from smarthub.const import CONF_API_KEY, CONF_LATITUDE, CONF_LONGITUDE, Platform
...
async def async_setup_entry(hass: SmartHub, entry: NWSConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: NWSConfigEntry) -> bool:
