...
from smarthub.const import CONF_HOST, CONF_MAC, CONF_PASSWORD, CONF_PORT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: BoschAlarmConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BoschAlarmConfigEntry) -> bool:
