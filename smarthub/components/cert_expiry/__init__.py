...
async def async_setup_entry(hass: SmartHub, entry: CertExpiryConfigEntry) -> bool:
    ...
    async def _async_finish_startup(_: SmartHub) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: CertExpiryConfigEntry) -> bool:
