"""SmartHub component for accessing the Wallbox Portal API. The lock component creates a lock entity."""

from __future__ import annotations

from typing import Any

from smarthub.components.lock import LockEntity, LockEntityDescription
