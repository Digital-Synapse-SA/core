...
from smarthub.const import CONF_HOST, CONF_NAME, CONF_PORT, CONF_SWITCHES, Platform
...
async def async_setup_entry(hass: SmartHub, entry: HlkConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: HlkConfigEntry) -> bool:
