...
from smarthub.const import CONF_HOST, CONF_PORT, CONF_PROTOCOL, CONF_TYPE
...
class DSMRConnection:
    ...
    async def validate_connect(self, hass: SmartHub) -> bool:
...
async def _validate_dsmr_connection(
    hass: SmartHub, data: dict[str, Any], protocol: str
) -> dict[str, str | None]:
...
class CannotCommunicate(SmartHubError):
    """Error to indicate we cannot connect."""
