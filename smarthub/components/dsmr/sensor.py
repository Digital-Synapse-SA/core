...
from smarthub.core import CoreState, Event, SmartHub, callback
...
def rename_old_gas_to_mbus(
    hass: SmartHub, entry: ConfigEntry, mbus_device_id: str
) -> None:
...
def create_mbus_entities(
    hass: SmartHub, telegram: Telegram, entry: ConfigEntry, dsmr_version: str
...
async def async_setup_entry(
    ...
    async def connect_and_reconnect() -> None:
        """Connect to DSMR and keep reconnecting until SmartHub stops."""
        stop_listener = None
        transport = None
        protocol = None
