...
async def async_setup_entry(hass: SmartHub, entry: DsmrConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: DsmrConfigEntry) -> bool:
...
async def async_update_options(hass: SmartHub, entry: DsmrConfigEntry) -> None:
    """Update options."""
