...
from smarthub.components.google_assistant import DOMAIN as GOOGLE_DOMAIN
from smarthub.components.google_assistant.helpers import AbstractConfig
...
from smarthub.helpers import device_registry as dr, entity_registry as er, start
from smarthub.helpers.entity import get_device_class
from smarthub.helpers.entityfilter import EntityFilter
...
def _supported_legacy(hass: SmartHub, entity_id: str) -> bool:
...
class CloudGoogleConfig(AbstractConfig):
    ...
    def get_local_user_id(self, webhook_id: Any) -> str:
        """Map webhook ID to a SmartHub user ID.
    ...
    async def async_initialize(self) -> None:
        ...
        async def on_hass_started(hass: SmartHub) -> None:
        ...
        async def on_hass_start(hass: SmartHub) -> None:
