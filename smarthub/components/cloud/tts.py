...
from smarthub.const import CONF_PLATFORM, Platform
...
from smarthub.setup import async_when_setup
...
async def async_setup_entry(
    ...
    """Set up SmartHub Cloud text-to-speech platform."""
...
class CloudTTSEntity(TextToSpeechEntity):
    """SmartHub Cloud text-to-speech entity."""

    _attr_name = "SmartHub Cloud"
    ...
    async def async_added_to_hass(self) -> None:
        ...
        async def pipeline_setup(hass: SmartHub, _comp: str) -> None:
...
class CloudProvider(Provider):
    """SmartHub Cloud speech API provider."""
