"""Alexa configuration for SmartHub Cloud."""
...
from smarthub.core import Event, SmartHub, callback, split_entity_id
from smarthub.exceptions import SmartHubError
from smarthub.helpers import entity_registry as er, start
...
def entity_supported(hass: SmartHub, entity_id: str) -> bool:
