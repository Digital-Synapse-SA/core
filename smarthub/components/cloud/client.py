...
from smarthub.components import google_assistant, persistent_notification, webhook
from smarthub.components.alexa import (
    errors as alexa_errors,
    smart_home as alexa_smart_home,
)
from smarthub.components.camera.webrtc import async_register_ice_servers
from smarthub.components.google_assistant import smart_home as ga
from smarthub.const import __version__ as HA_VERSION
from smarthub.core import Context, HassJob, SmartHub, callback
from smarthub.helpers.aiohttp_client import SERVER_SOFTWARE
...
from smarthub.util.aiohttp import MockRequest, serialize_response
...
class CloudClient(Interface):
    """Interface class for SmartHub Cloud."""
