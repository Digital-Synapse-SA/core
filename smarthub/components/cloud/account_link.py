...
from smarthub.helpers import config_entry_oauth2_flow, event
...
async def _get_services(hass: SmartHub) -> list[dict[str, Any]]:
...
class CloudOAuth2Implementation(config_entry_oauth2_flow.AbstractOAuth2Implementation):
    ...
    def __init__(self, hass: SmartHub, service: str) -> None:
