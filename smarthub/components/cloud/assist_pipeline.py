...
from smarthub.components.conversation import HOME_ASSISTANT_AGENT
from smarthub.components.stt import DOMAIN as STT_DOMAIN
from smarthub.components.tts import DOMAIN as TTS_DOMAIN
...
async def async_create_cloud_pipeline(hass: SmartHub) -> str | None:
    ...
    def cloud_assist_pipeline(hass: SmartHub) -> str | None:
...
async def async_migrate_cloud_pipeline_engine(
    hass: SmartHub, platform: Platform, engine_id: str
) -> None:
