...
async def async_setup_entry(hass: SmartHub, entry: Eq3ConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: Eq3ConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: Eq3ConfigEntry) -> None:
    """Handle config entry update."""

    await hass.config_entries.async_reload(entry.entry_id)


async def _async_run_thermostat(hass: SmartHub, entry: Eq3ConfigEntry) -> None:
    """Run the thermostat."""
...
async def _async_reconnect_thermostat(
    hass: SmartHub, entry: Eq3ConfigEntry
) -> None:
