...
from smarthub.const import CONF_DEVICE_ID, CONF_PASSWORD, CONF_PIN, CONF_USERNAME
...
async def async_get_device_diagnostics(
    hass: SmartHub, config_entry: ConfigEntry, device: DeviceEntry
) -> dict[str, Any]:
    ...
    raise SmartHubError("Device not found")
