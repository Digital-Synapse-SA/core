...
from smarthub.components.script import CONF_MODE
from smarthub.const import CONF_DESCRIPTION, CONF_TYPE, SERVICE_RELOAD
...
async def async_reload(hass: SmartHub, service_call: ServiceCall) -> None:
...
def async_load_intents(hass: SmartHub, intents: dict[str, ConfigType]) -> None:
