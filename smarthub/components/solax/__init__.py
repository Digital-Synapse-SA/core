...
from smarthub.const import CONF_IP_ADDRESS, CONF_PASSWORD, CONF_PORT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: SolaxConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SolaxConfigEntry) -> bool:
