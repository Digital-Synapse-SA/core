...
from smarthub.loader import async_get_ssdp, bind_hass
from smarthub.util.logging import catch_log_exception
...
# Attributes for accessing info added by SmartHub
ATTR_HA_MATCHING_DOMAINS = "x_smarthub_matching_domains"
