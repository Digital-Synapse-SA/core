...
class HassUpnpServiceDevice(UpnpServerDevice):
    ...
    DEVICE_DEFINITION = DeviceInfo(
        device_type="urn:smart-hub.io:device:SmartHub:1",
        friendly_name="filled_later_on",
        manufacturer="SmartHub",
        manufacturer_url="https://www.smart-hub.io",
        model_description=None,
        model_name="filled_later_on",
        model_number=current_version,
        model_url="https://www.smart-hub.io",
        serial_number="filled_later_on",
        udn="filled_later_on",
        upc=None,
        presentation_url="https://my.smart-hub.io/",
        url="/device.xml",
        icons=[
            DeviceIcon(
                mimetype="image/png",
    ...
    async def _async_start_upnp_servers(self, event: Event) -> None:
        ...
        try:
            ...
            _LOGGER.warning(
                ...
                " in the SmartHub general configuration"
            )
            return
        ...
        HassUpnpServiceDevice.DEVICE_DEFINITION = (
            HassUpnpServiceDevice.DEVICE_DEFINITION._replace(
                udn=udn,
                friendly_name=f"{self.hass.config.location_name} (SmartHub)",
