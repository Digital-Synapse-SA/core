...
from smarthub.const import EVENT_HOMEASSISTANT_STOP, MATCH_ALL
from smarthub.core import HassJob, SmartHub, callback as core_callback
...
class Scanner:
    ...
    def __init__(
        self, hass: SmartHub, integration_matchers: IntegrationMatchers
    ) -> None:
        """Initialize class."""
        self.hass = hass
    ...
    def _ssdp_listener_process_callback(
        ...
        discovery_info.x_smarthub_matching_domains = matching_domains
