...
from smarthub.const import CONF_DEVICE_ID, CONF_PLATFORM, CONF_TYPE
...
async def async_attach_trigger(
    ...
    raise SmartHubError(f"Unhandled trigger type {trigger_type}")
