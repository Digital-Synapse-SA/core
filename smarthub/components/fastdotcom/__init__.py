...
async def async_setup_entry(hass: SmartHub, entry: FastdotcomConfigEntry) -> bool:
    ...
    async def _async_finish_startup(hass: SmartHub) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: FastdotcomConfigEntry) -> bool:
