...
@callback
def setup_bans(hass: SmartHub, app: Application, login_threshold: int) -> None:
...
def log_invalid_auth[_HassViewT: SmartHubView, **_P](
...
async def process_wrong_login(request: Request) -> None:
    ...
    from smarthub.components import persistent_notification  # noqa: PLC0415
