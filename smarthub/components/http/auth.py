...
from smarthub.auth import jwt_wrapper
...
from smarthub.helpers.http import current_request
...
CONTENT_USER_NAME = "SmartHub Content"
...
def async_user_not_allowed_do_auth(
    hass: SmartHub, user: User, request: Request | None = None
) -> str | None:
