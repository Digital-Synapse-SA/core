"""Decorators for the SmartHub API."""
...
def require_admin[
    ...
    *,
    ...
    [_FuncType[_SmartHubViewT, _P, _ResponseT]],
    _FuncType[_SmartHubViewT, _P, _ResponseT],
]: ...
...
def require_admin[
    ...
    **_P,
    ...
    _func: _FuncType[_SmartHubViewT, _P, _ResponseT],
) -> _FuncType[_SmartHubViewT, _P, _ResponseT]: ...
...
def require_admin[
    ...
    **_P,
    ...
    _func: _FuncType[_SmartHubViewT, _P, _ResponseT] | None = None,
    *,
    perm_category: str | None = None,
    permission: str | None = None,
) -> (
    ...
    """SmartHub API decorator to require user to be an admin."""

    def decorator_require_admin(
        func: _FuncType[_SmartHubViewT, _P, _ResponseT],
    ) -> _FuncType[_SmartHubViewT, _P, _ResponseT]:
