...
from smarthub.const import CONF_WEBHOOK_ID, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(hass: SmartHub, entry: TedeeConfigEntry) -> bool:
    """Integration setup."""
...
async def async_unload_entry(hass: SmartHub, entry: TedeeConfigEntry) -> bool:
...
def get_webhook_handler(
    ...
    async def async_webhook_handler(
        ...
        return SmartHubView.json(result="OK", status_code=HTTPStatus.OK)

    return async_webhook_handler


async def async_migrate_entry(
    hass: SmartHub, config_entry: TedeeConfigEntry
) -> bool:
    """Migrate old entry."""
