...
async def async_setup_entry(hass: SmartHub, entry: MastodonConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: MastodonConfigEntry) -> bool:
...
async def async_migrate_entry(hass: SmartHub, entry: MastodonConfigEntry) -> bool:
    """Migrate old config."""
