...
from smarthub.core import SmartHub, ServiceCall, ServiceResponse
...
def async_get_entry(hass: SmartHub, config_entry_id: str) -> MastodonConfigEntry:
...
def setup_services(hass: SmartHub) -> None:
