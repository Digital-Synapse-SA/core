...
from smarthub.core import SmartHub, get_release_channel
from smarthub.helpers import entity_platform, instance_id
from smarthub.helpers.event import async_call_later
from smarthub.helpers.system_info import async_get_system_info
from smarthub.loader import Integration, async_get_custom_components
...
def process_before_send(
    ...
    if (platform := entity_platform.current_platform.get()) is not None:
        ...
        if matches:
            ...
            # Handle the "smarthub." package differently
            if group1 == "smarthub" and group2 and group3:
                ...
                # Not the "smarthub" package, this third-party
    ...
    # Update event data with SmartHub Context
