...
async def async_setup_entry(hass: SmartHub, entry: WebOsTvConfigEntry) -> bool:
...
async def async_update_options(hass: SmartHub, entry: WebOsTvConfigEntry) -> None:
    """Update options."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: WebOsTvConfigEntry) -> bool:
