...
async def async_setup_entry(hass: SmartHub, entry: EnphaseConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: EnphaseConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: EnphaseConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
