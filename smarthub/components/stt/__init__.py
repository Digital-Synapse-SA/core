...
from smarthub.util import dt as dt_util, language as language_util
...
@callback
def async_get_speech_to_text_languages(hass: SmartHub) -> set[str]:
...
class SpeechToTextView(SmartHubView):
    ...
    def _get_provider(self, hass: SmartHub, provider: str) -> Provider:
        """Get provider.
        ...
        if not self._legacy_provider_reported:
            ...
            # This should raise in SmartHub Core 2023.9
            _LOGGER.warning(
    ...
    def _suggest_report_issue(
        self, hass: SmartHub, provider: str, provider_instance: object
    ) -> str:
