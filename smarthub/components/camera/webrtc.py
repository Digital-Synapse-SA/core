...
from smarthub.util.ulid import ulid
...
async def _async_refresh_providers(hass: SmartHub) -> None:
...
@callback
def async_register_ws(hass: SmartHub) -> None:
