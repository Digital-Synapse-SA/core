...
async def async_setup_entry(hass: SmartHub, entry: LitterRobotConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: LitterRobotConfigEntry
) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, entry: LitterRobotConfigEntry, device_entry: DeviceEntry
) -> bool:
