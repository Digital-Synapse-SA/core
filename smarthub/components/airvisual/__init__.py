...
def async_get_cloud_api_update_interval(
    hass: SmartHub, api_key: str, num_consumers: int
) -> timedelta:
...
async def async_setup_entry(hass: SmartHub, entry: AirVisualConfigEntry) -> bool:
...
async def async_migrate_entry(hass: SmartHub, entry: AirVisualConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AirVisualConfigEntry) -> bool:
...
async def async_reload_entry(hass: SmartHub, entry: AirVisualConfigEntry) -> None:
