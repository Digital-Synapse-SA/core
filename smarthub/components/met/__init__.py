...
async def async_setup_entry(
    hass: SmartHub, config_entry: MetWeatherConfigEntry
) -> bool:
...
async def async_update_entry(hass: SmartHub, config_entry: MetWeatherConfigEntry):
    """Reload Met component when options changed."""
    await hass.config_entries.async_reload(config_entry.entry_id)


async def cleanup_old_device(hass: SmartHub) -> None:
