...
async def async_setup(hass: SmartHub, hass_config: ConfigType) -> bool:
...
async def async_setup_entry(hass: SmartHub, entry: ElkM1ConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: ElkM1ConfigEntry) -> bool:
