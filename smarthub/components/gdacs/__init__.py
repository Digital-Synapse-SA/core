...
async def async_setup_entry(
    hass: SmartHub, config_entry: GdacsConfigEntry
) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: GdacsConfigEntry) -> bool:
...
class GdacsFeedEntityManager:
    ...
    def __init__(
        self, hass: SmartHub, config_entry: GdacsConfigEntry, radius_in_km: float
    ) -> None:
