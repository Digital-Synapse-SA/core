...
from smarthub.components import media_source, plex, spotify
    ...
    if speaker.favorites:
        children.append(
            BrowseMedia(
                ...
                thumbnail="https://brands.smart-hub.io/_/sonos/logo.png",
                can_play=False,
                can_expand=True,
            )
        )
    ...
    if "plex" in hass.config.components:
        children.append(
            BrowseMedia(
                ...
                thumbnail="https://brands.smart-hub.io/_/plex/logo.png",
                can_play=False,
                can_expand=True,
            )
        )
