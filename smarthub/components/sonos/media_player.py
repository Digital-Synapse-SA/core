...
from smarthub.components.plex import PLEX_URI_SCHEME
from smarthub.components.plex.services import process_plex_payload
from smarthub.const import ATTR_TIME
from smarthub.core import SmartHub, ServiceCall, SupportsResponse, callback
from smarthub.exceptions import SmartHubError, ServiceValidationError
from smarthub.helpers import config_validation as cv, entity_platform, service
    ...
    async def async_join_players(self, group_members: list[str]) -> None:
        ...
        for entity_id in group_members:
            if speaker := self.config_entry.runtime_data.entity_id_mappings.get(
                ...
                raise SmartHubError(f"Not a known Sonos entity_id: {entity_id}")
