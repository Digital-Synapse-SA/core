...
async def async_get_device_diagnostics(
    hass: SmartHub, config_entry: SonosConfigEntry, device: DeviceEntry
) -> dict[str, Any]:
...
async def async_generate_media_info(
    hass: SmartHub, speaker: SonosSpeaker
) -> dict[str, Any]:
...
async def async_generate_speaker_info(
    hass: SmartHub, config_entry: SonosConfigEntry, speaker: SonosSpeaker
) -> dict[str, Any]:
