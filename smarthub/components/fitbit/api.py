"""API for fitbit bound to SmartHub OAuth."""
...
class FitbitApi(ABC):
    ...
    async def _async_get_client(self) -> Fitbit:
        ...
        # Always rely on SmartHub's token update mechanism which refreshes
    ...
    async def async_get_unit_system(self) -> FitbitUnitSystem:
        ...
        units returned by the API. The second is to tell SmartHub the
