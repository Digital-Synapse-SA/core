...
async def async_setup_entry(hass: SmartHub, entry: PingConfigEntry) -> bool:
...
async def async_reload_entry(hass: SmartHub, entry: PingConfigEntry) -> None:
    """Handle an options update."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: PingConfigEntry) -> bool:
