...
def _async_trigger_ble_lock_discovery(
    hass: SmartHub, locks_with_offline_keys: list[LockDetail]
) -> None:
...
class AugustData(YaleXSData):
    ...
    def __init__(self, hass: SmartHub, august_gateway: AugustGateway) -> None:
        """Init August data object."""
        self._hass = hass
        super().__init__(august_gateway, SmartHubError)
