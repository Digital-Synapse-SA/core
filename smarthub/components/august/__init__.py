...
def _async_create_yale_brand_migration_issue(
    hass: SmartHub, entry: AugustConfigEntry
) -> None:
    ...
    ir.async_create_issue(
        ...
        learn_more_url="https://www.smart-hub.io/integrations/yale",
...
async def async_setup_entry(hass: SmartHub, entry: AugustConfigEntry) -> bool:
...
async def async_remove_entry(hass: SmartHub, entry: AugustConfigEntry) -> None:
    """Remove an August config entry."""
    ir.async_delete_issue(hass, DOMAIN, "yale_brand_migration")


async def async_unload_entry(hass: SmartHub, entry: AugustConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_setup_august(
    hass: SmartHub, entry: AugustConfigEntry, august_gateway: AugustGateway
) -> None:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: AugustConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
