...
from smarthub.util.ssl import client_context_no_verify
...
async def async_setup_entry(hass: SmartHub, entry: DaikinConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: DaikinConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_unique_id(
    hass: SmartHub, config_entry: DaikinConfigEntry, device: Appliance
) -> None:
    """Migrate old entry."""
