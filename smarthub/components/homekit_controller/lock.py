...
from smarthub.components.lock import LockEntity, LockState
from smarthub.config_entries import ConfigEntry
from smarthub.const import ATTR_BATTERY_LEVEL, STATE_UNKNOWN, Platform
...
class HomeKitLock(HomeKitEntity, LockEntity):
    ...
    async def _set_lock_state(self, state: LockState) -> None:
        ...
        # https://github.com/smart-hub/core/issues/81887
