...
async def async_get_imap_client(hass: SmartHub, entry_id: str) -> IMAP4_SSL:
...
async def async_setup_entry(hass: SmartHub, entry: ImapConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: ImapConfigEntry) -> bool:
