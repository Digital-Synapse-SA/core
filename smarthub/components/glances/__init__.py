...
async def async_setup_entry(
    hass: SmartHub, config_entry: GlancesConfigEntry
) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: GlancesConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def get_api(hass: SmartHub, entry_data: dict[str, Any]) -> Glances:
...
class ServerVersionMismatch(SmartHubError):
