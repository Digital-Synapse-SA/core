...
async def async_setup_entry(hass: SmartHub, entry: FlickConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FlickConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(
    hass: SmartHub, config_entry: FlickConfigEntry
) -> bool:
    """Migrate old entry."""
    _LOGGER.debug(
...
class HassFlickAuth(SimpleFlickAuth):
    """Implementation of AbstractFlickAuth based on a SmartHub entity config."""

    def __init__(self, hass: SmartHub, entry: FlickConfigEntry) -> None:
        """Flick authentication based on a SmartHub entity config."""
        super().__init__(
