...
from smarthub.const import CONF_EXCLUDE, CONF_HOSTS, EVENT_HOMEASSISTANT_STARTED
...
@callback
def _async_untrack_devices(hass: SmartHub, entry: ConfigEntry) -> None:
...
class NmapDeviceScanner:
    ...
    def __init__(
        self, hass: SmartHub, entry: ConfigEntry, devices: NmapTrackedDevices
    ) -> None:
