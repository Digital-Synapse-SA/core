...
from smarthub.components.network import MDNS_TARGET_IP
...
async def async_get_network(hass: SmartHub) -> str:
...
async def _async_build_schema_with_user_input(
    hass: SmartHub, user_input: dict[str, Any], include_options: bool
) -> vol.Schema:
