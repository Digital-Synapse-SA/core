...
async def async_setup_entry(hass: SmartHub, entry: ConfigEntry) -> bool:
    ...
    # Register SmartHub functions to use in the library
...
async def options_update_listener(hass: SmartHub, entry: ConfigEntry) -> None:
...
async def apply_options(hass: SmartHub, entry: ConfigEntry) -> None:
