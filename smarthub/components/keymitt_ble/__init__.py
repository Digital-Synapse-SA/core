"""Integration to integrate Keymitt BLE devices with SmartHub."""
...
from smarthub.const import CONF_ACCESS_TOKEN, CONF_ADDRESS, Platform
...
async def async_setup_entry(hass: SmartHub, entry: MicroBotConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: MicroBotConfigEntry) -> bool:
