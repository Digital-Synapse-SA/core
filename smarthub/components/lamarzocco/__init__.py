...
from smarthub.components.bluetooth import async_discovered_service_info
...
async def async_setup_entry(hass: SmartHub, entry: LaMarzoccoConfigEntry) -> bool:
    ...
    async def update_listener(
        hass: SmartHub, entry: LaMarzoccoConfigEntry
    ) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: LaMarzoccoConfigEntry) -> bool:
