...
from smarthub.const import CONF_TOKEN, CONF_URL, CONF_VERIFY_SSL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: NtfyConfigEntry) -> bool:
...
async def _async_update_listener(hass: SmartHub, entry: NtfyConfigEntry) -> None:
    """Handle update."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: NtfyConfigEntry) -> bool:
