...
from smarthub.components.http.static import CACHE_HEADERS
...
class ImageStorageCollection(collection.DictStorageCollection):
    ...
    def __init__(self, hass: SmartHub, image_dir: pathlib.Path) -> None:
...
class ImageUploadView(SmartHubView):
...
class ImageServeView(SmartHubView):
