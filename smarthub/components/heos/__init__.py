...
async def async_setup_entry(hass: SmartHub, entry: HeosConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: HeosConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_remove_config_entry_device(
    hass: SmartHub, entry: HeosConfigEntry, device: dr.DeviceEntry
) -> bool:
