...
from smarthub.components.media_source import BrowseMediaSource
from smarthub.const import Platform
from smarthub.core import SmartHub, ServiceResponse, callback
...
def catch_action_error[**_P, _R](
    ...
    """Return decorator that catches errors and raises SmartHubError."""
