...
from smarthub.components.media_player import ATTR_MEDIA_VOLUME_LEVEL
from smarthub.config_entries import ConfigEntryState
from smarthub.core import SmartHub, ServiceCall, SupportsResponse
...
from smarthub.helpers.typing import VolDictType, VolSchemaType
...
def register(hass: SmartHub) -> None:
...
def _get_controller(hass: SmartHub) -> Heos:
