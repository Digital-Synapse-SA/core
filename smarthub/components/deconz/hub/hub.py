...
from smarthub.config_entries import SOURCE_HASSIO
...
class DeconzHub:
    ...
    def __init__(
        self, hass: SmartHub, config_entry: DeconzConfigEntry, api: DeconzSession
    ) -> None:
    ...
    async def async_config_entry_updated(
        hass: SmartHub, config_entry: DeconzConfigEntry
    ) -> None:
