...
from smarthub.const import CONF_API_TOKEN, CONF_HOST, CONF_VERIFY_SSL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: MealieConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: MealieConfigEntry) -> bool:
