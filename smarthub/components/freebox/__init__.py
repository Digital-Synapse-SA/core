...
from smarthub.const import CONF_HOST, CONF_PORT, EVENT_HOMEASSISTANT_STOP
...
async def async_setup_entry(hass: SmartHub, entry: FreeboxConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FreeboxConfigEntry) -> bool:
