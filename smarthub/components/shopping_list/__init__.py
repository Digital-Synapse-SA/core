...
from smarthub.const import ATTR_NAME, Platform
...
from smarthub.util.json import JsonValueType, load_json_array
...
class ShoppingListView(http.SmartHubView):
...
class UpdateShoppingListItemView(http.SmartHubView):
    """View to retrieve shopping list content."""
...
class CreateShoppingListItemView(http.SmartHubView):
    """View to retrieve shopping list content."""
...
class ClearCompletedItemsView(http.SmartHubView):
    """View to retrieve shopping list content."""
