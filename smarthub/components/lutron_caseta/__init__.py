...
from smarthub.const import ATTR_DEVICE_ID, CONF_HOST, Platform
...
async def async_setup(hass: SmartHub, base_config: ConfigType) -> bool:
...
async def _async_migrate_unique_ids(
    hass: SmartHub, entry: LutronCasetaConfigEntry
) -> None:
...
def _async_register_bridge_device(
    hass: SmartHub, config_entry_id: str, bridge_device: dict, bridge: Smartbridge
) -> None:
...
async def async_remove_config_entry_device(
    hass: SmartHub, entry: LutronCasetaConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
