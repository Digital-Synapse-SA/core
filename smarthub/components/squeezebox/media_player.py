...
from smarthub.config_entries import SOURCE_INTEGRATION_DISCOVERY
from smarthub.const import ATTR_COMMAND, CONF_HOST, CONF_PORT, Platform
...
from smarthub.helpers.start import async_at_start
...
async def start_server_discovery(hass: SmartHub) -> None:
...
class SqueezeBoxMediaPlayerEntity(SqueezeboxEntity, MediaPlayerEntity):
    ...
    def shuffle(self) -> bool:
        ...
        # Squeezebox has a third shuffle mode (album) not recognized by SmartHub
