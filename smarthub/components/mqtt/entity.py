...
from smarthub.core import Event, HassJobType, SmartHub, callback
...
from smarthub.helpers.service_info.mqtt import ReceivePayloadType
from smarthub.helpers.typing import (
    UNDEFINED,
    ConfigType,
    DiscoveryInfoType,
    UndefinedType,
...
from smarthub.util.yaml import dump as yaml_dump
...
def _verify_mqtt_config_entry_enabled_for_discovery(
    hass: SmartHub, domain: str, discovery_payload: MQTTDiscoveryPayload
) -> bool:
...
def init_entity_id_from_config(
    hass: SmartHub, entity: Entity, config: ConfigType, entity_id_format: str
) -> None:
...
async def cleanup_device_registry(
    hass: SmartHub, device_id: str | None, config_entry_id: str | None
) -> None:
...
def send_discovery_done(hass: SmartHub, discovery_data: DiscoveryInfoType) -> None:
        ...
        if self._discovery_data[ATTR_DISCOVERY_TOPIC] != new_discovery_topic:
            ...
            if new_origin_support_url:
                ...
                get_support = (
                    ...
                    "discovery schema, visit https://www.smart-hub.io/integrations/"
...
def ensure_via_device_exists(
    hass: SmartHub, device_info: DeviceInfo | None, config_entry: ConfigEntry
) -> None:
