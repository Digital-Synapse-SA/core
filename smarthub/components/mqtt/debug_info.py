...
def add_subscription(
    hass: SmartHub, subscription: str, entity_id: str | None
) -> None:
...
def add_entity_discovery_data(
    hass: SmartHub, discovery_data: DiscoveryInfoType, entity_id: str
) -> None:
    """Add discovery data."""
    entity_info = hass.data[DATA_MQTT].debug_info_entities.setdefault(
        entity_id, {"subscriptions": {}, "discovery_data": {}, "transmitted": {}}
...
def update_entity_discovery_data(
    hass: SmartHub, discovery_payload: DiscoveryInfoType, entity_id: str
) -> None:
...
def remove_entity_data(hass: SmartHub, entity_id: str) -> None:
...
def remove_trigger_discovery_data(
    hass: SmartHub, discovery_hash: tuple[str, str]
) -> None:
    """Remove discovery data."""
    hass.data[DATA_MQTT].debug_info_triggers.pop(discovery_hash, None)


def _info_for_entity(hass: SmartHub, entity_id: str) -> dict[str, Any]:
...
def _info_for_trigger(
    hass: SmartHub, trigger_key: tuple[str, str]
) -> dict[str, Any]:
...
def info_for_config_entry(hass: SmartHub) -> dict[str, list[Any]]:
...
def info_for_device(hass: SmartHub, device_id: str) -> dict[str, list[Any]]:
