...
from smarthub.components.button import ButtonDeviceClass
from smarthub.components.cover import CoverDeviceClass
...
from smarthub.data_entry_flow import AbortFlow, SectionConfig, section
...
async def _get_uploaded_file(hass: SmartHub, id: str) -> bytes:
