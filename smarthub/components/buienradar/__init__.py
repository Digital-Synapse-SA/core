...
async def async_setup_entry(hass: SmartHub, entry: BuienRadarConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BuienRadarConfigEntry) -> bool:
...
async def async_update_options(
    hass: SmartHub, config_entry: BuienRadarConfigEntry
) -> None:
    """Update options."""
