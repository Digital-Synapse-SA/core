...
class BSBLanData:
    """BSBLan data stored in the SmartHub data object."""
...
async def async_setup_entry(hass: SmartHub, entry: BSBLanConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BSBLanConfigEntry) -> bool:
