...
class SatelliteDevice:
    ...
    def get_assist_in_progress_entity_id(self, hass: SmartHub) -> str | None:
    ...
    def get_muted_entity_id(self, hass: SmartHub) -> str | None:
    ...
    def get_pipeline_entity_id(self, hass: SmartHub) -> str | None:
    ...
    def get_noise_suppression_level_entity_id(self, hass: SmartHub) -> str | None:
    ...
    def get_auto_gain_entity_id(self, hass: SmartHub) -> str | None:
    ...
    def get_volume_multiplier_entity_id(self, hass: SmartHub) -> str | None:
    ...
    def get_vad_sensitivity_entity_id(self, hass: SmartHub) -> str | None:
