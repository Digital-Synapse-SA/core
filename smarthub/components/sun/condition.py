...
from smarthub.const import CONF_CONDITION, SUN_EVENT_SUNRISE, SUN_EVENT_SUNSET
from smarthub.core import SmartHub
from smarthub.helpers import config_validation as cv
from smarthub.helpers.condition import (
...
def async_condition_from_config(config: ConfigType) -> ConditionCheckerType:
    ...
    @trace_condition_function
    def sun_if(hass: SmartHub, variables: TemplateVarsType = None) -> bool:
