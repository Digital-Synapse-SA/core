...
from smarthub.components.device_tracker import ATTR_GPS, ATTR_IP, ATTR_MAC
from smarthub.components.diagnostics import REDACTED, async_redact_data
from smarthub.components.person import ATTR_USER_ID
...
async def async_get_config_entry_diagnostics(
    hass: SmartHub, entry: ProximityConfigEntry
) -> dict[str, Any]:
