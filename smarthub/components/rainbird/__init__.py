...
async def async_setup_entry(hass: SmartHub, entry: RainbirdConfigEntry) -> bool:
...
async def _async_fix_unique_id(
    hass: SmartHub, controller: AsyncRainbirdController, entry: RainbirdConfigEntry
) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: RainbirdConfigEntry) -> bool:
