...
from smarthub.const import CONF_HOST, CONF_PORT, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(hass: SmartHub, entry: AprilaireConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AprilaireConfigEntry) -> bool:
