...
from smarthub.components.notify import ATTR_DATA, BaseNotificationService
from smarthub.const import CONF_ICON
...
class LaMetricNotificationService(BaseNotificationService):
    ...
    async def async_send_message(self, message: str = "", **kwargs: Any) -> None:
        ...
        try:
            ...
            raise SmartHubError("Could not send LaMetric notification") from ex
