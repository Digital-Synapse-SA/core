...
from smarthub.helpers.config_entry_oauth2_flow import AbstractOAuth2FlowHandler
...
from smarthub.util.network import is_link_local
    ...
    async def _async_step_create_entry(
        ...
        await lametric.notify(
            notification=Notification(
                ...
                model=Model(
                    cycles=2,
                    frames=[Simple(text="Connected to SmartHub!", icon=7956)],
                    sound=notify_sound,
                ),
            )
        )
