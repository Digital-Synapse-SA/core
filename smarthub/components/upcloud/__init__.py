...
async def _async_signal_options_update(
    hass: SmartHub, config_entry: UpCloudConfigEntry
) -> None:
...
async def async_setup_entry(hass: SmartHub, entry: UpCloudConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: UpCloudConfigEntry) -> bool:
