...
class Filters:
    ...
    def _generate_filter_for_columns(
        ...
        This must match exactly how smarthub.helpers.entityfilter works.
        """
    ...
    def events_entity_filter(self) -> ColumnElement:
        ...
        return or_(
            ...
            # Needs https://github.com/bdraco/smart-hub/commit/bba91945006a46f3a01870008eb048e4f9cbb1ef
