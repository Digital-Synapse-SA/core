...
from smarthub.core import SmartHub, callback, valid_entity_id
from smarthub.exceptions import SmartHubError
from smarthub.helpers.recorder import DATA_RECORDER
...
def _generate_statistics_at_time_stmt_dependent_sub_query(
    ...
    # https://github.com/smart-hub/core/issues/132865
...
def validate_statistics(hass: SmartHub) -> dict[str, list[ValidationIssue]]:
    """Validate statistics."""
...
def update_statistics_issues(hass: SmartHub) -> None:
    ...
    for statistic in statistics:
        ...
        if "last_reset" in statistic and statistic["last_reset"] is not None:
            ...
            if (
                ...
                raise SmartHubError("Naive timestamp")
