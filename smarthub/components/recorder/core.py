...
class Recorder(threading.Thread):
    ...
    @callback
    def _async_hass_started(self, hass: SmartHub) -> None:
    ...
    def _run(self) -> None:
        ...
        if schema_status.current_version > SCHEMA_VERSION:
            _LOGGER.error(
                ...
                "SmartHub Core, either upgrade SmartHub Core or restore "
        ...
        if self._wait_startup_or_shutdown() is SHUTDOWN_TASK:
            # Shutdown happened before SmartHub finished starting
            self.migration_in_progress = False
