...
from smarthub.util.ulid import ulid_at_time, ulid_to_bytes
...
MIGRATION_NOTE_OFFLINE = (
    ...
    "SmartHub will not start until the upgrade is completed. Please be patient "
    "and do not turn off or restart SmartHub while the upgrade is in progress!"
)
...
def validate_db_schema(
    hass: SmartHub, instance: Recorder, session_maker: Callable[[], Session]
...
class _SchemaVersion33Migrator(_SchemaVersionMigrator, target_version=33):
    def _apply_update(self) -> None:
        ...
        # https://github.com/smart-hub/core/issues/83787
...
class _SchemaVersion48Migrator(_SchemaVersionMigrator, target_version=48):
    def _apply_update(self) -> None:
        """Version specific update method."""
        # https://github.com/smart-hub/core/issues/134002
...
def _correct_table_character_set_and_collation(
    ...
    with (
        ...
        connection.execute(
            ...
            # https://github.com/smart-hub/core/issues/56104
            text(
...
class EventIDPostMigration(BaseRunTimeMigration):
    ...
    # https://github.com/smart-hub/core/pull/120779
