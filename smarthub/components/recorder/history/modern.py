...
from smarthub.const import COMPRESSED_STATE_LAST_UPDATED, COMPRESSED_STATE_STATE
from smarthub.core import SmartHub, State, split_entity_id
from smarthub.helpers.recorder import get_instance
...
def get_last_state_changes(
    hass: SmartHub, number_of_states: int, entity_id: str
) -> dict[str, list[State]]:
...
def _get_oldest_possible_ts(
    hass: SmartHub, utc_point_in_time: datetime
) -> float | None:
