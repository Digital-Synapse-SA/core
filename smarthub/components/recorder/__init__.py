...
from smarthub.helpers.recorder import DATA_INSTANCE
...
DEFAULT_DB_FILE = "smart-hub_v2.db"
...
@bind_hass
def is_entity_recorded(hass: SmartHub, entity_id: str) -> bool:
...
async def _async_setup_integration_platform(
    hass: SmartHub, instance: Recorder
) -> None:
...
def get_default_url(hass: SmartHub) -> str:
