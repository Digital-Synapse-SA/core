...
from smarthub.const import EntityCategory, Platform, UnitOfTemperature
...
class ISYSensorEntity(ISYNodeEntity, SensorEntity):
    ...
    def native_value(self) -> float | int | str | None:
        ...
        # Convert temperatures to SmartHub's unit
    ...
    def native_unit_of_measurement(self) -> str | None:
        """Get the SmartHub unit of measurement for the device."""
