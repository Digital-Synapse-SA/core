...
# ISY Scenes are more like Switches than SmartHub Scenes
...
# Do not use the SmartHub consts for the states here - we're matching exact API
# responses, not using them for SmartHub states
