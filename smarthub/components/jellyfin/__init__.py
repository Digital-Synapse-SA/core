...
async def async_setup_entry(hass: SmartHub, entry: JellyfinConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: JellyfinConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: JellyfinConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
