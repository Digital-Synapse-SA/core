...
async def async_setup_entry(hass: SmartHub, entry: NexiaConfigEntry) -> bool:
    """Configure the base Nexia device for SmartHub."""
...
async def async_unload_entry(hass: SmartHub, entry: NexiaConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_remove_config_entry_device(
    hass: SmartHub, entry: NexiaConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
...
async def async_migrate_entry(hass: SmartHub, entry: NexiaConfigEntry) -> bool:
    """Migrate entry."""
