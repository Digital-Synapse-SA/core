...
from smarthub.helpers.entity import Entity, ToggleEntity
...
class BasePlatform(Entity):
    ...
    def __init__(
        self, hass: SmartHub, hub: ModbusHub, entry: dict[str, Any]
    ) -> None:
...
class BaseStructPlatform(BasePlatform, RestoreEntity):
    ...
    def __init__(self, hass: SmartHub, hub: ModbusHub, config: dict) -> None:
