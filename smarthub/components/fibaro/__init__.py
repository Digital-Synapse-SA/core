...
from smarthub.const import CONF_PASSWORD, CONF_URL, CONF_USERNAME, Platform
from smarthub.core import SmartHub
from smarthub.exceptions import ConfigEntryAuthFailed, ConfigEntryNotReady
from smarthub.helpers import device_registry as dr
from smarthub.helpers.device_registry import DeviceEntry, DeviceInfo
...
async def async_setup_entry(hass: SmartHub, entry: FibaroConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FibaroConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: FibaroConfigEntry, device_entry: DeviceEntry
) -> bool:
