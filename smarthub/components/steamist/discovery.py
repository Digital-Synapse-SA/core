...
from smarthub.const import CONF_MODEL, CONF_NAME
...
async def async_discover_device(hass: SmartHub, host: str) -> Device30303 | None:
...
@callback
def async_get_discovery(hass: SmartHub, host: str) -> Device30303 | None:
