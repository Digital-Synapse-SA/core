...
async def async_migrate_entry(
    hass: SmartHub, config_entry: IntellifireConfigEntry
) -> bool:
    """Migrate entries."""
    LOGGER.debug(
...
async def async_setup_entry(hass: SmartHub, entry: IntellifireConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: IntellifireConfigEntry
) -> bool:
