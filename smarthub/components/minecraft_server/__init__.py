...
from smarthub.const import CONF_ADDRESS, CONF_HOST, CONF_PORT, Platform
...
async def async_setup_entry(
    hass: SmartHub, entry: MinecraftServerConfigEntry
) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, config_entry: MinecraftServerConfigEntry
) -> bool:
