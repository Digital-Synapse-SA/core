...
class ReolinkFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        placeholders = {
            "error": "",
            "troubleshooting_link": "https://www.smart-hub.io/integrations/reolink/#troubleshooting",
        }
        ...
        if user_input is not None:
            ...
            try:
                ...
                placeholders["more_info"] = (
                    "https://www.smart-hub.io/more-info/no-url-available/#configuring-the-instance-url"
                )
