...
from smarthub.components.media_source import Unresolvable
...
from smarthub.helpers.translation import async_get_exception_message
...
def is_connected(hass: SmartHub, config_entry: config_entries.ConfigEntry) -> bool:
...
def get_host(hass: SmartHub, config_entry_id: str) -> ReolinkHost:
...
def get_store(hass: SmartHub, config_entry_id: str) -> Store[str]:
