...
from smarthub.components.camera import DOMAIN as CAM_DOMAIN, DynamicStreamSettings
from smarthub.components.media_player import MediaClass, MediaType
...
async def async_get_media_source(hass: SmartHub) -> ReolinkVODMediaSource:
