"""Reolink integration for SmartHub."""
...
from smarthub.const import CONF_PORT, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(
    hass: SmartHub, config_entry: ReolinkConfigEntry
) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: ReolinkConfigEntry, device: dr.DeviceEntry
) -> bool:
...
def migrate_entity_ids(
    hass: SmartHub, config_entry_id: str, host: ReolinkHost
) -> None:
