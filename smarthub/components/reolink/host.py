...
from smarthub.core import CALLBACK_TYPE, HassJob, SmartHub, callback
...
class ReolinkHost:
        ...
        if not self._long_poll_received:
            ...
            ir.async_create_issue(
                ...
                translation_placeholders={
                    ...
                    "network_link": "https://my.smart-hub.io/redirect/network/",
                },
            )
            ...
            if self._hass.config.api is not None and self._hass.config.api.use_ssl:
                ir.async_create_issue(
                    ...
                    translation_key="ssl",
                    translation_placeholders={
                        "ssl_link": "https://www.smart-hub.io/integrations/http/#ssl_certificate",
                        "base_url": self._base_url,
                        "network_link": "https://my.smart-hub.io/redirect/network/",
                        "nginx_link": "https://github.com/smart-hub/addons/tree/master/nginx_proxy",
                    },
                )
            else:
    ...
    async def _process_webhook_data(
        self, hass: SmartHub, webhook_id: str, data: bytes | None
    ) -> None:
