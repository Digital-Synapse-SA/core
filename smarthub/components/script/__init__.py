...
from smarthub.helpers.config_validation import make_entity_service_schema
...
from smarthub.helpers.service import async_set_service_schema
from smarthub.helpers.trace import trace_get, trace_path
...
def _x_in_script(hass: SmartHub, entity_id: str, property_name: str) -> list[str]:
...
@callback
def blueprint_in_script(hass: SmartHub, entity_id: str) -> str | None:
...
async def _create_script_entities(
    hass: SmartHub, script_configs: list[ScriptEntityConfig]
