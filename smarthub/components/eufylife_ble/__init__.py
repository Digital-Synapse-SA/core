...
from smarthub.const import CONF_MODEL, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(hass: SmartHub, entry: EufyLifeConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: EufyLifeConfigEntry) -> bool:
