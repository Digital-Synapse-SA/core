...
from smarthub.const import CONF_API_KEY, CONF_API_TOKEN, Platform
...
async def async_setup_entry(hass: SmartHub, entry: CoinbaseConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: CoinbaseConfigEntry) -> bool:
...
async def update_listener(
    hass: SmartHub, config_entry: CoinbaseConfigEntry
) -> None:
