...
from smarthub.const import ATTR_CONFIGURATION_URL, CONF_HOST
...
async def async_get_device_diagnostics(
    hass: SmartHub, entry: PowerviewConfigEntry, device: DeviceEntry
) -> dict[str, Any]:
...
@callback
def _async_device_as_dict(hass: SmartHub, device: DeviceEntry) -> dict[str, Any]:
    """Represent a Powerview device as a dictionary."""

    # Gather information how this device is represented in SmartHub
