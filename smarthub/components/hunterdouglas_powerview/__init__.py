...
from smarthub.const import CONF_API_VERSION, CONF_HOST, Platform
...
async def async_setup_entry(hass: SmartHub, entry: PowerviewConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: PowerviewConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: PowerviewConfigEntry) -> bool:
    """Migrate entry."""
...
async def _async_add_missing_entry_unique_id(
    hass: SmartHub, entry: PowerviewConfigEntry
) -> None:
...
async def _migrate_unique_ids(hass: SmartHub, entry: PowerviewConfigEntry) -> None:
