...
_GO2RTC_CONFIG_FORMAT = r"""# This file is managed by SmartHub
...
class Go2RTCServerStartError(SmartHubError):
    """Raised when server does not start."""

    _message = "Go2rtc server didn't start correctly"


class Go2RTCWatchdogError(SmartHubError):
...
class Server:
    ...
    def __init__(
        self, hass: SmartHub, binary: str, *, enable_ui: bool = False
    ) -> None:
