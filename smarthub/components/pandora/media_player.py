...
from smarthub.core import DOMAIN as HOMEASSISTANT_DOMAIN, Event, SmartHub
    ...
    async def _start_pianobar(self) -> bool:
        ...
        if mode == 1:
            ...
            _LOGGER.warning(
                ...
                "https://www.smart-hub.io/integrations/pandora/"
            )
...
def _pianobar_exists() -> bool:
    ...
    _LOGGER.warning(
        ...
        "https://www.smart-hub.io/integrations/media_player.pandora/"
    )
    return False
