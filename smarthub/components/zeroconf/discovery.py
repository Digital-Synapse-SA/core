"""Zeroconf discovery for SmartHub."""
...
from smarthub.loader import HomeKitDiscoveredIntegration, ZeroconfMatcher
...
ZEROCONF_TYPE = "_smart-hub._tcp.local."
HOMEKIT_TYPES = [
    "_hap._tcp.local.",
...
class ZeroconfDiscovery:
    ...
    async def async_setup(self) -> None:
        ...
        # We want to make sure we know about other SmartHub
