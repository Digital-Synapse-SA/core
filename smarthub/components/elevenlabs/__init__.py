...
async def async_setup_entry(hass: SmartHub, entry: ElevenLabsConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: ElevenLabsConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def update_listener(
    hass: SmartHub, config_entry: ElevenLabsConfigEntry
) -> None:
