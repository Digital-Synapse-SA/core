...
from smarthub.const import CONF_ACCESS_TOKEN, CONF_TOKEN, Platform
...
async def async_setup_entry(hass: SmartHub, entry: TeslaFleetConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: TeslaFleetConfigEntry) -> bool:
