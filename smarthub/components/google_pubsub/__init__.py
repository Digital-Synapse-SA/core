...
from smarthub.const import EVENT_STATE_CHANGED, STATE_UNAVAILABLE, STATE_UNKNOWN
from smarthub.core import Event, EventStateChangedData, SmartHub
from smarthub.helpers import config_validation as cv
from smarthub.helpers.entityfilter import FILTER_SCHEMA
...
def setup(hass: SmartHub, yaml_config: ConfigType) -> bool:
