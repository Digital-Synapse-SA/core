...
from smarthub.const import CONF_DEVICES, CONF_HOST, CONF_NAME, CONF_PORT
...
def to_futurenow_level(level):
    """Convert the given SmartHub light level (0-255) to FutureNow (0-100)."""
    return round((level * 100) / 255)


def to_hass_level(level):
    """Convert the given FutureNow (0-100) light level to SmartHub (0-255)."""
