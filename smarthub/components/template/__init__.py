...
from smarthub.core import Event, SmartHub, ServiceCall
from smarthub.exceptions import ConfigEntryError, SmartHubError
from smarthub.helpers import discovery
from smarthub.helpers.device import (
    async_remove_stale_devices_links_keep_current_device,
)
from smarthub.helpers.reload import async_reload_integration_platforms
...
async def _process_config(hass: SmartHub, hass_config: ConfigType) -> None:
    """Process config."""
    ...
    async def init_coordinator(
        hass: SmartHub, conf_section: dict[str, Any]
