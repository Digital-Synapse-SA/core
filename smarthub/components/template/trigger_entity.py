...
from smarthub.const import CONF_STATE
from smarthub.core import SmartHub, callback
from smarthub.helpers.template import _SENTINEL
from smarthub.helpers.trigger_template_entity import TriggerBaseEntity
