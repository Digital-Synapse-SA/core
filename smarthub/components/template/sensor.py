...
from smarthub.components.sensor.helpers import async_parse_date_datetime
...
from smarthub.helpers.trigger_template_entity import TEMPLATE_SENSOR_BASE_SCHEMA
...
def extra_validation_checks(val):
    ...
    if CONF_TRIGGERS in val or CONF_TRIGGER in val:
        raise vol.Invalid(
            ...
            " https://www.smart-hub.io/integrations/template/"
        )
