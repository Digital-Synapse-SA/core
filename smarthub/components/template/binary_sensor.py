...
from smarthub.helpers import config_validation as cv, selector, template
from smarthub.helpers.device import async_device_info_to_link_from_device_id
from smarthub.helpers.entity import async_generate_entity_id
from smarthub.helpers.entity_platform import (
    AddConfigEntryEntitiesCallback,
    AddEntitiesCallback,
)
from smarthub.helpers.event import async_call_later, async_track_point_in_utc_time
...
def rewrite_legacy_to_modern_conf(
    hass: SmartHub, cfg: dict[str, dict]
) -> list[dict]:
