...
from smarthub.components.binary_sensor import DOMAIN as DOMAIN_BINARY_SENSOR
from smarthub.components.blueprint import (
    is_blueprint_instance_config,
    schemas as blueprint_schemas,
)
from smarthub.components.button import DOMAIN as DOMAIN_BUTTON
from smarthub.components.cover import DOMAIN as DOMAIN_COVER
from smarthub.components.fan import DOMAIN as DOMAIN_FAN
from smarthub.components.image import DOMAIN as DOMAIN_IMAGE
from smarthub.components.light import DOMAIN as DOMAIN_LIGHT
from smarthub.components.lock import DOMAIN as DOMAIN_LOCK
from smarthub.components.number import DOMAIN as DOMAIN_NUMBER
from smarthub.components.select import DOMAIN as DOMAIN_SELECT
from smarthub.components.sensor import DOMAIN as DOMAIN_SENSOR
from smarthub.components.switch import DOMAIN as DOMAIN_SWITCH
from smarthub.components.vacuum import DOMAIN as DOMAIN_VACUUM
from smarthub.components.weather import DOMAIN as DOMAIN_WEATHER
from smarthub.config import async_log_schema_error, config_without_domain
...
from smarthub.helpers.condition import async_validate_conditions_config
from smarthub.helpers.trigger import async_validate_trigger_config
from smarthub.helpers.typing import ConfigType
from smarthub.setup import async_notify_setup_error
...
async def async_validate_config(hass: SmartHub, config: ConfigType) -> ConfigType:
    """Validate config."""
        ...
        for old_key, new_key, transform in (
            ...
            if not legacy_warn_printed:
                ...
                logging.getLogger(__name__).warning(
                    ...
                    "https://www.smart-hub.io/integrations/template#configuration-for-trigger-based-template-sensors"
                )
