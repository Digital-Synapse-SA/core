...
from smarthub.const import EVENT_HOMEASSISTANT_STOP, UnitOfTemperature
...
async def async_setup_entry(hass: SmartHub, entry: FritzboxConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FritzboxConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, entry: FritzboxConfigEntry, device: DeviceEntry
) -> bool:
