...
class OverkizExecutor:
    ...
    async def async_execute_command(
        ...
        # Catch Overkiz exceptions to support `continue_on_error` functionality
            ...
            raise SmartHubError(exception) from exception
    ...
    async def async_cancel_command(
        ...
        # Retrieve executions initiated via SmartHub from Data Update Coordinator queue
        exec_id = next(
            (
                exec_id
        ...
        # Retrieve executions initiated outside SmartHub via API
