...
from smarthub.const import ATTR_TEMPERATURE, UnitOfTemperature
...
class AtlanticDomesticHotWaterProductionMBLComponent(OverkizEntity, WaterHeaterEntity):
    ...
    def current_operation(self) -> str:
        ...
        if (
            ...
            # https://developers.smart-hub.io/docs/core/entity/water-heater/#states
    ...
    async def async_turn_away_mode_on(self) -> None:
        ...
        but possible via smarthub dt_util to form both start and end dates dictionaries from scratch
