...
from smarthub.const import CONF_HOST, CONF_PASSWORD, CONF_PORT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: DuotecnoConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: DuotecnoConfigEntry) -> bool:
