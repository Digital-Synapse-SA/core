...
from smarthub.helpers.service_info.dhcp import DhcpServiceInfo as _DhcpServiceInfo
from smarthub.helpers.typing import ConfigType
from smarthub.loader import DHCPMatcher, async_get_dhcp
...
class WatcherBase:
    ...
    def __init__(self, hass: SmartHub, dhcp_data: DHCPData) -> None:
        """Initialize class."""
        super().__init__()
        self.hass = hass
