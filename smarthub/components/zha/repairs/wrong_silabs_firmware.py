...
from smarthub.components.smarthub_sky_connect import (
    hardware as skyconnect_hardware,
)
from smarthub.components.smarthub_yellow import (
...
def _detect_radio_hardware(hass: SmartHub, device: str) -> HardwareType:
...
async def warn_on_wrong_silabs_firmware(hass: SmartHub, device: str) -> bool:
