...
from smarthub.const import ATTR_MANUFACTURER, ATTR_MODEL, ATTR_NAME, EntityCategory
from smarthub.core import State, callback
from smarthub.helpers.device_registry import CONNECTION_ZIGBEE, DeviceInfo
...
class ZHAEntity(LogMixin, RestoreEntity, Entity):
    ...
    def restore_external_state_attributes(self, state: State) -> None:
        """Restore ephemeral external state from SmartHub back into ZHA."""
