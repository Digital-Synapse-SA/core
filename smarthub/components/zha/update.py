...
from smarthub.helpers.update_coordinator import (
    CoordinatorEntity,
...
ZHA_DOCS_NETWORK_RELIABILITY = "https://www.smart-hub.io/integrations/zha/#zigbee-interference-avoidance-and-network-rangecoverage-optimization"
...
class ZHAFirmwareUpdateCoordinator(DataUpdateCoordinator[None]):  # pylint: disable=hass-enforce-class-module
    ...
    def __init__(
        self, hass: SmartHub, controller_application: ControllerApplication
    ) -> None:
...
class ZHAFirmwareUpdateEntity(
    ...
    async def async_install(
        ...
        try:
            ...
            raise SmartHubError(exc) from exc
        finally:
