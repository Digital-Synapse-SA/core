...
class ZhaRadioManager:
    ...
    def from_config_entry(
        cls, hass: SmartHub, config_entry: config_entries.ConfigEntry
    ) -> Self:
...
class ZhaMultiPANMigrationHelper:
    ...
    radio used in the SmartHub SkyConnect USB stick and the SmartHub Yellow
    from Zigbee only firmware to firmware supporting both Zigbee and Thread.
    """

    def __init__(
        self, hass: SmartHub, config_entry: config_entries.ConfigEntry
    ) -> None:
