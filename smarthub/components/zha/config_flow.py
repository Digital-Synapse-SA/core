...
from smarthub.components import onboarding, usb
from smarthub.components.file_upload import process_uploaded_file
...
from smarthub.helpers.selector import FileSelector, FileSelectorConfig
...
REPAIR_MY_URL = "https://my.smart-hub.io/redirect/repairs/"
...
async def list_serial_ports(hass: SmartHub) -> list[ListPortInfo]:
...
class BaseZhaFlow(ConfigEntryBaseFlow):
    ...
    @property
    def hass(self) -> SmartHub:
        """Return hass."""
        return self._hass

    @hass.setter
    def hass(self, hass: SmartHub) -> None:
        """Set hass."""
        self._hass = hass
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                ...
                "docs_recommended_adapters_url": (
                    "https://www.smart-hub.io/integrations/zha/#recommended-zigbee-radio-adapters-and-modules"
                ),
            },
        )
