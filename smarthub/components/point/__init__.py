...
async def async_setup_entry(hass: SmartHub, entry: PointConfigEntry) -> bool:
...
async def async_setup_webhook(
    hass: SmartHub, entry: PointConfigEntry, session: PointSession
) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: PointConfigEntry) -> bool:
