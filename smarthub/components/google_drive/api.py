"""API for Google Drive bound to SmartHub OAuth."""
...
from smarthub.components.backup import AgentBackup, suggested_filename
...
class AsyncConfigEntryAuth(AbstractAuth):
    ...
    async def async_get_access_token(self) -> str:
        ...
        try:
            ...
            raise SmartHubError(ex) from ex
...
class DriveClient:
    ...
    async def async_create_ha_root_folder_if_not_exists(self) -> tuple[str, str]:
        """Create SmartHub folder if it doesn't exist."""
        fields = "id,name"
        query = " and ".join(
            [
