...
from smarthub.helpers.entityfilter import FILTER_SCHEMA, EntityFilter
from smarthub.helpers.event import async_call_later
from smarthub.helpers.json import ExtendedJSONEncoder
...
async def async_setup(hass: SmartHub, yaml_config: ConfigType) -> bool:
