...
from smarthub.const import CONF_TIMEOUT, Platform
...
async def async_setup_entry(hass: SmartHub, entry: SenseConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SenseConfigEntry) -> bool:
