...
from smarthub.helpers.service import verify_domain_control
...
async def async_setup_entry(hass: SmartHub, entry: GeniusHubConfigEntry) -> bool:
...
@callback
def setup_service_functions(hass: SmartHub, broker):
...
class GeniusBroker:
    ...
    def __init__(self, hass: SmartHub, client: GeniusHub, hub_uid: str) -> None:
