...
async def async_setup_entry(hass: SmartHub, entry: ConfigEntry) -> bool:
    ...
    if not hass.config.is_allowed_path(path):
        ...
        async_create_issue(
            ...
            learn_more_url="https://www.smart-hub.io/docs/configuration/basic/#allowlist_external_dirs",
        )
        return False
...
def create_event_handler(
    patterns: list[str], hass: SmartHub, entry_id: str
) -> EventHandler:
...
class EventHandler(PatternMatchingEventHandler):
    ...
    def __init__(self, patterns: list[str], hass: SmartHub, entry_id: str) -> None:
...
class Watcher:
    ...
    def __init__(
        self, path: str, patterns: list[str], hass: SmartHub, entry_id: str
    ) -> None:
