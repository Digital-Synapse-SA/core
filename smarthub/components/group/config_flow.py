...
from smarthub.const import CONF_ENTITIES, CONF_TYPE
from smarthub.core import SmartHub, callback
from smarthub.exceptions import SmartHubError
from smarthub.helpers import entity_registry as er, selector
...
CREATE_PREVIEW_ENTITY: dict[
    str,
    Callable[[SmartHub, str, dict[str, Any]], GroupEntity | MediaPlayerGroup],
] = {
...
def _async_hide_members(
    hass: SmartHub, members: list[str], hidden_by: er.RegistryEntryHider | None
) -> None:
