...
from smarthub.components.input_number import DOMAIN as INPUT_NUMBER_DOMAIN
...
from smarthub.helpers.entity import (
    get_capability,
    get_device_class,
...
from smarthub.helpers.typing import ConfigType, DiscoveryInfoType, StateType
...
def async_create_preview_sensor(
    hass: SmartHub, name: str, validated_config: dict[str, Any]
) -> SensorGroup:
...
def _has_numeric_state(hass: SmartHub, entity_id: str) -> bool:
            ...
            if (state := self.hass.states.get(entity_id)) is not None:
                ...
                try:
                    ...
                    if valid_units and uom not in valid_units:
                        raise SmartHubError("Not a valid unit")  # noqa: TRY301
