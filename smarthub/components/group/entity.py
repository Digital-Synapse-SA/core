...
from smarthub.const import ATTR_ASSUMED_STATE, ATTR_ENTITY_ID, STATE_OFF, STATE_ON
...
class GroupEntity(Entity):
    ...
    @callback
    def _update_at_start(self, _: SmartHub) -> None:
...
class Group(Entity):
    ...
    @callback
    def _async_start(self, _: SmartHub | None = None) -> None:
    ...
    def _async_stop(self) -> None:
        """Unregister the group from SmartHub.
...
def async_get_component(hass: SmartHub) -> EntityComponent[Group]:
