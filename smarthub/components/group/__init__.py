...
from smarthub.helpers.group import (
...
@bind_hass
def groups_with_entity(hass: SmartHub, entity_id: str) -> list[str]:
...
async def _async_process_config(hass: SmartHub, config: ConfigType) -> None:
