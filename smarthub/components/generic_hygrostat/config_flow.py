...
from smarthub.components import fan, switch
from smarthub.components.humidifier import HumidifierDeviceClass
from smarthub.components.sensor import DOMAIN as SENSOR_DOMAIN, SensorDeviceClass
from smarthub.const import CONF_NAME, PERCENTAGE
