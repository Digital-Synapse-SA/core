...
from smarthub.components.camera import Camera
from smarthub.const import CONF_FILE_PATH, CONF_NAME, EVENT_HOMEASSISTANT_STOP
...
class RaspberryCamera(Camera):
    ...
    def __init__(self, device_info: dict[str, Any]) -> None:
        ...
        # the background until killed when SmartHub is stopped.
