...
class ApplicationCredentialsProtocol(Protocol):
    ...
    async def async_get_auth_implementation(
        self, hass: SmartHub, auth_domain: str, credential: ClientCredential
...
async def _get_platform(
    hass: SmartHub, integration_domain: str
...
async def _async_integration_config(hass: SmartHub, domain: str) -> dict[str, Any]:
    platform = await _get_platform(hass, domain)
