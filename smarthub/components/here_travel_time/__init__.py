...
from smarthub.const import CONF_API_KEY, CONF_MODE, Platform
...
async def async_setup_entry(hass: SmartHub, config_entry: HereConfigEntry) -> bool:
    ...
    async def _async_update_at_start(_: SmartHub) -> None:
...
async def async_unload_entry(
    hass: SmartHub, config_entry: HereConfigEntry
) -> bool:
