...
def _storage_path_prefix(hass: SmartHub, entry_id: str) -> Path:
...
class RoborockMapStorage:
    ...
    def __init__(self, hass: SmartHub, entry_id: str, device_id_slug: str) -> None:
...
async def async_remove_map_storage(hass: SmartHub, entry_id: str) -> None:
