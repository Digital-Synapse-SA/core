...
from smarthub.const import ATTR_CONNECTIONS
    ...
    async def _verify_api(self) -> None:
        ...
        if isinstance(self.api, RoborockLocalClientV1):
            try:
                ...
                _LOGGER.warning(
                    "Using the cloud API for device %s. This is not recommended as it can lead to rate limiting. We recommend making your vacuum accessible by your SmartHub instance",
                    self.duid,
                )
