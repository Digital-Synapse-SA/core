...
from smarthub.components.network import async_get_ipv4_broadcast_addresses
...
async def async_setup_entry(hass: SmartHub, entry: GreeConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: GreeConfigEntry) -> bool:
