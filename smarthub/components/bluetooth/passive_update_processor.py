...
from smarthub.helpers.device_registry import CONNECTION_BLUETOOTH, DeviceInfo
from smarthub.helpers.entity import Entity, EntityDescription
from smarthub.helpers.entity_platform import async_get_current_platform
...
def async_register_coordinator_for_restore(
    hass: SmartHub, coordinator: PassiveBluetoothProcessorCoordinator[Any]
) -> CALLBACK_TYPE:
...
async def async_setup(hass: SmartHub) -> None:
