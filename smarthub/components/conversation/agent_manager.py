...
from smarthub.core import Context, SmartHub, async_get_hass, callback
from smarthub.exceptions import SmartHubError
from smarthub.helpers import config_validation as cv, intent, singleton
...
@callback
def get_agent_manager(hass: SmartHub) -> AgentManager:
