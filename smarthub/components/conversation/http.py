...
from smarthub.helpers import config_validation as cv, intent
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "conversation/agent/smarthub/debug",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "conversation/agent/smarthub/language_scores",
        vol.Optional("language"): str,
        vol.Optional("country"): str,
    }
)
...
class ConversationProcessView(http.SmartHubView):
