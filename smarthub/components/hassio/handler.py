...
from smarthub.const import SERVER_PORT
...
@bind_hass
async def async_update_diagnostics(hass: SmartHub, diagnostics: bool) -> bool:
...
async def async_create_backup(
    hass: SmartHub, payload: dict, partial: bool = False
) -> dict:
...
@api_data
async def async_get_green_settings(hass: SmartHub) -> dict[str, bool]:
    """Return settings specific to SmartHub Green."""
    hassio = hass.data[DATA_COMPONENT]
...
async def async_set_green_settings(
    hass: SmartHub, settings: dict[str, bool]
) -> dict:
    """Set settings specific to SmartHub Green.
...
@api_data
async def async_get_yellow_settings(hass: SmartHub) -> dict[str, bool]:
    """Return settings specific to SmartHub Yellow."""
    hassio = hass.data[DATA_COMPONENT]
...
async def async_set_yellow_settings(
    ...
    """Set settings specific to SmartHub Yellow.
...
class HassIO:
    ...
    async def update_hass_api(
        ...
        """Update SmartHub API data on Hass.io."""
        ...
        return await self.send_command("/smarthub/options", payload=options)
...
def get_supervisor_client(hass: SmartHub) -> SupervisorClient:
