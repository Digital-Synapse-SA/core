...
from smarthub.const import ATTR_ICON, ATTR_NAME
...
class SupervisorOSUpdateEntity(HassioOSEntity, UpdateEntity):
    """Update entity to handle updates for the SmartHub Operating System."""
    ...
    _attr_title = "SmartHub Operating System"
    ...
    def entity_picture(self) -> str | None:
        ...
        return "https://brands.smart-hub.io/smarthub/icon.png"
    ...
    def release_url(self) -> str | None:
        ...
        if version.dev or version.strategy == AwesomeVersionStrategy.UNKNOWN:
            return "https://github.com/smart-hub/operating-system/commits/dev"
        return (
            f"https://github.com/smart-hub/operating-system/releases/tag/{version}"
        )
...
class SupervisorSupervisorUpdateEntity(HassioSupervisorEntity, UpdateEntity):
    """Update entity to handle updates for the SmartHub Supervisor."""

    _attr_supported_features = UpdateEntityFeature.INSTALL
    _attr_title = "SmartHub Supervisor"
    ...
    def release_url(self) -> str | None:
        ...
        version = AwesomeVersion(self.latest_version)
        if version.dev or version.strategy == AwesomeVersionStrategy.UNKNOWN:
            return "https://github.com/smart-hub/supervisor/commits/main"
        return f"https://github.com/smart-hub/supervisor/releases/tag/{version}"

    @property
    def entity_picture(self) -> str | None:
        """Return the icon of the entity."""
        return "https://brands.smart-hub.io/hassio/icon.png"
    ...
    async def async_install(
        ...
        try:
            ...
            raise SmartHubError(
                f"Error updating SmartHub Supervisor: {err}"
            ) from err


class SupervisorCoreUpdateEntity(HassioCoreEntity, UpdateEntity):
    """Update entity to handle updates for SmartHub Core."""
    ...
    def release_url(self) -> str | None:
        ...
        version = AwesomeVersion(self.latest_version)
        if version.dev:
            return "https://github.com/smart-hub/core/commits/dev"
        return f"https://{'rc' if version.beta else 'www'}.smart-hub.io/latest-release-notes/"
