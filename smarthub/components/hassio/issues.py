...
from smarthub.core import HassJob, SmartHub, callback
...
INFO_URL_UNHEALTHY = "https://www.smart-hub.io/more-info/unhealthy"
INFO_URL_UNSUPPORTED = "https://www.smart-hub.io/more-info/unsupported"
...
class SupervisorIssues:
    ...
    def __init__(self, hass: SmartHub, client: HassIO) -> None:
