...
from smarthub.const import ATTR_MANUFACTURER, ATTR_NAME
from smarthub.core import CALLBACK_TYPE, SmartHub, callback
...
@callback
@bind_hass
def get_info(hass: SmartHub) -> dict[str, Any] | None:
...
@callback
@bind_hass
def get_host_info(hass: SmartHub) -> dict[str, Any] | None:
...
@callback
@bind_hass
def get_store(hass: SmartHub) -> dict[str, Any] | None:
...
@callback
@bind_hass
def get_supervisor_info(hass: SmartHub) -> dict[str, Any] | None:
...
@callback
@bind_hass
def get_network_info(hass: SmartHub) -> dict[str, Any] | None:
...
@callback
@bind_hass
def get_addons_info(hass: SmartHub) -> dict[str, dict[str, Any]] | None:
    """Return Addons info.
...
@callback
@bind_hass
def get_addons_stats(hass: SmartHub) -> dict[str, Any]:
    """Return Addons stats.
...
@callback
@bind_hass
def get_core_stats(hass: SmartHub) -> dict[str, Any]:
    """Return core stats.
...
@callback
@bind_hass
def get_supervisor_stats(hass: SmartHub) -> dict[str, Any]:
...
@callback
@bind_hass
def get_os_info(hass: SmartHub) -> dict[str, Any] | None:
...
@callback
@bind_hass
def get_core_info(hass: SmartHub) -> dict[str, Any] | None:
    """Return SmartHub Core information from Supervisor.
...
@callback
@bind_hass
def get_issues_info(hass: SmartHub) -> SupervisorIssues | None:
...
def async_register_addons_in_dev_reg(
    ...
    for addon in addons:
        params = DeviceInfo(
            ...
            configuration_url=f"smarthub://hassio/addon/{addon[ATTR_SLUG]}",
        )
...
def async_register_os_in_dev_reg(
    ...
    params = DeviceInfo(
        ...
        name="SmartHub Operating System",
        entry_type=dr.DeviceEntryType.SERVICE,
    )
    dev_reg.async_get_or_create(config_entry_id=entry_id, **params)
...
class HassioDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    def __init__(
        self, hass: SmartHub, config_entry: ConfigEntry, dev_reg: dr.DeviceRegistry
    ) -> None:
