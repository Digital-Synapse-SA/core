...
from smarthub.const import ATTR_SERVICE, EVENT_HOMEASSISTANT_START
...
@callback
def async_setup_discovery_view(hass: SmartHub, hassio: HassIO) -> None:
    """Discovery setup."""
...
class HassIODiscovery(SmartHubView):
    """Hass.io view to handle base part."""

    name = "api:hassio_push:discovery"
    url = "/api/hassio_push/discovery/{uuid}"

    def __init__(self, hass: SmartHub, hassio: HassIO) -> None:
        """Initialize WebView."""
        self.hass = hass
        self.hassio = hassio
