...
ATTR_HOMEASSISTANT = "smarthub"
ATTR_HOMEASSISTANT_EXCLUDE_DATABASE = "smarthub_exclude_database"
ATTR_INPUT = "input"
ATTR_ISSUES = "issues"
...
class SupervisorEntityModel(StrEnum):
    ...
    ADDON = "SmartHub Add-on"
    OS = "SmartHub Operating System"
    CORE = "SmartHub Core"
    SUPERVISOR = "SmartHub Supervisor"
    HOST = "SmartHub Host"
