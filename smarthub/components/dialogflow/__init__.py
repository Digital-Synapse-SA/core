...
from smarthub.helpers import config_entry_flow, intent, template

from .const import DOMAIN

_LOGGER = logging.getLogger(__name__)

SOURCE = "SmartHub Dialogflow"
...
class DialogFlowError(SmartHubError):
    ...
    try:
        ...
        return web.json_response(
            dialogflow_error_response(
                message, "This intent is not yet configured within SmartHub."
            )
        )
