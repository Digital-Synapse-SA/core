...
from python_smarthub_analytics.models import Environment, IntegrationType
...
class HomeassistantAnalyticsConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            if all(
                ...
                return self.async_create_entry(
                    title="SmartHub Analytics Insights",
                    data={},
                    options={
        ...
        try:
            ...
            LOGGER.exception("Error connecting to SmartHub analytics")
