...
from smarthub.components.device_tracker import ATTR_BATTERY
from smarthub.config_entries import ConfigEntry
from smarthub.const import ATTR_LATITUDE, ATTR_LONGITUDE, CONF_WEBHOOK_ID, Platform
...
async def async_setup_entry(hass: SmartHub, entry: GPSLoggerConfigEntry) -> bool:
