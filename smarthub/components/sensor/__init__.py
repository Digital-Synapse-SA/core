...
from smarthub.helpers.typing import UNDEFINED, ConfigType, StateType, UndefinedType
...
class SensorEntity(Entity, cached_properties=CACHED_PROPERTIES_WITH_ATTR_):
    ...
    def state(self) -> Any:
        ...
        if (
            ...
            # This should raise in SmartHub Core 2023.6
            _LOGGER.warning(
...
@callback
def async_update_suggested_units(hass: SmartHub) -> None:
...
def _display_precision(hass: SmartHub, entity_id: str) -> int | None:
...
@callback
def async_rounded_state(hass: SmartHub, entity_id: str, state: State) -> str:
