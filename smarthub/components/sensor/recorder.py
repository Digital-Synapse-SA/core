...
from smarthub.core import SmartHub, State, callback, split_entity_id
from smarthub.exceptions import SmartHubError
from smarthub.helpers import issue_registry as ir
from smarthub.helpers.entity import entity_sources
...
def _suggest_report_issue(hass: SmartHub, entity_id: str) -> str:
...
def warn_dip(
    hass: SmartHub, entity_id: str, state: State, previous_fstate: float
) -> None:
...
def warn_negative(hass: SmartHub, entity_id: str, state: State) -> None:
...
def update_statistics_issues(
    ...
    @callback
    def get_sensor_statistics_issues(hass: SmartHub) -> set[str]:
