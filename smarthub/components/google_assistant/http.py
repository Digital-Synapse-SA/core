...
from smarthub.helpers.storage import STORAGE_DIR, Store
...
class GoogleConfig(AbstractConfig):
    ...
    def get_local_user_id(self, webhook_id):
        ...
        # user ID instead of a valid SmartHub user ID
...
class GoogleAssistantView(SmartHubView):
...
async def async_get_users(hass: SmartHub) -> list[str]:
    """Return stored users.
