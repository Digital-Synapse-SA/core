...
from smarthub.components.media_player import MediaPlayerEntityFeature, MediaType
...
from smarthub.util import color as color_util, dt as dt_util
...
class _Trait(ABC):
    ...
    def __init__(self, hass: SmartHub, state, config) -> None:
