...
from smarthub.helpers.typing import DiscoveryInfoType, VolDictType
from smarthub.util import slugify
from smarthub.util.network import is_ip_address as is_ip
...
class InvalidData(SmartHubError):
