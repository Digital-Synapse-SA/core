...
from smarthub.const import CONF_MAC, CONF_SCAN_INTERVAL, CONF_VERIFY_SSL
...
async def async_setup_entry(hass: SmartHub, entry: SynologyDSMConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: SynologyDSMConfigEntry
) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, entry: SynologyDSMConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
