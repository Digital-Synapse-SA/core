...
from smarthub.config import config_per_platform
from smarthub.const import CONF_DESCRIPTION, CONF_NAME
from smarthub.core import CALLBACK_TYPE, SmartHub, ServiceCall, callback
        ...
        with async_start_setup(
            ...
            try:
                if hasattr(platform, "async_get_service"):
                    ...
                    raise SmartHubError("Invalid notify platform.")  # noqa: TRY301
...
@bind_hass
async def async_reload(hass: SmartHub, integration_name: str) -> None:
...
@bind_hass
async def async_reset_platform(hass: SmartHub, integration_name: str) -> None:
...
def _async_integration_has_notify_services(
    hass: SmartHub, integration_name: str
) -> bool:
