...
from smarthub.core import DOMAIN as HOMEASSISTANT_DOMAIN, SmartHub, callback
...
class Blueprint:
    ...
    def validate(self) -> list[str] | None:
        """Test if the SmartHub installation supports this blueprint.
        ...
        if min_version is not None and AwesomeVersion(__version__) < AwesomeVersion(
            ...
            errors.append(f"Requires at least SmartHub {min_version}")
...
class DomainBlueprints:
    ...
    def __init__(
        ...
        blueprint_in_use: Callable[[SmartHub, str], bool],
        reload_blueprint_consumers: Callable[[SmartHub, str], Awaitable[None]],
