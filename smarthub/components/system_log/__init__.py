...
def _figure_out_source(
    ...
    if record.exc_info:
        ...
        # a file in SmartHub. Try to figure out where error happened.
        for path, line_number in reversed(stack):
            # Try to match with a file within SmartHub
        ...
        # and find the first one that is from a file within SmartHub.
        #
