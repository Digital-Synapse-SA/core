"""Config flow for the SmartHub SkyConnect integration."""
...
from smarthub.components.smarthub_hardware import (
...
from smarthub.core import callback
...
class SkyConnectTranslationMixin(ConfigEntryBaseFlow, TranslationPlaceholderProtocol):
    """Translation placeholder mixin for SmartHub SkyConnect."""
...
class SmartHubSkyConnectConfigFlow(
    SkyConnectTranslationMixin,
    firmware_config_flow.BaseFirmwareConfigFlow,
    domain=DOMAIN,
):
    """Handle a config flow for SmartHub SkyConnect."""
    ...
    def async_get_options_flow(
        ...
        if firmware_type is ApplicationType.CPC:
            return SmartHubSkyConnectMultiPanOptionsFlowHandler(config_entry)

        return SmartHubSkyConnectOptionsFlowHandler(config_entry)
...
class SmartHubSkyConnectMultiPanOptionsFlowHandler(
    silabs_multiprotocol_addon.OptionsFlowHandler
):
    """Multi-PAN options flow for SmartHub SkyConnect."""
...
class SmartHubSkyConnectOptionsFlowHandler(
