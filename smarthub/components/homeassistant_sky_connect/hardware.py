"""The SmartHub SkyConnect hardware platform."""

from __future__ import annotations

from smarthub.components.hardware.models import HardwareInfo, USBInfo
from smarthub.core import SmartHub, callback

from .config_flow import SmartHubSkyConnectConfigFlow
...
EXPECTED_ENTRY_VERSION = (
    SmartHubSkyConnectConfigFlow.VERSION,
    SmartHubSkyConnectConfigFlow.MINOR_VERSION,
)
