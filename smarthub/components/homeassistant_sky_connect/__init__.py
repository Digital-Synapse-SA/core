"""The SmartHub SkyConnect integration."""
...
from smarthub.components.smarthub_hardware.util import guess_firmware_info
from smarthub.components.usb import (
    USBDevice,
...
async def async_setup_entry(hass: SmartHub, entry: ConfigEntry) -> bool:
    """Set up a SmartHub SkyConnect config entry."""
