...
from smarthub.components.snmp import async_get_snmp_engine
from smarthub.const import CONF_HOST, CONF_TYPE, Platform
...
async def async_setup_entry(hass: SmartHub, entry: BrotherConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BrotherConfigEntry) -> bool:
