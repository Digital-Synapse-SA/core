...
async def async_setup_entry(hass: SmartHub, entry: FeedReaderConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FeedReaderConfigEntry) -> bool:
...
async def _async_update_listener(
    hass: SmartHub, entry: FeedReaderConfigEntry
) -> None:
