...
from smarthub.components.climate import FAN_OFF, HVACMode
from smarthub.components.cover import (
    DEVICE_CLASSES_SCHEMA as COVER_DEVICE_CLASSES_SCHEMA,
)
from smarthub.components.number import NumberMode
...
from smarthub.components.text import TextMode
...
from smarthub.helpers.entity import ENTITY_CATEGORIES_SCHEMA
...
def number_limit_sub_validator(entity_config: OrderedDict) -> OrderedDict:
    ...
    # Infinity is not supported by SmartHub frontend so user defined
