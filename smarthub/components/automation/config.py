...
from smarthub.components.trace import TRACE_CONFIG_SCHEMA
from smarthub.config import config_per_platform, config_without_domain
...
from smarthub.helpers import config_validation as cv, script
...
from smarthub.util.yaml.input import UndefinedSubstitution
...
async def _try_async_validate_config_item(
    ...
    except (vol.Invalid, SmartHubError):
        return None
