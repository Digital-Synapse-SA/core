...
from smarthub.const import CONF_IP_ADDRESS, CONF_WEBHOOK_ID, Platform
...
async def async_setup_entry(hass: SmartHub, entry: WatergateConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: WatergateConfigEntry) -> bool:
