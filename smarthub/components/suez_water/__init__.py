...
async def async_setup_entry(hass: SmartHub, entry: SuezWaterConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SuezWaterConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(
    hass: SmartHub, config_entry: SuezWaterConfigEntry
) -> bool:
