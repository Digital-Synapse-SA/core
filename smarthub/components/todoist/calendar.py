...
from smarthub.const import CONF_ID, CONF_NAME, CONF_TOKEN, EVENT_HOMEASSISTANT_STOP
...
def async_register_services(  # noqa: C901
    hass: SmartHub, coordinator: TodoistCoordinator
) -> None:
    """Register services."""
    ...
    async def handle_new_task(call: ServiceCall) -> None:  # noqa: C901
        """Call when a user creates a new Todoist Task from SmartHub."""
