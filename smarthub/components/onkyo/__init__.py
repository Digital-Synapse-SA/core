...
async def async_setup(hass: SmartHub, _: ConfigType) -> bool:
    """Set up Onkyo component."""
    async_setup_services(hass)
    return True


async def async_setup_entry(hass: SmartHub, entry: OnkyoConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: OnkyoConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: OnkyoConfigEntry) -> None:
