...
from smarthub.helpers.service_info.usb import UsbServiceInfo as _UsbServiceInfo
from smarthub.helpers.typing import ConfigType
from smarthub.loader import USBMatcher, async_get_usb
...
def async_register_scan_request_callback(
    hass: SmartHub, callback: CALLBACK_TYPE
) -> CALLBACK_TYPE:
...
def async_register_port_event_callback(
    hass: SmartHub, callback: PORT_EVENT_CALLBACK_TYPE
) -> CALLBACK_TYPE:
...
@hass_callback
def async_is_plugged_in(hass: SmartHub, matcher: USBCallbackMatcher) -> bool:
