...
from smarthub.const import CONF_HOST, CONF_NAME, CONF_PASSWORD, Platform
...
async def async_setup_entry(hass: SmartHub, entry: NetgearLTEConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: NetgearLTEConfigEntry) -> bool:
