...
class PhilipsTVMediaPlayer(PhilipsJsEntity, MediaPlayerEntity):
    ...
    async def async_play_media_channel(self, media_id: str):
        ...
        raise SmartHubError(f"Unable to find channel {media_id}")
    ...
    async def async_play_media(
        ...
        if media_type == MediaType.CHANNEL:
            ...
            if app := self._tv.applications.get(media_id):
                ...
                raise SmartHubError(f"Unable to find application {media_id}")
        else:
            raise SmartHubError(f"Unsupported media type {media_type}")
