...
async def async_setup_entry(hass: SmartHub, entry: PhilipsTVConfigEntry) -> bool:
...
async def async_update_entry(hass: SmartHub, entry: PhilipsTVConfigEntry) -> None:
    """Update options."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: PhilipsTVConfigEntry) -> bool:
