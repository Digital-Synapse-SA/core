...
from smarthub.components import frontend, http, websocket_api
...
from smarthub.helpers.event import async_track_point_in_time
...
# Ensure events created in SmartHub have a positive duration
...
class CalendarEventView(http.SmartHubView):
...
class CalendarListView(http.SmartHubView):
