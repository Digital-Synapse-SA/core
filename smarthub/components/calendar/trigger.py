...
from smarthub.const import CONF_ENTITY_ID, CONF_EVENT, CONF_OFFSET, CONF_PLATFORM
...
def get_entity(hass: SmartHub, entity_id: str) -> CalendarEntity:
...
def event_fetcher(hass: SmartHub, entity_id: str) -> EventFetcher:
