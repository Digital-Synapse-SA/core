...
async def async_setup_entry(hass: SmartHub, entry: KMTronicConfigEntry) -> bool:
...
async def async_update_options(
    hass: SmartHub, config_entry: KMTronicConfigEntry
) -> None:
    """Update options."""
    await hass.config_entries.async_reload(config_entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: KMTronicConfigEntry) -> bool:
