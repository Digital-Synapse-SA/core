...
from smarthub.config_entries import SOURCE_INTEGRATION_DISCOVERY, ConfigEntryState
from smarthub.const import CONF_HOST, CONF_MODEL, CONF_NAME
from smarthub.core import SmartHub, callback
from smarthub.helpers import device_registry as dr, discovery_flow
from smarthub.util.async_ import create_eager_task
from smarthub.util.network import is_ip_address
...
@callback
def async_get_discovery(hass: SmartHub, host: str) -> FluxLEDDiscovery | None:
...
@callback
def async_clear_discovery_cache(hass: SmartHub, host: str) -> None:
...
async def async_discover_devices(
    hass: SmartHub, timeout: int, address: str | None = None
