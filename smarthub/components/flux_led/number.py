...
from smarthub.components.light import EFFECT_RANDOM
from smarthub.components.number import NumberEntity, NumberMode
...
class FluxSpeedNumber(
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        if not self._device.speed_adjust_off and not self._device.is_on:
            raise SmartHubError("Speed can only be adjusted when the light is on")
