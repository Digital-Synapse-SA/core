...
async def _async_migrate_unique_ids(
    hass: SmartHub, entry: FluxLedConfigEntry
) -> None:
...
async def async_setup_entry(hass: SmartHub, entry: FluxLedConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FluxLedConfigEntry) -> bool:
