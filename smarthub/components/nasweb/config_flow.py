...
NASWEB_SCHEMA_IMG_URL = (
    "https://smart-hub.io/images/integrations/nasweb/nasweb_scheme.png"
)
...
async def validate_input(hass: SmartHub, data: dict[str, Any]) -> dict[str, Any]:
...
class MissingNASwebData(SmartHubError):
    """Error to indicate missing information from NASweb."""


class MissingNASwebStatus(SmartHubError):
