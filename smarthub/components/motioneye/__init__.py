...
from smarthub.components.media_source import URI_SCHEME
...
from smarthub.const import ATTR_DEVICE_ID, ATTR_NAME, CONF_URL, CONF_WEBHOOK_ID
...
def async_generate_motioneye_webhook(
    ...
    try:
        ...
        _LOGGER.warning(
            "Unable to get SmartHub URL. Have you set the internal and/or "
...
async def _async_entry_updated(hass: SmartHub, config_entry: ConfigEntry) -> None:
