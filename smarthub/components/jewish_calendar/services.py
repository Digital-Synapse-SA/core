...
from smarthub.const import CONF_LANGUAGE, SUN_EVENT_SUNSET
...
from smarthub.helpers.selector import LanguageSelector, LanguageSelectorConfig
...
def async_setup_services(hass: SmartHub) -> None:
    ...
    def is_after_sunset(hass: SmartHub) -> bool:
