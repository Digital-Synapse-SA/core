...
from smarthub.const import CONF_API_KEY, CONF_PASSWORD, CONF_USERNAME, Platform
...
async def async_setup_entry(
    hass: SmartHub, config_entry: HydrawiseConfigEntry
) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: HydrawiseConfigEntry) -> bool:
