...
async def async_setup_entry(hass: SmartHub, entry: AsusWrtConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: AsusWrtConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: AsusWrtConfigEntry) -> None:
