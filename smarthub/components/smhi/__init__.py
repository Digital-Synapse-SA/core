...
async def async_setup_entry(hass: SmartHub, entry: SMHIConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SMHIConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: SMHIConfigEntry) -> bool:
    """Migrate old entry."""
