...
from smarthub.const import CONF_HOST, CONF_NAME, EVENT_HOMEASSISTANT_STOP, Platform
...
async def async_setup_entry(
    ...
    try:
        ...
        # The Android TV is network unreachable. Raise exception and let SmartHub retry
