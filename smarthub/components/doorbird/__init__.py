...
async def async_setup_entry(hass: SmartHub, entry: DoorBirdConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: DoorBirdConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def _async_register_events(
    hass: SmartHub, door_station: ConfiguredDoorBird, entry: DoorBirdConfigEntry
) -> bool:
...
async def _update_listener(hass: SmartHub, entry: DoorBirdConfigEntry) -> None:
