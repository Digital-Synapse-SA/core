...
from smarthub.const import ATTR_DEVICE_ID, CONTENT_TYPE_JSON
...
from smarthub.util.json import JsonValueType, json_loads
...
def savable_state(hass: SmartHub) -> dict:
