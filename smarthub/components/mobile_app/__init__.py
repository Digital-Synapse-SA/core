"""Integrates Native Apps to SmartHub."""
...
from smarthub.components import cloud, intent, notify as hass_notify
from smarthub.components.webhook import (
    async_register as webhook_register,
    async_unregister as webhook_unregister,
)
from smarthub.config_entries import ConfigEntry
from smarthub.const import ATTR_DEVICE_ID, CONF_WEBHOOK_ID, Platform
