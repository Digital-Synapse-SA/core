...
@callback
def async_get_api(hass: SmartHub, api_key: str) -> API:
...
@callback
def async_get_coordinates_schema(hass: SmartHub) -> vol.Schema:
...
async def async_validate_api_key(hass: SmartHub, api_key: str) -> ValidationResult:
    """Validate an API key.
