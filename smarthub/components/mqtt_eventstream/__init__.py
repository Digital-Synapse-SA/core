"""Connect two SmartHub instances via MQTT."""
...
from smarthub.components.mqtt import valid_publish_topic, valid_subscribe_topic
...
from smarthub.core import EventOrigin, SmartHub, State, callback
