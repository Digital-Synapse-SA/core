...
class DebouncedEntryReloader:
    ...
    def __init__(self, hass: SmartHub, entry: SamsungTVConfigEntry) -> None:
    ...
    async def async_call(
        self, hass: SmartHub, entry: SamsungTVConfigEntry
    ) -> None:
...
async def _async_update_ssdp_locations(
    hass: SmartHub, entry: SamsungTVConfigEntry
) -> None:
...
async def async_setup_entry(hass: SmartHub, entry: SamsungTVConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: SamsungTVConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(
    hass: SmartHub, config_entry: SamsungTVConfigEntry
) -> bool:
    """Migrate old entry."""
