...
from smarthub.helpers import entity_component
...
class SamsungTVBridge(ABC):
    ...
    def __init__(
        self, hass: SmartHub, method: str, host: str, port: int | None = None
    ) -> None:
        """Initialize Bridge."""
        self.hass = hass
        self.port = port
...
class SamsungTVLegacyBridge(SamsungTVBridge):
    ...
    def __init__(
        self, hass: SmartHub, method: str, host: str, port: int | None
    ) -> None:
        """Initialize Bridge."""
