...
from smarthub.const import CONF_REGION, Platform, UnitOfLength
...
from smarthub.util.unit_conversion import DistanceConverter
...
async def async_migrate_entry(hass: SmartHub, config_entry: ConfigEntry) -> bool:
