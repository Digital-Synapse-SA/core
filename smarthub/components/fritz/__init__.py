...
async def async_setup_entry(hass: SmartHub, entry: FritzConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FritzConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: FritzConfigEntry) -> None:
