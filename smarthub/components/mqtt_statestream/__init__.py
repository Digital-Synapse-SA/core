...
from smarthub.components.mqtt import valid_publish_topic
from smarthub.const import EVENT_HOMEASSISTANT_STOP, EVENT_STATE_CHANGED
...
async def async_setup(hass: SmartHub, config: ConfigType) -> bool:
    ...
    @callback
    def _ha_started(hass: SmartHub) -> None:
        @callback
