...
from smarthub.components.lock import CONF_DEFAULT_CODE, DOMAIN as LOCK_DOMAIN
from smarthub.config_entries import ConfigEntry
from smarthub.const import CONF_CODE, CONF_NAME
...
async def async_setup_entry(hass: SmartHub, entry: YaleConfigEntry) -> bool:
...
async def update_listener(hass: SmartHub, entry: YaleConfigEntry) -> None:
    """Handle options update."""
    await hass.config_entries.async_reload(entry.entry_id)


async def async_unload_entry(hass: SmartHub, entry: YaleConfigEntry) -> bool:
    """Unload a config entry."""
    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: YaleConfigEntry) -> bool:
    """Migrate old entry."""
