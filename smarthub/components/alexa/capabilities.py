...
class AlexaCapability:
    ...
    roughly analogous to domains in SmartHub. The supported interfaces
...
class Alexa(AlexaCapability):
    ...
    To compare current supported locales in SmartHub
...
class AlexaEndpointHealth(AlexaCapability):
    ...
    def __init__(self, hass: SmartHub, entity: State) -> None:
