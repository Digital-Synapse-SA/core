...
from smarthub.helpers import network
...
class AlexaEntity:
    ...
    def __init__(
        self, hass: SmartHub, config: AbstractConfig, entity: State
    ) -> None:
    ...
    def description(self) -> str:
        ...
        return f"{description} via SmartHub".translate(TRANSLATION_TABLE)
    ...
    def default_display_categories(self) -> list[str] | None:
        ...
        This can be overridden by the user in the SmartHub configuration.
