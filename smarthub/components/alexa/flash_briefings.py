...
@callback
def async_setup(hass: SmartHub, flash_briefing_config: ConfigType) -> None:
    """Activate Alexa component."""
    hass.http.register_view(AlexaFlashBriefingView(hass, flash_briefing_config))


class AlexaFlashBriefingView(http.SmartHubView):
    ...
    def __init__(self, hass: SmartHub, flash_briefings: ConfigType) -> None:
    ...
    @callback
    def get(
        self, request: http.SmartHubRequest, briefing_id: str
