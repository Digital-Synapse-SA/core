...
HANDLERS: Registry[
    str, Callable[[SmartHub, dict[str, Any]], Coroutine[Any, Any, dict[str, Any]]]
] = Registry()
...
class UnknownRequest(SmartHubError):
    """When an unknown Alexa request is passed in."""


class AlexaIntentsView(http.SmartHubView):
    """Handle Alexa requests."""

    url = INTENTS_API_ENDPOINT
    name = "api:alexa"

    async def post(self, request: http.SmartHubRequest) -> Response | bytes:
        """Handle Alexa."""
...
def intent_error_response(
    hass: SmartHub, message: dict[str, Any], error: str
) -> dict[str, Any]:
...
async def async_handle_message(
    hass: SmartHub, message: dict[str, Any]
) -> dict[str, Any]:
...
class AlexaIntentResponse:
    ...
    def __init__(self, hass: SmartHub, intent_info: dict[str, Any] | None) -> None:
