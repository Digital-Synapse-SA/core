...
async def async_discovery(hass: SmartHub) -> list[dict[str, Any]]:
...
class OnvifFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_configure(
        ...
        # See https://github.com/smart-hub/core/issues/39182
        # and https://github.com/smart-hub/core/issues/35904
        return self.async_show_form(
            step_id="configure",
            data_schema=vol.Schema(
                {
