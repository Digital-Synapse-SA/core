...
from smarthub.util.file import write_utf8_file_atomic
from smarthub.util.yaml import dump, load_yaml
...
class BaseEditConfigView[_DataT: (dict[str, dict[str, Any]], list[dict[str, Any]])](
    ...
    def _get_value(
        self, hass: SmartHub, data: _DataT, config_key: str
    ) -> dict[str, Any] | None:
        """Get value."""
        raise NotImplementedError
    ...
    async def read_config(self, hass: SmartHub) -> _DataT:
        """Read the config."""
...
class EditKeyBasedConfigView(BaseEditConfigView[dict[str, dict[str, Any]]]):
    ...
    def _get_value(
        self, hass: SmartHub, data: dict[str, dict[str, Any]], config_key: str
    ) -> dict[str, Any] | None:
        """Get value."""
...
class EditIdBasedConfigView(BaseEditConfigView[list[dict[str, Any]]]):
    ...
    def _get_value(
        self, hass: SmartHub, data: list[dict[str, Any]], config_key: str
    ) -> dict[str, Any] | None:
        """Get value."""
