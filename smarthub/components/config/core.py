...
from smarthub.components.sensor import async_update_suggested_units
...
from smarthub.util import location as location_util, unit_system
...
class CheckConfigView(SmartHubView):
