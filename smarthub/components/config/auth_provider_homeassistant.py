"""Offer API to configure the SmartHub auth provider."""
...
from smarthub.auth.providers import smarthub as auth_ha
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "config/auth_provider/smarthub/create",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "config/auth_provider/smarthub/delete",
        vol.Required("username"): str,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "config/auth_provider/smarthub/change_password",
...
@websocket_api.websocket_command(
    {
        vol.Required(
            "type"
        ): "config/auth_provider/smarthub/admin_change_password",
        vol.Required("user_id"): str,
        vol.Required("password"): str,
    }
)
...
@websocket_api.websocket_command(
    {
        vol.Required(
            "type"
        ): "config/auth_provider/smarthub/admin_change_username",
        vol.Required("user_id"): str,
        vol.Required("username"): str,
    }
)
