...
async def async_get_config_entry_diagnostics(
    hass: SmartHub, entry: TuyaConfigEntry
) -> dict[str, Any]:
...
async def async_get_device_diagnostics(
    hass: SmartHub, entry: TuyaConfigEntry, device: DeviceEntry
) -> dict[str, Any]:
...
def _async_device_as_dict(
    hass: SmartHub, device: CustomerDevice
) -> dict[str, Any]:
    ...
    # Gather information how this Tuya device is represented in SmartHub
