...
from smarthub.const import CONF_API_KEY, CONF_API_VERSION, CONF_HOST, CONF_USERNAME
...
async def check_migration(hass: core.SmartHub, entry: HueConfigEntry) -> None:
...
async def handle_v2_migration(hass: core.SmartHub, entry: HueConfigEntry) -> None:
