...
async def async_setup_entry(hass: SmartHub, entry: HueConfigEntry) -> bool:
    ...
    # Remove this logic after SmartHub 2022.4
...
async def async_unload_entry(hass: SmartHub, entry: HueConfigEntry) -> bool:
