...
from smarthub.helpers.event import async_call_later, async_track_point_in_time
...
class BackupConfig:
    ...
    def __init__(self, hass: SmartHub, manager: BackupManager) -> None:
...
@callback
def check_unavailable_agents(hass: SmartHub, manager: BackupManager) -> None:
