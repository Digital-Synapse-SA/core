...
from smarthub.config_entries import SOURCE_SYSTEM
...
async def async_setup(hass: SmartHub, config: ConfigType) -> bool:
    ...
    if not with_hassio:
        ...
        from smarthub.components.hassio.backup import (  # noqa: PLC0415
...
async def async_setup_entry(hass: SmartHub, entry: BackupConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BackupConfigEntry) -> bool:
