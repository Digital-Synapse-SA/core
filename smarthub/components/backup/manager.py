...
from smarthub.backup_restore import (
    RESTORE_BACKUP_FILE,
...
from smarthub.helpers.backup import DATA_BACKUP
from smarthub.helpers.json import json_bytes
from smarthub.util import dt as dt_util, json as json_util
...
class BlockedEvent(ManagerStateEvent):
    """Backup manager blocked, SmartHub is starting."""
...
class BackupPlatformProtocol(Protocol):
    ...
    async def async_pre_backup(self, hass: SmartHub) -> None:
        """Perform operations before a backup starts."""

    async def async_post_backup(self, hass: SmartHub) -> None:
...
class BackupManager:
    ...
    def __init__(self, hass: SmartHub, reader_writer: BackupReaderWriter) -> None:
    ...
    async def async_setup(self) -> None:
        ...
        async def set_manager_idle_after_start(hass: SmartHub) -> None:
    ...
    async def _async_reload_backup_agents(self, domain: str) -> None:
        ...
        @callback
        def check_unavailable_agents_after_start(hass: SmartHub) -> None:
            ...
            for agent_backup in result:
                if (backup_id := agent_backup.backup_id) not in backups:
                    ...
                    backups[backup_id] = ManagerBackup(
                        ...
                        smarthub_included=agent_backup.smarthub_included,
                        smarthub_version=agent_backup.smarthub_version,
        ...
        for idx, result in enumerate(get_backup_results):
            ...
            if backup is None:
                ...
                backup = ManagerBackup(
                    ...
                    smarthub_included=result.smarthub_included,
                    smarthub_version=result.smarthub_version,
                    name=result.name,
                    with_automatic_settings=with_automatic_settings,
                )
    ...
    async def async_create_backup(
        ...
        *,
        ...
        new_backup = await self.async_initiate_backup(
            ...
            include_smarthub=include_smarthub,
            name=name,
            password=password,
    ...
    async def async_create_automatic_backup(self) -> NewBackup:
        ...
        return await self.async_create_backup(
            ...
            include_smarthub=True,  # always include HA
        ...
        *,
        ...
        try:
            await self._async_restore_backup(
                ...
                restore_smarthub=restore_smarthub,
            )
            self.async_on_backup_event(
                RestoreBackupEvent(
                    reason=None,
    ...
    def _create_automatic_backup_failed_issue(
        ...
        ir.async_create_issue(
            ...
            is_fixable=False,
            is_persistent=True,
            learn_more_url="smarthub://config/backup",
...
class CoreBackupReaderWriter(BackupReaderWriter):
    ...
    async def async_create_backup(
        ...
        *,
        ...
        if not include_smarthub:
            raise BackupReaderWriterError("SmartHub must be included in backup")
    ...
    async def async_restore_backup(
        ...
        *,
        ...
        if not restore_smarthub and not restore_database:
            raise BackupReaderWriterError(
                "SmartHub or database must be included in restore"
            )
        ...
        await self._hass.services.async_call("smarthub", "restart", blocking=True)
