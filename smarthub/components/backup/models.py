...
class BaseBackup:
    ...
    folders: list[Folder]
    smarthub_included: bool
    smarthub_version: str | None  # None if smarthub_included is False
    name: str
...
class AgentBackup(BaseBackup):
    ...
    def from_dict(cls, data: dict[str, Any]) -> Self:
        ...
        return cls(
            ...
            smarthub_included=data["smarthub_included"],
            smarthub_version=data["smarthub_version"],
            name=data["name"],
...
class BackupError(SmartHubError):
