...
@callback
def async_register_websocket_handlers(hass: SmartHub, with_hassio: bool) -> None:
...
@websocket_api.websocket_command(
    {
        ...
        vol.Optional("restore_smarthub", default=True): bool,
    }
)
@websocket_api.async_response
async def handle_restore(
    ...
    try:
        await hass.data[DATA_MANAGER].async_restore_backup(
            ...
            restore_smarthub=msg["restore_smarthub"],
        )
...
@websocket_api.websocket_command(
    {
        ...
        vol.Optional("include_smarthub", default=True): bool,
...
async def handle_create(
    ...
    backup = await hass.data[DATA_MANAGER].async_initiate_backup(
        ...
        include_smarthub=msg["include_smarthub"],
        name=msg.get("name"),
        password=msg.get("password"),
    )
