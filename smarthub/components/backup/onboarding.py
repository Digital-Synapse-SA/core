...
from smarthub.components.onboarding import (
    BaseOnboardingView,
...
if TYPE_CHECKING:
    from smarthub.components.onboarding import OnboardingStoreData


async def async_setup_views(hass: SmartHub, data: OnboardingStoreData) -> None:
...
def with_backup_manager[_ViewT: BaseOnboardingView, **_P](
    ...
    """SmartHub API decorator to check onboarding and inject manager."""
