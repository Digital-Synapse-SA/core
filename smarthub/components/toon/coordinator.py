...
from smarthub.components import cloud, webhook
...
class ToonDataUpdateCoordinator(DataUpdateCoordinator[Status]):
    ...
    def __init__(
        self, hass: SmartHub, entry: ConfigEntry, session: OAuth2Session
    ) -> None:
    ...
    async def handle_webhook(
        self, hass: SmartHub, webhook_id: str, request: web.Request
    ) -> None:
