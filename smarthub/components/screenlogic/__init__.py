...
async def async_setup_entry(hass: SmartHub, entry: ScreenLogicConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: ScreenLogicConfigEntry
) -> bool:
...
async def _async_migrate_entries(
    hass: SmartHub, config_entry: ScreenLogicConfigEntry
) -> None:
