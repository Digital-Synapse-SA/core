...
from smarthub.const import CONF_LOCATION, Platform
...
async def async_setup_entry(hass: SmartHub, entry: HKOConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: HKOConfigEntry) -> bool:
