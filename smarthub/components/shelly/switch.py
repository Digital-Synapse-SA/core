...
from smarthub.components.climate import DOMAIN as CLIMATE_PLATFORM
from smarthub.components.switch import (
    DOMAIN as SWITCH_PLATFORM,
    SwitchEntity,
    SwitchEntityDescription,
)
from smarthub.const import STATE_ON, EntityCategory
...
from smarthub.helpers.entity_registry import RegistryEntry
