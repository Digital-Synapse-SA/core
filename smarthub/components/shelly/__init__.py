...
async def async_setup_entry(hass: SmartHub, entry: ShellyConfigEntry) -> bool:
...
async def _async_setup_block_entry(
    hass: SmartHub, entry: ShellyConfigEntry
) -> bool:
    ...
    # https://github.com/smart-hub/core/pull/48076
    ...
    if sleep_period == 0:
        ...
        # SmartHub was restarted before the device was online. In this case we
...
async def _async_setup_rpc_entry(hass: SmartHub, entry: ShellyConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: ShellyConfigEntry) -> bool:
...
async def async_remove_entry(hass: SmartHub, entry: ShellyConfigEntry) -> None:
