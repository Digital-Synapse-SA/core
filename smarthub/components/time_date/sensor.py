...
from smarthub.const import CONF_DISPLAY_OPTIONS, EVENT_CORE_CONFIG_UPDATE
...
async def async_setup_platform(
    ...
    if hass.config.time_zone is None:
        _LOGGER.error("Timezone is not set in SmartHub configuration")  # type: ignore[unreachable]
        return
