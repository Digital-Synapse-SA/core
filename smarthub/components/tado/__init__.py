...
async def async_setup_entry(hass: SmartHub, entry: TadoConfigEntry) -> bool:
...
async def async_migrate_entry(hass: SmartHub, entry: TadoConfigEntry) -> bool:
    """Migrate old entry."""
...
def _async_import_options_from_data_if_missing(
    hass: SmartHub, entry: TadoConfigEntry
):
...
async def async_unload_entry(hass: SmartHub, entry: TadoConfigEntry) -> bool:
