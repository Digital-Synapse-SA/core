...
def get_device_connection(
    hass: SmartHub, address: AddressType, config_entry: ConfigEntry
...
def purge_entity_registry(
    hass: SmartHub, entry_id: str, imported_entry_data: ConfigType
) -> None:
...
def register_lcn_host_device(hass: SmartHub, config_entry: ConfigEntry) -> None:
