...
from smarthub.components.websocket_api import AsyncWebSocketCommandHandler
...
type AsyncLcnWebSocketCommandHandler = Callable[
    [SmartHub, ActiveConnection, dict[str, Any], ConfigEntry], Awaitable[None]
]

URL_BASE: Final = "/lcn_static"


async def register_panel_and_ws_api(hass: SmartHub) -> None:
...
def get_entity_entry(
    hass: SmartHub, entity_config: dict, config_entry: ConfigEntry
