...
async def async_setup_entry(hass: SmartHub, entry: EcobeeConfigEntry) -> bool:
...
class EcobeeData:
    ...
    def __init__(
        self, hass: SmartHub, entry: ConfigEntry, api_key: str, refresh_token: str
    ) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: EcobeeConfigEntry) -> bool:
