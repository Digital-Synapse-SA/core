...
def _is_valid_date_range(check_date: str, error: type[SmartHubError]) -> bool:
    """Validate date range."""
...
class AddDatesError(SmartHubError):
    """Exception for error adding dates."""


class AddDateRangeError(SmartHubError):
    """Exception for error adding dates."""


class RemoveDatesError(SmartHubError):
    """Exception for error removing dates."""


class RemoveDateRangeError(SmartHubError):
    """Exception for error removing dates."""


class CountryNotExist(SmartHubError):
