...
from smarthub.const import CONF_WEBHOOK_ID, EVENT_HOMEASSISTANT_STOP
...
async def async_cloudhook_generate_url(hass: SmartHub, entry: ConfigEntry) -> str:
...
async def async_config_entry_updated(hass: SmartHub, entry: ConfigEntry) -> None:
