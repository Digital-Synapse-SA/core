...
from smarthub.const import STATE_ON, Platform
...
from smarthub.helpers.restore_state import ExtraStoredData
...
class MatterUpdate(MatterEntity, UpdateEntity):
    ...
    async def async_update(self) -> None:
        ...
        try:
            ...
            raise SmartHubError(f"Error finding applicable update: {err}") from err
    ...
    async def async_install(
        ...
        if not self.get_matter_attribute_value(
            ...
            raise SmartHubError("Device is not ready to install updates")
        ...
        if software_version is None:
            raise SmartHubError("No software version specified")
        ...
        try:
            ...
            raise SmartHubError(f"Error updating: {err}") from err
        finally:
