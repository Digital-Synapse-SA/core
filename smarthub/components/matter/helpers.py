...
class MissingNode(SmartHubError):
...
@callback
def get_matter(hass: SmartHub) -> MatterAdapter:
...
@callback
def node_from_ha_device_id(hass: SmartHub, ha_device_id: str) -> MatterNode | None:
...
def get_node_from_device_entry(
    hass: SmartHub, device: dr.DeviceEntry
) -> MatterNode | None:
