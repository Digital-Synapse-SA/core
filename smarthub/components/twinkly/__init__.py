...
async def async_setup_entry(hass: SmartHub, entry: TwinklyConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: TwinklyConfigEntry) -> bool:
    """Remove a twinkly entry."""

    return await hass.config_entries.async_unload_platforms(entry, PLATFORMS)


async def async_migrate_entry(hass: SmartHub, entry: TwinklyConfigEntry) -> bool:
    """Migrate old entry."""
