...
from smarthub.helpers.aiohttp_client import (
    SERVER_SOFTWARE,
...
async def async_setup_entry(hass: SmartHub, entry: GithubConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: GithubConfigEntry) -> bool:
...
async def async_reload_entry(hass: SmartHub, entry: GithubConfigEntry) -> None:
