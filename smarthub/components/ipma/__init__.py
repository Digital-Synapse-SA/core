...
from smarthub.const import CONF_LATITUDE, CONF_LONGITUDE, Platform
...
async def async_setup_entry(hass: SmartHub, config_entry: IpmaConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: IpmaConfigEntry) -> bool:
