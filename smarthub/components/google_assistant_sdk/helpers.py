...
from smarthub.const import ATTR_ENTITY_ID, CONF_ACCESS_TOKEN
from smarthub.core import SmartHub
from smarthub.exceptions import SmartHubError
from smarthub.helpers.config_entry_oauth2_flow import OAuth2Session
...
async def async_send_text_commands(
    hass: SmartHub, commands: list[str], media_players: list[str] | None = None
...
def default_language_code(hass: SmartHub) -> str:
    """Get default language code based on SmartHub config."""
...
def best_matching_language_code(
    hass: SmartHub, assist_language: str, agent_language: str | None = None
) -> str:
...
class GoogleAssistantSDKAudioView(SmartHubView):
