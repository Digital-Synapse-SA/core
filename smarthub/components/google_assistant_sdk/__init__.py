...
from smarthub.const import CONF_ACCESS_TOKEN, CONF_NAME, Platform
from smarthub.core import SmartHub
from smarthub.exceptions import ConfigEntryAuthFailed, ConfigEntryNotReady
from smarthub.helpers import config_validation as cv, discovery, intent
...
class GoogleAssistantConversationAgent(conversation.AbstractConversationAgent):
    ...
    def __init__(
        self, hass: SmartHub, entry: GoogleAssistantSDKConfigEntry
    ) -> None:
