...
from smarthub.const import ATTR_ENTITY_ID, ATTR_ID
...
from smarthub.helpers.event import async_track_point_in_utc_time
from smarthub.util.dt import as_timestamp, now, parse_datetime, utc_from_timestamp
...
async def async_setup_entry(
    ...
    def start_multiple(service: ServiceCall) -> None:
        ...
        if len(zones_list) != 0:
            ...
            raise SmartHubError("No matching zones found in given entity_ids")
...
def _create_entities(
    hass: SmartHub, config_entry: RachioConfigEntry
) -> list[Entity]:
