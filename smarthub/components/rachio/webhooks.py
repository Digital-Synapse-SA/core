...
from smarthub.const import CONF_WEBHOOK_ID, URL_API
...
WEBHOOK_CONST_ID = "smarthub.rachio:"
...
@callback
def async_register_webhook(hass: SmartHub, entry: RachioConfigEntry) -> None:
    """Register a webhook."""
...
@callback
def async_unregister_webhook(hass: SmartHub, entry: RachioConfigEntry) -> None:
...
async def async_get_or_create_registered_webhook_id_and_url(
    hass: SmartHub, entry: RachioConfigEntry
) -> str:
