            ...
            ir.async_create_issue(
                ...
                translation_placeholders={
                    ...
                    "home_assistant_core_new_issue_url": (
                        "https://github.com/smart-hub/core/issues/new?template=bug_report.yml"
                        f"&integration_name={DOMAIN}&integration_link=https://www.smart-hub.io/integrations/{DOMAIN}/"
                    ),
                },
            )
            return True
