...
from smarthub.components.binary_sensor import DEVICE_CLASSES_SCHEMA
...
async def async_entry_updated(hass: SmartHub, entry: ConfigEntry) -> None:
    """Reload the config entry when options change."""
    await hass.config_entries.async_reload(entry.entry_id)


class KonnectedView(SmartHubView):
