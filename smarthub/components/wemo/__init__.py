...
from smarthub.const import CONF_DISCOVERY, EVENT_HOMEASSISTANT_STOP, Platform
from smarthub.core import CALLBACK_TYPE, Event, HassJob, SmartHub, callback
...
from smarthub.util.async_ import gather_with_limited_concurrency
...
async def async_wemo_dispatcher_connect(
    ...
    module = dispatch.__module__  # Example: "smarthub.components.wemo.switch"
...
class WemoDispatcher:
    ...
    async def async_add_unique_device(
        self, hass: SmartHub, wemo: pywemo.WeMoDevice
    ) -> None:
    ...
    async def async_unload_platforms(self, hass: SmartHub) -> bool:
