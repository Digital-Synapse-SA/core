...
from smarthub.const import CONF_COUNTRY, CONF_MODE, CONF_PASSWORD, CONF_USERNAME
from smarthub.core import SmartHub
from smarthub.helpers import aiohttp_client, selector
from smarthub.helpers.typing import VolDictType
from smarthub.util.ssl import get_default_no_verify_context
...
async def _validate_input(
    hass: SmartHub, user_input: dict[str, Any]
) -> dict[str, str]:
    """Validate user input."""
    errors: dict[str, str] = {}
