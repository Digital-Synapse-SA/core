...
from smarthub.const import CONF_DEVICE_ID, CONF_ENTITY_ID, CONF_NAME, Platform
...
def _async_migrate_options_from_data_if_missing(
    hass: SmartHub, entry: BMWConfigEntry
) -> None:
...
async def _async_migrate_entries(
    hass: SmartHub, config_entry: BMWConfigEntry
) -> bool:
    """Migrate old entry."""
...
async def async_setup_entry(hass: SmartHub, entry: BMWConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BMWConfigEntry) -> bool:
