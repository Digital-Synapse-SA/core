...
async def async_setup_entry(hass: SmartHub, entry: MieleConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: MieleConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: MieleConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
