...
CLIENT_INFO = f"SmartHub {ha_version}"
...
async def async_setup_entry(hass: SmartHub, entry: ESPHomeConfigEntry) -> bool:
    """Set up the esphome component."""
...
async def async_unload_entry(hass: SmartHub, entry: ESPHomeConfigEntry) -> bool:
...
async def async_remove_entry(hass: SmartHub, entry: ESPHomeConfigEntry) -> None:
