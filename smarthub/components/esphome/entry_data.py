...
from smarthub.components.assist_satellite import AssistSatelliteConfiguration
...
class RuntimeEntryData:
    ...
    def async_remove_entities(
        self, hass: SmartHub, static_infos: Iterable[EntityInfo], mac: str
    ) -> None:
    ...
    async def async_update_listener(
        self, hass: SmartHub, entry: ESPHomeConfigEntry
    ) -> None:
