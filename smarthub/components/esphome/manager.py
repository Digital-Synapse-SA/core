...
from smarthub.components import bluetooth, tag, zeroconf
...
def _async_check_firmware_version(
    hass: SmartHub, device_info: EsphomeDeviceInfo, api_version: APIVersion
) -> None:
...
def _async_check_using_api_password(
    hass: SmartHub, device_info: EsphomeDeviceInfo, has_password: bool
) -> None:
...
class ESPHomeManager:
    ...
    def async_on_service_call(self, service: HomeassistantServiceCall) -> None:
        ...
        if service.is_event:
            ...
            _LOGGER.error(
                ...
                "SmartHub service calls, you can enable this "
    ...
    def _send_home_assistant_state(
        ...
        """Forward SmartHub states to ESPHome."""
    ...
    def _send_home_assistant_state_event(
        ...
        """Forward SmartHub states updates to ESPHome."""
    ...
    async def _on_connect(self) -> None:
        ...
        if not device_info.friendly_name:
            _LOGGER.info(
                ...
                "with SmartHub naming conventions",
                device_info.name,
                device_mac,
            )
    ...
    async def async_start(self) -> None:
        ...
        # the callback twice when shutting down SmartHub.
...
def _async_setup_device_registry(
    hass: SmartHub, entry: ESPHomeConfigEntry, entry_data: RuntimeEntryData
) -> str:
    ...
    if device_info.webserver_port > 0:
        ...
        configuration_url = f"smarthub://hassio/ingress/{dashboard.addon_slug}"
...
@callback
def _setup_services(
    hass: SmartHub, entry_data: RuntimeEntryData, services: list[UserService]
) -> None:
    device_info = entry_data.device_info
