...
async def async_pulse(
    hass: SmartHub, ihc_controller: IHCController, ihc_id: int
) -> None:
...
@callback
def async_set_bool(
    hass: SmartHub, ihc_controller: IHCController, ihc_id: int, value: bool
) -> asyncio.Future[bool]:
...
@callback
def async_set_int(
    hass: SmartHub, ihc_controller: IHCController, ihc_id: int, value: int
) -> asyncio.Future[bool]:
...
@callback
def async_set_float(
    hass: SmartHub, ihc_controller: IHCController, ihc_id: int, value: float
) -> asyncio.Future[bool]:
