...
from smarthub.const import CONF_TYPE, CONF_UNIT_OF_MEASUREMENT, UnitOfTemperature
...
def autosetup_ihc_products(hass: SmartHub, config, ihc_controller, controller_id):
