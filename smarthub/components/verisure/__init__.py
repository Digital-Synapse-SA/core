...
from smarthub.const import CONF_EMAIL, Platform
...
async def update_listener(hass: SmartHub, entry: ConfigEntry):
...
def migrate_cookie_files(hass: SmartHub, entry: ConfigEntry) -> None:
