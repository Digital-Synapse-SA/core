...
from smarthub.components.select import SelectEntity, SelectEntityDescription
from smarthub.const import EntityCategory, Platform
from smarthub.core import SmartHub, callback
from smarthub.helpers import collection, entity_registry as er, restore_state
...
class AssistPipelineSelect(SelectEntity, restore_state.RestoreEntity):
    ...
    def __init__(self, hass: SmartHub, domain: str, unique_id_prefix: str) -> None:
...
class VadSensitivitySelect(SelectEntity, restore_state.RestoreEntity):
    ...
    def __init__(self, hass: SmartHub, unique_id_prefix: str) -> None:
        """Initialize a pipeline selector."""
