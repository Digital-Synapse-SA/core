...
from smarthub.components import conversation, stt, tts, websocket_api
from smarthub.const import ATTR_DEVICE_ID, ATTR_SECONDS, MATCH_ALL
...
@callback
def async_register_websocket_api(hass: SmartHub) -> None:
