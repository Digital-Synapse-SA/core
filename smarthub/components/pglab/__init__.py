...
async def async_setup_entry(
    hass: SmartHub, config_entry: PGLabConfigEntry
) -> bool:
    ...
    async def mqtt_publish(topic: str, payload: str, qos: int, retain: bool) -> None:
        """Publish an MQTT message using the SmartHub MQTT client."""
    ...
    async def mqtt_subscribe(
        ...
        """Subscribe to MQTT topics using the SmartHub MQTT client."""
