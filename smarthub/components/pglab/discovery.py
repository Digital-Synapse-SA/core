...
async def create_discover_device_info(
    hass: SmartHub, config_entry: PGLabConfigEntry, pglab_device: PyPGLabDevice
) -> DiscoverDeviceInfo:
...
class PGLabDiscovery:
    ...
    def __clean_discovered_device(self, hass: SmartHub, device_id: str) -> None:
    ...
    async def register_platform(
        self, hass: SmartHub, platform: Platform, target: Callable[..., Any]
    ):
    ...
    async def stop(self, hass: SmartHub, config_entry: PGLabConfigEntry) -> None:
