...
from smarthub.util.dt import async_get_time_zone
...
async def async_setup_entry(hass: SmartHub, entry: FytaConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: FytaConfigEntry) -> bool:
    """Unload Fyta entity."""
...
async def async_migrate_entry(
    hass: SmartHub, config_entry: FytaConfigEntry
) -> bool:
    """Migrate old entry."""
