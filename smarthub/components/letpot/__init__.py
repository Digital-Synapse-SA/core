...
from smarthub.const import CONF_ACCESS_TOKEN, CONF_EMAIL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: LetPotConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: LetPotConfigEntry) -> bool:
