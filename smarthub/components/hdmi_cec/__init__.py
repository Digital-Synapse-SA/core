...
from smarthub.components.media_player import DOMAIN as MEDIA_PLAYER
...
from smarthub.core import HassJob, SmartHub, ServiceCall, callback
from smarthub.helpers import config_validation as cv, discovery, event
...
def setup(hass: SmartHub, base_config: ConfigType) -> bool:  # noqa: C901
