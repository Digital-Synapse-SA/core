...
from smarthub.components.mqtt import DOMAIN as MQTT_DOMAIN, ReceiveMessage
...
class AxisEventSource:
    ...
    def __init__(
        self, hass: SmartHub, config_entry: ConfigEntry, api: axis.AxisDevice
    ) -> None:
    ...
    async def _async_use_mqtt(self, hass: SmartHub, component: str) -> None:
        """Set up to use MQTT."""
        try:
