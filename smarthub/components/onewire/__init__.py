...
async def async_setup_entry(hass: SmartHub, entry: OneWireConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: OneWireConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, config_entry: OneWireConfigEntry
) -> bool:
