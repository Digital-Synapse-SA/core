...
async def async_setup_entry(hass: SmartHub, entry: P1MonitorConfigEntry) -> bool:
...
async def async_migrate_entry(
    hass: SmartHub, config_entry: P1MonitorConfigEntry
) -> bool:
    """Migrate old entry."""
...
async def async_unload_entry(hass: SmartHub, entry: P1MonitorConfigEntry) -> bool:
