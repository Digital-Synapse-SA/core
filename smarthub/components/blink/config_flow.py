...
from smarthub.const import CONF_PASSWORD, CONF_PIN, CONF_USERNAME
...
async def _send_blink_2fa_pin(hass: SmartHub, auth: Auth, pin: str | None) -> bool:
...
class Require2FA(SmartHubError):
