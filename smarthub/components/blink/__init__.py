...
async def _reauth_flow_wrapper(
    hass: SmartHub, entry: BlinkConfigEntry, data: dict[str, Any]
) -> None:
    """Reauth flow wrapper."""
...
async def async_migrate_entry(hass: SmartHub, entry: BlinkConfigEntry) -> bool:
...
async def async_setup_entry(hass: SmartHub, entry: BlinkConfigEntry) -> bool:
...
def _async_import_options_from_data_if_missing(
    hass: SmartHub, entry: BlinkConfigEntry
) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: BlinkConfigEntry) -> bool:
    """Unload Blink entry."""
