...
class KeyboardRemote:
    ...
    def __init__(self, hass: SmartHub, config: list[dict[str, Any]]) -> None:
    ...
    def setup(self):
        """Listen for SmartHub start and stop events."""
    ...
    class DeviceHandler:
        ...
        def __init__(self, hass: SmartHub, dev_block: dict[str, Any]) -> None:
