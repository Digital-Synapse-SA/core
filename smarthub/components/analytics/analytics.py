...
from smarthub.components.api import ATTR_INSTALLATION_TYPE
from smarthub.components.automation import DOMAIN as AUTOMATION_DOMAIN
from smarthub.components.energy import (
...
from smarthub.const import ATTR_DOMAIN, BASE_PLATFORMS, __version__ as HA_VERSION
...
from smarthub.setup import async_get_loaded_integrations
        ...
        try:
            async with timeout(30):
                ...
                if response.status == 200:
                    LOGGER.info(
                        (
                            "Submitted analytics to SmartHub servers. "
