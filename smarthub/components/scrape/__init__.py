...
from smarthub.components.rest import RESOURCE_SCHEMA, create_rest_data_from_config
...
async def async_setup_entry(hass: SmartHub, entry: ScrapeConfigEntry) -> bool:
