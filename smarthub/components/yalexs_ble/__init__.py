...
async def async_setup_entry(hass: SmartHub, entry: YALEXSBLEConfigEntry) -> bool:
...
async def _async_update_listener(
    hass: SmartHub, entry: YALEXSBLEConfigEntry
) -> None:
...
async def async_unload_entry(hass: SmartHub, entry: YALEXSBLEConfigEntry) -> bool:
