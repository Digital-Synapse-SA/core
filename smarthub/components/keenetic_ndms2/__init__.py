...
from smarthub.const import CONF_HOST, CONF_SCAN_INTERVAL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: KeeneticConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, config_entry: KeeneticConfigEntry
) -> bool:
...
async def update_listener(hass: SmartHub, entry: KeeneticConfigEntry) -> None:
    """Handle options update."""
    await hass.config_entries.async_reload(entry.entry_id)


def async_add_defaults(hass: SmartHub, entry: KeeneticConfigEntry):
