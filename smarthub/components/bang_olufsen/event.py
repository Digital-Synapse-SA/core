...
from smarthub.components.event import EventDeviceClass, EventEntity
from smarthub.const import CONF_MODEL
...
class BangOlufsenButtonEvent(BangOlufsenEntity, EventEntity):
    ...
    def __init__(self, config_entry: BangOlufsenConfigEntry, button_type: str) -> None:
        ...
        # Make the native button name SmartHub compatible
