...
from smarthub.const import CONF_HOST, CONF_MODEL, Platform
...
async def async_setup_entry(hass: SmartHub, entry: BangOlufsenConfigEntry) -> bool:
...
async def async_unload_entry(
    hass: SmartHub, entry: BangOlufsenConfigEntry
) -> bool:
