...
from smarthub.helpers.entity import SLOW_UPDATE_WARNING
...
async def async_setup_entry(hass: SmartHub, entry: BondConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: BondConfigEntry) -> bool:
...
async def async_remove_config_entry_device(
    hass: SmartHub, config_entry: BondConfigEntry, device_entry: dr.DeviceEntry
) -> bool:
