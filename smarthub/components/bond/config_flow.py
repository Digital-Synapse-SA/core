...
from smarthub.config_entries import ConfigEntryState, ConfigFlow, ConfigFlowResult
from smarthub.const import CONF_ACCESS_TOKEN, CONF_HOST, CONF_NAME
...
async def async_get_token(hass: SmartHub, host: str) -> str | None:
...
async def _validate_input(hass: SmartHub, data: dict[str, Any]) -> tuple[str, str]:
...
class InputValidationError(SmartHubError):
