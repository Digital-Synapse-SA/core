...
from smarthub.components.media_player import DOMAIN as MP_DOMAIN, BrowseError
from smarthub.config_entries import ConfigEntry
from smarthub.const import CONF_URL, CONF_VERIFY_SSL, EVENT_HOMEASSISTANT_STOP
...
from smarthub.helpers.network import is_internal_request
...
async def async_options_updated(hass: SmartHub, entry: ConfigEntry) -> None:
