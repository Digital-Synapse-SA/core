...
from smarthub.components.media_player import DOMAIN as MP_DOMAIN, MediaType
from smarthub.const import CONF_CLIENT_ID, CONF_TOKEN, CONF_URL, CONF_VERIFY_SSL
