...
from smarthub.const import ATTR_TEMPERATURE, PRECISION_HALVES, UnitOfTemperature
...
# Mappings from radiotherm json data codes to and from SmartHub state
# flags.  CODE is the thermostat integer code and these map to and
# from SmartHub state flags.
