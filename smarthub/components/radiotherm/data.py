...
async def async_get_init_data(hass: SmartHub, host: str) -> RadioThermInitData:
...
def _get_data(device: CommonThermostat) -> RadioThermUpdate:
    ...
    # to a bare minimum or we'll hit the SmartHub 10 sec warning.  We
...
async def async_get_data(
    hass: SmartHub, device: CommonThermostat
) -> RadioThermUpdate:
