...
from smarthub.const import CONF_HOST, CONF_NAME, CONF_PORT, CONF_TYPE, STATE_ON
...
from smarthub.util.color import color_hs_to_RGB
...
class LimitlessLEDGroup(LightEntity, RestoreEntity):
    ...
    def limitlessled_temperature(self) -> float:
        """Convert SmartHub color temperature units to percentage."""
