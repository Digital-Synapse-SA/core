"""Plugwise platform for SmartHub Core."""
...
async def async_setup_entry(hass: SmartHub, entry: PlugwiseConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: PlugwiseConfigEntry) -> bool:
