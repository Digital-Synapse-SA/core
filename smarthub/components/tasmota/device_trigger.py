...
from smarthub.components.smarthub.triggers import event as event_trigger
    ...
    async def add_trigger(
        ...
        def async_remove() -> None:
            ...
            if instance not in self.trigger_instances:
                raise SmartHubError("Can't remove trigger twice")
...
async def async_remove_triggers(hass: SmartHub, device_id: str) -> None:
