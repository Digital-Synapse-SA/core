...
async def async_entry_changed(hass: SmartHub, entry: DynaliteConfigEntry) -> None:
...
async def async_setup_entry(hass: SmartHub, entry: DynaliteConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: DynaliteConfigEntry) -> bool:
