...
from smarthub.helpers.aiohttp_client import async_create_clientsession
...
def create_async_tplink_clientsession(hass: SmartHub) -> ClientSession:
...
async def async_discover_devices(hass: SmartHub) -> dict[str, Device]:
...
async def async_setup_entry(hass: SmartHub, entry: TPLinkConfigEntry) -> bool:
...
async def async_unload_entry(hass: SmartHub, entry: TPLinkConfigEntry) -> bool:
...
async def get_credentials(hass: SmartHub) -> Credentials | None:
...
async def set_credentials(hass: SmartHub, username: str, password: str) -> None:
...
async def async_migrate_entry(
    hass: SmartHub, config_entry: TPLinkConfigEntry
) -> bool:
    """Migrate old entry."""
