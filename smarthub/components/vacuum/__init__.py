...
from smarthub.const import (  # noqa: F401 # STATE_PAUSED/IDLE are API
    ATTR_BATTERY_LEVEL,
    ATTR_COMMAND,
    SERVICE_TOGGLE,
    SERVICE_TURN_OFF,
...
from smarthub.helpers.icon import icon_for_battery_level
...
# These STATE_* constants are deprecated as of SmartHub 2025.1.
