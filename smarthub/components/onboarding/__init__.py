...
@bind_hass
@callback
def async_is_onboarded(hass: SmartHub) -> bool:
    """Return if SmartHub has been onboarded."""
...
@bind_hass
@callback
def async_is_user_onboarded(hass: SmartHub) -> bool:
...
@callback
def async_add_listener(hass: SmartHub, listener: Callable[[], None]) -> None:
