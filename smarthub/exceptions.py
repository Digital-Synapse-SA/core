"""The exceptions used by SmartHub."""
...
class SmartHubError(Exception):
    """General SmartHub exception occurred."""
...
class ConfigValidationError(SmartHubError, ExceptionGroup[Exception]):
...
class ServiceValidationError(SmartHubError):
    """A validation exception occurred when calling a service."""


class InvalidEntityFormatError(SmartHubError):
    """When an invalid formatted entity is encountered."""


class NoEntitySpecifiedError(SmartHubError):
    """When no entity is specified."""


class TemplateError(SmartHubError):
...
class ConditionError(SmartHubError):
...
class IntegrationError(SmartHubError):
...
class InvalidStateError(SmartHubError):
    """When an invalid state is encountered."""


class Unauthorized(SmartHubError):
...
class MaxLengthExceeded(SmartHubError):
...
class DependencyError(SmartHubError):
