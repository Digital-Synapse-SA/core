...
WHOAMI_URL = "https://services.smart-hub.io/whoami/v1"
WHOAMI_URL_DEV = "https://services-dev.smart-hub.workers.dev/whoami/v1"
...
async def _get_whoami(session: aiohttp.ClientSession) -> dict[str, Any] | None:
    """Query whoami.smart-hub.io for location data."""
    try:
