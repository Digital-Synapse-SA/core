...
@callback
def async_initialize_recorder(hass: SmartHub) -> None:
    ...
    """
    from smarthub.components.recorder.basic_websocket_api import (  # noqa: PLC0415
        async_setup,
    )
...
def get_instance(hass: SmartHub) -> Recorder:
