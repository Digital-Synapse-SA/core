...
from smarthub.components import zone as zone_cmp
...
type ConditionCheckerType = Callable[[SmartHub, TemplateVarsType], bool | None]
...
def trace_condition_function(condition: ConditionCheckerType) -> ConditionCheckerType:
    ...
    @ft.wraps(condition)
    def wrapper(hass: SmartHub, variables: TemplateVarsType = None) -> bool | None:
        """Trace condition."""
    ...
    if CONF_ENABLED in config:
        ...
        if not enabled:
            ...
            def disabled_condition(
                hass: SmartHub, variables: TemplateVarsType = None
            ) -> bool | None:
...
def state_from_config(config: ConfigType) -> ConditionCheckerType:
    ...
    @trace_condition_function
    def if_state(hass: SmartHub, variables: TemplateVarsType = None) -> bool:
        """Test if condition."""
        errors = []
...
def template(
    hass: SmartHub, value_template: Template, variables: TemplateVarsType = None
) -> bool:
...
def async_template_from_config(config: ConfigType) -> ConditionCheckerType:
    ...
    @trace_condition_function
    def template_if(hass: SmartHub, variables: TemplateVarsType = None) -> bool:
...
def time_from_config(config: ConfigType) -> ConditionCheckerType:
    ...
    @trace_condition_function
    def time_if(hass: SmartHub, variables: TemplateVarsType = None) -> bool:
...
def zone_from_config(config: ConfigType) -> ConditionCheckerType:
    ...
    @trace_condition_function
    def if_in_zone(hass: SmartHub, variables: TemplateVarsType = None) -> bool:
        """Test if condition."""
        errors = []
...
async def async_trigger_from_config(
    ...
    @trace_condition_function
    def trigger_if(hass: SmartHub, variables: TemplateVarsType = None) -> bool:
...
def state_validate_config(hass: SmartHub, config: ConfigType) -> ConfigType:
...
async def async_validate_condition_config(
    ...
    if platform is None and condition in ("numeric_state", "state"):
        validator = cast(
            Callable[[SmartHub, ConfigType], ConfigType],
...
async def async_validate_conditions_config(
    hass: SmartHub, conditions: list[ConfigType]
