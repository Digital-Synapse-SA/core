...
from smarthub.core import Event, SmartHub, async_get_hass, callback
...
def _async_get_translations_cache(hass: SmartHub) -> _TranslationCache:
...
async def async_load_integrations(hass: SmartHub, integrations: set[str]) -> None:
...
@callback
def async_translations_loaded(hass: SmartHub, components: set[str]) -> bool:
    """Return if the given components are loaded for the language."""
