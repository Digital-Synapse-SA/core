...
async def async_reload_integration_platforms(
    hass: SmartHub, integration_domain: str, platform_domains: Iterable[str]
) -> None:
    ...
    SmartHub data and make this available to other integrations.
...
async def async_integration_yaml_config(
    hass: SmartHub, integration_name: str, *, raise_on_failure: bool = False
) -> ConfigType | None:
...
def async_get_platform_without_config_entry(
    hass: SmartHub, integration_name: str, integration_platform_name: str
) -> EntityPlatform | None:
...
async def async_setup_reload_service(
    hass: SmartHub, domain: str, platforms: Iterable[str]
) -> None:
