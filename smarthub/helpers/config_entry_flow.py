...
type DiscoveryFunctionType[_R] = Callable[[SmartHub], _R]
...
class WebhookFlowHandler(config_entries.ConfigFlow):
    ...
    async def async_step_user(
        ...
        from smarthub.components.webhook import (  # noqa: PLC0415
            async_generate_id,
            async_generate_url,
        )
...
async def webhook_async_remove_entry(
    ...
    # Local import to be sure cloud is loaded and setup
    from smarthub.components.cloud import async_delete_cloudhook  # noqa: PLC0415
