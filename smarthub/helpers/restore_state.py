...
from smarthub.const import ATTR_RESTORED, EVENT_HOMEASSISTANT_STOP
from smarthub.core import SmartHub, State, callback, valid_entity_id
...
class ExtraStoredData(ABC):
    ...
    def as_dict(self) -> dict[str, Any]:
        ...
        Must be serializable by SmartHub's JSONEncoder.
        """
...
def async_get(hass: SmartHub) -> RestoreStateData:
...
class RestoreStateData:
    ...
    @classmethod
    async def async_save_persistent_states(cls, hass: SmartHub) -> None:
        """Dump states now."""
    ...
    async def async_setup(self) -> None:
        ...
        @callback
        def hass_start(hass: SmartHub) -> None:
    ...
    def async_setup_dump(self, *args: Any) -> None:
        ...
        # old states loaded by overwriting the last states once SmartHub
