"""Temperature helpers for SmartHub."""

from __future__ import annotations

from numbers import Number

from smarthub.const import PRECISION_HALVES, PRECISION_TENTHS
from smarthub.core import SmartHub
from smarthub.util.unit_conversion import TemperatureConverter


def display_temp(
    hass: SmartHub, temperature: float | None, unit: str, precision: float
) -> float | None:
