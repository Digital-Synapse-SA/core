...
def async_get(hass: SmartHub) -> IssueRegistry:
    """Get issue registry."""
    return IssueRegistry(hass)


async def async_load(hass: SmartHub, *, read_only: bool = False) -> None:
    """Load issue registry."""
    ir = async_get(hass)
...
@callback
def async_delete_issue(hass: SmartHub, domain: str, issue_id: str) -> None:
    """Delete an issue.
...
def delete_issue(hass: SmartHub, domain: str, issue_id: str) -> None:
    """Delete an issue.
...
def async_ignore_issue(
    hass: SmartHub, domain: str, issue_id: str, ignore: bool
) -> None:
    """Ignore an issue.
