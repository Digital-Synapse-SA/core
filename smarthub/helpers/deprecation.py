"""Deprecation helpers for SmartHub."""
...
def _print_deprecation_warning_internal_impl(
    ...
    *,
    ...
    from smarthub.core import async_get_hass_or_none  # noqa: PLC0415
    from smarthub.loader import async_suggest_report_issue  # noqa: PLC0415
