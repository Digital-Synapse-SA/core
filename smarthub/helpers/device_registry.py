...
CONFIGURATION_URL_SCHEMES = {"http", "https", "smarthub"}
...
class DeviceInfoError(SmartHubError):
...
class DeviceCollisionError(SmartHubError):
...
def async_get(hass: SmartHub) -> DeviceRegistry:
    """Get device registry."""
...
@callback
def async_setup_cleanup(hass: SmartHub, dev_reg: DeviceRegistry) -> None:
