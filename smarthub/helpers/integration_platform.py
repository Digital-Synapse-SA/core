...
from smarthub.core import Event, HassJob, SmartHub, callback
...
from smarthub.setup import ATTR_COMPONENT, EventComponentLoaded
...
class IntegrationPlatform:
    ...
    platform_name: str
    process_job: HassJob[[SmartHub, str, Any], Awaitable[None] | None]
...
async def async_process_integration_platforms(
    ...
    platform_name: str,
    # Any = platform.
    process_platform: Callable[[SmartHub, str, Any], Awaitable[None] | None],
