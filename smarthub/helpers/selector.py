...
from smarthub.const import CONF_MODE, CONF_UNIT_OF_MEASUREMENT
from smarthub.core import split_entity_id, valid_entity_id
from smarthub.generated.countries import COUNTRIES
from smarthub.util import decorator
from smarthub.util.yaml import dumper
...
def _entity_feature_flag(domain: str, enum_name: str, feature_name: str) -> int:
    ...
    """
    module = importlib.import_module(f"smarthub.components.{domain}")
