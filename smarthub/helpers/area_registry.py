...
def async_get(hass: SmartHub) -> AreaRegistry:
    """Get area registry."""
...
def _validate_temperature_entity(hass: SmartHub, entity_id: str) -> None:
    """Validate temperature entity."""
    from smarthub.components.sensor import SensorDeviceClass  # noqa: PLC0415
...
def _validate_humidity_entity(hass: SmartHub, entity_id: str) -> None:
