...
from smarthub.core import Context, SmartHub, is_callback
from smarthub.util.json import JSON_ENCODE_EXCEPTIONS, format_unserializable_data
...
KEY_HASS: AppKey[SmartHub] = AppKey("hass")
...
def request_handler_factory(
    hass: SmartHub, view: SmartHubView, handler: Callable
...
class SmartHubView:
    ...
    def register(
        self, hass: SmartHub, app: web.Application, router: web.UrlDispatcher
    ) -> None:
