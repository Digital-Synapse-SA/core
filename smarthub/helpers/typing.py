...
def _deprecated_typing_helper(attr: str) -> DeferredDeprecatedAlias:
    ...
    def value_fn() -> Any:
        import smarthub.core  # noqa: PLC0415

        return getattr(smarthub.core, attr)

    return DeferredDeprecatedAlias(value_fn, f"smarthub.core.{attr}", "2025.5")
...
# Deprecated as of 2024.5 use types from smarthub.core instead.
_DEPRECATED_ContextType = _deprecated_typing_helper("Context")
_DEPRECATED_EventType = _deprecated_typing_helper("Event")
_DEPRECATED_SmartHubType = _deprecated_typing_helper("SmartHub")
