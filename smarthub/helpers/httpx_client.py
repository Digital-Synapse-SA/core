...
@callback
@bind_hass
def get_async_client(hass: SmartHub, verify_ssl: bool = True) -> httpx.AsyncClient:
...
def create_async_httpx_client(
    ...
    **kwargs: Any,
    ...
    automatically closed on smarthub_stop.
    ...
    client.aclose = warn_use(  # type: ignore[method-assign]
        client.aclose, "closes the SmartHub httpx client"
    )
...
def _async_register_async_client_shutdown(
    ...
    """Register httpx AsyncClient aclose on SmartHub shutdown.
