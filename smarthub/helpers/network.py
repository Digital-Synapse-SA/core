...
from smarthub.util.network import is_ip_address, is_loopback, normalize_url
...
SUPERVISOR_NETWORK_HOST = "smarthub"


class NoURLAvailableError(SmartHubError):
    """An URL to the SmartHub instance is not available."""


@bind_hass
def is_internal_request(hass: SmartHub) -> bool:
...
def get_supervisor_network_url(
    hass: SmartHub, *, allow_ssl: bool = False
) -> str | None:
...
def is_hass_url(hass: SmartHub, url: str) -> bool:
    """Return if the URL points at this SmartHub instance."""
    parsed = yarl.URL(url)
    ...
    *,
    ...
    if (
        ...
        if is_hassio(hass):
            ...
            from smarthub.components.hassio import get_host_info  # noqa: PLC0415
...
@bind_hass
def _get_cloud_url(hass: SmartHub, require_current_request: bool = False) -> str:
    """Get external SmartHub Cloud URL of this instance."""
...
def is_cloud_connection(hass: SmartHub) -> bool:
