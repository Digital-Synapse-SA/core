...
from smarthub.const import RESTART_EXIT_CODE
...
KEY_HA_STOP: HassKey[asyncio.Task[None]] = HassKey("smarthub_stop")


@callback
@bind_hass
def async_register_signal_handling(hass: SmartHub) -> None:
