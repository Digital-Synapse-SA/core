...
from smarthub.generated import languages
from smarthub.setup import SetupPhases, async_start_setup
...
class EntityPlatform:
    ...
    def _get_parallel_updates_semaphore(
        ...
        entity of the platform which is added to SmartHub. It's 1 if the
    ...
    async def async_setup(
        ...
        if not hasattr(platform, "async_setup_platform") and not hasattr(
            ...
            if self.platform and "custom_components" not in self.platform.__file__:  # type: ignore[attr-defined]
                learn_more_url = (
                    f"https://www.smart-hub.io/integrations/{self.platform_name}/"
                )
    ...
    async def _async_add_entity(  # noqa: C901
        ...
        if entity.unique_id is not None:
            ...
            if not valid_entity_id(entity.entity_id):
                entity.add_to_platform_abort()
                raise SmartHubError(f"Invalid entity ID: {entity.entity_id}")
