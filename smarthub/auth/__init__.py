"""Provide an authentication layer for SmartHub."""
...
from smarthub.data_entry_flow import FlowHandler, FlowManager, FlowResultType
...
from .providers.smarthub import HassAuthProvider
...
async def auth_manager_from_config(
    ...
    for provider in providers:
        ...
        if isinstance(provider, HassAuthProvider):
            # Can be removed in 2026.7 with the legacy mode of smarthub auth provider
...
class AuthManagerFlowManager(
    ...
    def __init__(self, hass: SmartHub, auth_manager: AuthManager) -> None:
...
class AuthManager:
    """Manage the authentication for SmartHub."""
