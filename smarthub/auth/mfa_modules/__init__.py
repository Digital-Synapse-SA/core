"""Pluggable auth modules for SmartHub."""
...
from smarthub import data_entry_flow, requirements
from smarthub.const import CONF_ID, CONF_NAME, CONF_TYPE
...
class MultiFactorAuthModule:
    ...
    def __init__(self, hass: SmartHub, config: dict[str, Any]) -> None:
...
async def _load_mfa_module(hass: SmartHub, module_name: str) -> types.ModuleType:
    """Load an mfa auth module."""
    module_path = f"smarthub.auth.mfa_modules.{module_name}"
