...
from smarthub.bootstrap import async_mount_local_lib_path
from smarthub.config import get_default_config_dir
from smarthub.requirements import pip_kwargs
from smarthub.util.package import install_package, is_installed, is_virtual_env
...
def run(args: list[str]) -> int:
    ...
    script = importlib.import_module(f"smarthub.scripts.{args[0]}")
