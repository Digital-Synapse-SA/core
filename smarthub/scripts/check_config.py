...
from smarthub import core, loader
from smarthub.config import get_default_config_dir
from smarthub.config_entries import ConfigEntries
...
from smarthub.helpers.check_config import async_check_ha_config_file
...
MOCKS: dict[str, tuple[str, Callable]] = {
    ...
    "load*": ("smarthub.config.load_yaml_dict", yaml_loader.load_yaml_dict),
...
def run(script_args: list) -> int:
    ...
    parser = argparse.ArgumentParser(description="Check SmartHub configuration.")
...
def check(config_dir, secrets=False):
    ...
    logging.getLogger("smarthub.loader").setLevel(logging.CRITICAL)
    res: dict[str, Any] = {
        ...
        #'components' is a SmartHubConfig
        "secret_cache": {},
    }
