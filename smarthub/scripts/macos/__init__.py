...
def install_osx():
    ...
    path = os.path.expanduser("~/Library/LaunchAgents/org.smarthub.plist")
    ...
    print("SmartHub has been installed. Open it here: http://localhost:8123")
...
def uninstall_osx():
    ...
    print("SmartHub has been uninstalled.")
