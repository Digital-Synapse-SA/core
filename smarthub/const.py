"""Constants used by SmartHub components."""
...
APPLICATION_NAME: Final = "SmartHub"
...
EVENT_HOMEASSISTANT_CLOSE: EventType[NoEventData] = EventType("smarthub_close")
EVENT_HOMEASSISTANT_START: EventType[NoEventData] = EventType("smarthub_start")
EVENT_HOMEASSISTANT_STARTED: EventType[NoEventData] = EventType("smarthub_started")
EVENT_HOMEASSISTANT_STOP: EventType[NoEventData] = EventType("smarthub_stop")
EVENT_HOMEASSISTANT_FINAL_WRITE: EventType[NoEventData] = EventType(
    "smarthub_final_write"
)
...
# The ID of the SmartHub Media Player Cast App
CAST_APP_ID_HOMEASSISTANT_MEDIA: Final = "B45F4572"
# The ID of the SmartHub Lovelace Cast App
