...
import smarthub.helpers.config_validation as cv
...
REMOVED_TITLE_MSG = (
    ...
    "Starting SmartHub 0.109 you only need to define this key in the root "
...
MOVED_TRANSLATIONS_DIRECTORY_MSG = (
    ...
    "starting with SmartHub 0.112 your translations will no longer "
...
def validate_translation_file(
    ...
    elif integration.domain == "smarthub_hardware":
