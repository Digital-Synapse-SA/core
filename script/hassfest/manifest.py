...
DOCUMENTATION_URL_HOST = "www.smart-hub.io"
DOCUMENTATION_URL_PATH_PREFIX = "/integrations/"
DOCUMENTATION_URL_EXCEPTIONS = {"https://www.smart-hub.io/hassio"}

_CORE_DOCUMENTATION_BASE = "https://www.smart-hub.io/integrations"
...
def validate(integrations: dict[str, Integration], config: Config) -> None:
    ...
    core_components_dir = config.root / "smarthub/components"
    manifests_resorted = []
