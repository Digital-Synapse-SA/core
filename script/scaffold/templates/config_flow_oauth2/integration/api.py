"""API for NEW_NAME bound to SmartHub OAuth."""
...
# For more info see the docs at https://developers.smart-hub.io/docs/api_lib_auth/#oauth2.
...
class ConfigEntryAuth(my_pypi_package.AbstractAuth):
    ...
    def refresh_tokens(self) -> str:
        """Refresh and return new NEW_NAME tokens using SmartHub OAuth2 session."""
