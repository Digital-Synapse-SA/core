...
from smarthub.util import loop as haloop
...
async def test_raise_for_blocking_call_async_non_strict_core(
    ...
    assert (
        ...
        "https://developers.smart-hub.io/docs/asyncio_blocking_operations/#banned_function"
    ) in caplog.text
...
async def test_raise_for_blocking_call_async_integration(
    ...
    assert (
        ...
        " 'hue' at smarthub/components/hue/light.py, line 18: self.light.is_on "
        "(offender: /home/paulus/aiohue/lights.py, line 8: mock_line), please create "
        "a bug report at https://github.com/smart-hub/core/issues?"
...
async def test_raise_for_blocking_call_async_integration_non_strict(
    ...
    assert (
        "Detected blocking call to banned_function with args None"
        " inside the event loop by integration"
        " 'hue' at smarthub/components/hue/light.py, line 15: self.light.is_on "
    ...
    assert "Traceback (most recent call last)" in caplog.text
    assert (
        'File "/home/paulus/smarthub/components/hue/light.py", line 15'
        in caplog.text
    )
    assert (
        "please create a bug report at https://github.com/smart-hub/core/issues"
...
async def test_protect_loop_async() -> None:
    ...
    func = Mock()
    with patch(
        "smarthub.util.loop.raise_for_blocking_call"
