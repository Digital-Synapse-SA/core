...
from smarthub.components.climate import PRESET_COMFORT, PRESET_SLEEP
from smarthub.components.vicare.fan import VentilationMode
from smarthub.components.vicare.types import HeatingProgram
