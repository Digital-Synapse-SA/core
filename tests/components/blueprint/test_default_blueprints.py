...
from smarthub.components.blueprint import BLUEPRINT_SCHEMA, models
from smarthub.components.blueprint.const import BLUEPRINT_FOLDER
...
def test_default_blueprints(domain: str) -> None:
    ...
    integration = importlib.import_module(f"smarthub.components.{domain}")
