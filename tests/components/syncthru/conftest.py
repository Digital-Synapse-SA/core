...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.syncthru.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def mock_syncthru() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.syncthru.coordinator.SyncThru",
            autospec=True,
        ) as mock_syncthru,
        patch(
            "smarthub.components.syncthru.config_flow.SyncThru", new=mock_syncthru
        ),
    ):
