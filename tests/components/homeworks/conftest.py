...
def mock_homeworks() -> Generator[MagicMock]:
    ...
    with (
        patch(
            "smarthub.components.homeworks.Homeworks", autospec=True
        ) as homeworks_mock,
        patch(
            "smarthub.components.homeworks.config_flow.Homeworks",
            new=homeworks_mock,
        ),
    ):
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.homeworks.async_setup_entry", return_value=True
    ) as mock_setup_entry:
