...
from smarthub.components import threshold
from smarthub.components.threshold.config_flow import ConfigFlowHandler
...
async def test_async_handle_source_entity_changes_source_entity_removed(
    ...
    # source sensor
    with patch(
        "smarthub.components.threshold.async_unload_entry",
