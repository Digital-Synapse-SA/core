...
from smarthub.components.wemo.coordinator import Options
...
async def test_not_discovered(hass: SmartHub) -> None:
    ...
    with patch("smarthub.components.wemo.config_flow.pywemo") as mock_pywemo:
...
async def test_invalid_options(hass: SmartHub) -> None:
