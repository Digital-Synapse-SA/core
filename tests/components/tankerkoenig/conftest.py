...
def mock_tankerkoenig() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.tankerkoenig.coordinator.Tankerkoenig",
            autospec=True,
        ) as mock_tankerkoenig,
        patch(
            "smarthub.components.tankerkoenig.config_flow.Tankerkoenig",
...
async def mock_setup_integration(
    hass: SmartHub, config_entry: MockConfigEntry, tankerkoenig: AsyncMock
) -> None:
