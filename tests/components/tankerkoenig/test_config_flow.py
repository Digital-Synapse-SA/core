...
from smarthub.components.tankerkoenig.const import CONF_STATIONS, DOMAIN
...
async def test_user(hass: SmartHub) -> None:
    ...
    with (
        patch(
            "smarthub.components.tankerkoenig.async_setup_entry", return_value=True
        ) as mock_setup_entry,
        patch(
            "smarthub.components.tankerkoenig.config_flow.Tankerkoenig.nearby_stations",
...
async def test_exception_security(hass: SmartHub) -> None:
...
async def test_options_flow(hass: SmartHub, tankerkoenig: AsyncMock) -> None:
    """Test options flow."""
...
async def test_options_flow_error(hass: SmartHub) -> None:
    """Test options flow."""
