...
from smarthub.components import statistics
from smarthub.components.statistics import DOMAIN
from smarthub.components.statistics.config_flow import StatisticsConfigFlowHandler
...
async def test_async_handle_source_entity_changes_source_entity_removed(
    ...
    # source sensor
    with patch(
        "smarthub.components.statistics.async_unload_entry",
