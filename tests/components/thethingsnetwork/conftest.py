...
from smarthub.components.thethingsnetwork.const import (
    CONF_APP_ID,
    DOMAIN,
    TTN_API_HOST,
)
...
def mock_ttnclient():
    ...
    with (
        patch(
            "smarthub.components.thethingsnetwork.coordinator.TTNClient",
            autospec=True,
        ) as ttn_client,
        patch(
            "smarthub.components.thethingsnetwork.config_flow.TTNClient",
            new=ttn_client,
        ),
    ):
