...
def mock_motion_device(
    ...
    with patch(
        "smarthub.components.motionblinds_ble.MotionDevice",
        autospec=True,
    ) as mock_device:
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.motionblinds_ble.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def motionblinds_ble_connect(
    ...
    with (
        ...
        patch(
            "smarthub.components.motionblinds_ble.config_flow.bluetooth.async_get_scanner",
