...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.igloohome.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
async def mock_auth() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.igloohome.config_flow.IgloohomeAuth.async_get_access_token",
...
def mock_api() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.igloohome.IgloohomeApi",
            autospec=True,
        ) as api_mock,
    ):
