...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.iron_os.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_async_discovered_service_info() -> Generator[MagicMock]:
    ...
    with patch(
        "smarthub.components.iron_os.config_flow.async_discovered_service_info",
...
def mock_ironosupdate() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.iron_os.IronOSUpdate",
        autospec=True,
    ) as mock_client:
...
def mock_pynecil() -> Generator[AsyncMock]:
    ...
    with (
        patch("smarthub.components.iron_os.Pynecil", autospec=True) as mock_client,
        patch("smarthub.components.iron_os.config_flow.Pynecil", new=mock_client),
    ):
        client = mock_client.return_value
