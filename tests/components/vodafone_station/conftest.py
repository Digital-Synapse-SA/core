...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.vodafone_station.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def mock_vodafone_station_router() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.vodafone_station.coordinator.VodafoneStationSercommApi",
            autospec=True,
        ) as mock_router,
        patch(
            "smarthub.components.vodafone_station.config_flow.VodafoneStationSercommApi",
            new=mock_router,
        ),
    ):
