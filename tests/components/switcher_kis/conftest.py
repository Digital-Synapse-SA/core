...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.switcher_kis.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_bridge(request: pytest.FixtureRequest) -> Generator[MagicMock]:
    ...
    with (
        patch(
            "smarthub.components.switcher_kis.SwitcherBridge", autospec=True
        ) as bridge_mock,
        patch(
            "smarthub.components.switcher_kis.utils.SwitcherBridge",
            new=bridge_mock,
        ),
    ):
...
def mock_api():
    ...
    patchers = [
        patch(
            "smarthub.components.switcher_kis.entity.SwitcherApi.connect",
            new=api_mock,
        ),
        patch(
            "smarthub.components.switcher_kis.entity.SwitcherApi.disconnect",
            new=api_mock,
        ),
    ]
