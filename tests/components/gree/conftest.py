...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.gree.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def discovery_fixture():
    ...
    with patch("smarthub.components.gree.coordinator.Discovery") as mock:
...
def device_fixture():
    ...
    with patch(
        "smarthub.components.gree.coordinator.Device",
