...
from smarthub.components import mythicbeastsdns
...
@patch("mbddns.update", new=mbddns_update_mock)
async def test_update_fails_if_wrong_token(hass: SmartHub) -> None:
...
@patch("mbddns.update", new=mbddns_update_mock)
async def test_update_fails_if_invalid_host(hass: SmartHub) -> None:
