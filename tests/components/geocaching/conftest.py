...
from smarthub.components.geocaching.const import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.geocaching.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
...
def mock_geocaching_config_flow() -> Generator[MagicMock]:
    ...
    with patch(
        "smarthub.components.geocaching.config_flow.GeocachingApi", autospec=True
    ) as geocaching_mock:
