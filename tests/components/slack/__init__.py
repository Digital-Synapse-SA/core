...
from smarthub.components.slack.const import CONF_DEFAULT_CHANNEL, DOMAIN
...
def create_entry(hass: SmartHub) -> ConfigEntry:
...
async def async_init_integration(
    ...
    """Set up the Slack integration in SmartHub."""
