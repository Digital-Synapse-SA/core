...
GATEWAY_IMPORT_PATH = "smarthub.components.screenlogic.ScreenLogicGateway"
GATEWAY_DISCOVERY_IMPORT_PATH = "smarthub.components.screenlogic.coordinator.async_discover_gateways_by_unique_id"
