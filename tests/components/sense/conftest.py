...
from smarthub.components.sense.binary_sensor import SenseDevice
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.sense.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_sense() -> Generator[MagicMock]:
    ...
    with patch("smarthub.components.sense.ASyncSenseable", autospec=True) as mock:
