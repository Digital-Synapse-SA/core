...
from smarthub.components.geniushub.const import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.geniushub.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def mock_geniushub_client() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.geniushub.config_flow.GeniusService",
        autospec=True,
    ) as mock_client:
...
def mock_geniushub_cloud(
    ...
    """Mock a GeniusHub."""
    with patch(
        "smarthub.components.geniushub.GeniusHub",
        autospec=True,
    ) as mock_client:
        client = mock_client.return_value
