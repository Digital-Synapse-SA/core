...
def mock_get_state():
    ...
    with patch(
        "smarthub.components.tessie.coordinator.get_state",
...
def mock_get_status():
    ...
    with patch(
        "smarthub.components.tessie.coordinator.get_status",
...
def mock_get_state_of_all_vehicles():
    ...
    with patch(
        "smarthub.components.tessie.get_state_of_all_vehicles",
...
def mock_scopes():
    ...
    with patch(
        "smarthub.components.tessie.Tessie.scopes",
        return_value=SCOPES,
    ) as mock_scopes:
        yield mock_scopes
...
def mock_products():
    ...
    with patch(
        "smarthub.components.tessie.Tessie.products", return_value=PRODUCTS
    ) as mock_products:
        yield mock_products
...
def mock_request():
    ...
    with patch(
        "smarthub.components.tessie.Tessie._request",
