...
from smarthub.components.google_wifi import sensor as google_wifi
...
def setup_api(
    hass: SmartHub | None, data: str | None, requests_mock: requests_mock.Mocker
...
def fake_delay(hass: SmartHub, ha_delay: int) -> None:
...
def test_name(hass: SmartHub, requests_mock: requests_mock.Mocker) -> None:
    """Test the name."""
...
def test_state(hass: SmartHub, requests_mock: requests_mock.Mocker) -> None:
