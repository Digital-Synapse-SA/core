...
from smarthub.components import device_tracker, zone
from smarthub.components.device_tracker import SourceType, const, legacy
...
def mock_yaml_devices(hass: SmartHub) -> Generator[str]:
...
def _mock_legacy_device_tracker_setup(
    hass: SmartHub, mock_legacy_device_scanner: MockScanner
) -> None:
...
async def test_reading_broken_yaml_config(hass: SmartHub) -> None:
...
async def test_reading_yaml_config(hass: SmartHub, yaml_devices: str) -> None:
...
@patch("smarthub.components.device_tracker.const.LOGGER.warning")
async def test_duplicate_mac_dev_id(mock_warning, hass: SmartHub) -> None:
...
async def test_setup_without_yaml_file(hass: SmartHub, yaml_devices: str) -> None:
...
async def test_gravatar(hass: SmartHub) -> None:
...
async def test_gravatar_and_picture(hass: SmartHub) -> None:
...
@patch("smarthub.components.device_tracker.legacy.DeviceTracker.see")
@patch("smarthub.components.demo.device_tracker.setup_scanner", autospec=True)
async def test_discover_platform(
    mock_demo_setup_scanner, mock_see, hass: SmartHub
) -> None:
...
async def test_update_stale(
    ...
    with (
        patch(
            "smarthub.components.device_tracker.legacy.dt_util.utcnow",
...
@patch("smarthub.components.device_tracker.legacy.DeviceTracker.async_see")
async def test_see_service(mock_see, hass: SmartHub) -> None:
...
async def test_see_state(hass: SmartHub, yaml_devices: str) -> None:
...
async def test_see_failures(
    mock_warning, hass: SmartHub, mock_device_tracker_conf: list[legacy.Device]
) -> None:
...
async def test_async_added_to_hass(hass: SmartHub) -> None:
...
async def test_bad_platform(hass: SmartHub) -> None:
    """Test bad platform."""
...
async def test_picture_and_icon_on_see_discovery(
    mock_device_tracker_conf: list[legacy.Device], hass: SmartHub
) -> None:
