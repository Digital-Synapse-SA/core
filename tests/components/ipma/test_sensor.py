...
async def test_ipma_fire_risk_create_sensors(hass: SmartHub) -> None:
...
async def test_ipma_uv_index_create_sensors(hass: SmartHub) -> None:
...
async def test_ipma_warning_create_sensors(hass: SmartHub) -> None:
