...
PATCH_SETUP_ENTRY = patch(
    "smarthub.components.androidtv.async_setup_entry",
    return_value=True,
)
PATCH_ACCESS = patch("smarthub.components.androidtv.os.access", return_value=True)
PATCH_ISFILE = patch("smarthub.components.androidtv.os.path.isfile", isfile)
