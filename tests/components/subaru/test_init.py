...
async def test_setup_ev(hass: SmartHub, ev_entry) -> None:
...
async def test_setup_g3(hass: SmartHub, subaru_config_entry) -> None:
...
async def test_setup_g1(hass: SmartHub, subaru_config_entry) -> None:
...
async def test_unsuccessful_connect(hass: SmartHub, subaru_config_entry) -> None:
...
async def test_invalid_credentials(hass: SmartHub, subaru_config_entry) -> None:
...
async def test_update_skip_unsubscribed(
    hass: SmartHub, subaru_config_entry
) -> None:
...
async def test_update_disabled(hass: SmartHub, ev_entry) -> None:
...
async def test_fetch_failed(hass: SmartHub, subaru_config_entry) -> None:
...
async def test_unload_entry(hass: SmartHub, ev_entry) -> None:
