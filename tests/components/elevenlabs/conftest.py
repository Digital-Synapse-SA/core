...
from smarthub.components.elevenlabs.const import CONF_MODEL, CONF_VOICE
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.elevenlabs.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_async_client() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.elevenlabs.AsyncElevenLabs",
            return_value=_client_mock(),
        ) as mock_async_client,
        patch(
            "smarthub.components.elevenlabs.config_flow.AsyncElevenLabs",
