...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.plugwise.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
...
def mock_smile_config_flow() -> Generator[MagicMock]:
    ...
    with patch(
        "smarthub.components.plugwise.config_flow.Smile",
        autospec=True,
    ) as smile_mock:
...
def mock_smile_adam() -> Generator[MagicMock]:
    ...
    with (
        patch(
            "smarthub.components.plugwise.coordinator.Smile", autospec=True
        ) as smile_mock,
        patch(
            "smarthub.components.plugwise.config_flow.Smile",
            new=smile_mock,
