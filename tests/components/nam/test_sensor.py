...
from smarthub.components.nam.const import DEFAULT_UPDATE_INTERVAL, DOMAIN
...
async def test_sensor(
    ...
    with patch("smarthub.components.nam.PLATFORMS", [Platform.SENSOR]):
...
async def test_incompleta_data_after_device_restart(hass: SmartHub) -> None:
...
async def test_availability(
    hass: SmartHub, freezer: FrozenDateTimeFactory, exc: Exception
) -> None:
