...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.israel_rail.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_israelrail() -> AsyncMock:
    ...
    with (
        patch(
            "smarthub.components.israel_rail.TrainSchedule",
            autospec=True,
        ) as mock_client,
        patch(
            "smarthub.components.israel_rail.config_flow.TrainSchedule",
            new=mock_client,
        ),
    ):
