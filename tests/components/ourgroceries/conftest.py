...
from smarthub.components.ourgroceries import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.ourgroceries.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
async def mock_setup_integration(
    ...
    with patch(
        "smarthub.components.ourgroceries.OurGroceries", return_value=ourgroceries
    ):
