...
def vizio_get_unique_id_fixture() -> Generator[None]:
    ...
    with patch(
        "smarthub.components.vizio.config_flow.VizioAsync.get_unique_id",
...
def vizio_connect_fixture() -> Generator[None]:
    ...
    with patch(
        "smarthub.components.vizio.config_flow.VizioAsync.validate_ha_config",
...
def vizio_complete_pairing_fixture() -> Generator[None]:
    ...
    with (
        patch(
            "smarthub.components.vizio.config_flow.VizioAsync.start_pair",
            return_value=MockStartPairingResponse(CH_TYPE, RESPONSE_TOKEN),
        ),
        patch(
            "smarthub.components.vizio.config_flow.VizioAsync.pair",
...
def vizio_bypass_setup_fixture() -> Generator[None]:
    ...
    with patch("smarthub.components.vizio.async_setup_entry", return_value=True):
        yield
...
def vizio_bypass_update_fixture() -> Generator[None]:
    ...
    with (
        patch(
            "smarthub.components.vizio.media_player.VizioAsync.can_connect_with_auth_check",
            return_value=True,
        ),
        patch("smarthub.components.vizio.media_player.VizioDevice.async_update"),
    ):
        yield
...
def vizio_guess_device_type_fixture() -> Generator[None]:
    ...
    with patch(
        "smarthub.components.vizio.config_flow.async_guess_device_type",
...
def vizio_update_fixture() -> Generator[None]:
    ...
    with (
        ...
        patch(
            "smarthub.components.vizio.media_player.VizioAsync.get_current_input",
            return_value=CURRENT_INPUT,
        ),
        patch(
            "smarthub.components.vizio.media_player.VizioAsync.get_inputs_list",
        ...
        patch(
            "smarthub.components.vizio.media_player.VizioAsync.get_model_name",
            return_value=MODEL,
        ),
        patch(
            "smarthub.components.vizio.media_player.VizioAsync.get_version",
...
def vizio_hostname_check() -> Generator[None]:
    ...
    with patch(
        "smarthub.components.vizio.config_flow.socket.gethostbyname",
