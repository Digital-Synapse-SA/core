...
from smarthub.components.enigma2.const import (
    CONF_DEEP_STANDBY,
    CONF_SOURCE_BOUQUET,
...
def openwebif_device_mock() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.enigma2.coordinator.OpenWebIfDevice",
            spec=OpenWebIfDevice,
        ) as openwebif_device_mock,
        patch(
            "smarthub.components.enigma2.config_flow.OpenWebIfDevice",
