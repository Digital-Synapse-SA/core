...
def fixture_mock_auth_api():
    ...
    with (
        mock.patch(
            "smarthub.components.whirlpool.Auth", spec=auth.Auth
        ) as mock_auth,
        mock.patch(
            "smarthub.components.whirlpool.config_flow.Auth", new=mock_auth
        ),
    ):
...
def fixture_mock_appliances_manager_api(
    ...
    with (
        mock.patch(
            "smarthub.components.whirlpool.AppliancesManager",
            spec=appliancesmanager.AppliancesManager,
        ) as mock_appliances_manager,
        mock.patch(
            "smarthub.components.whirlpool.config_flow.AppliancesManager",
...
def fixture_mock_backend_selector_api():
    ...
    with (
        mock.patch(
            "smarthub.components.whirlpool.BackendSelector"
        ) as mock_backend_selector,
        mock.patch(
            "smarthub.components.whirlpool.config_flow.BackendSelector",
