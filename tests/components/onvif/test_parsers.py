...
from smarthub.components.onvif import models, parsers
...
async def test_line_detector_crossed(hass: SmartHub) -> None:
...
async def test_tapo_line_crossed(hass: SmartHub) -> None:
...
async def test_tapo_tpsmartevent_vehicle(hass: SmartHub) -> None:
...
async def test_tapo_cellmotiondetector_vehicle(hass: SmartHub) -> None:
...
async def test_tapo_tpsmartevent_person(hass: SmartHub) -> None:
...
async def test_tapo_tpsmartevent_pet(hass: SmartHub) -> None:
...
async def test_tapo_cellmotiondetector_person(hass: SmartHub) -> None:
...
async def test_tapo_tamper(hass: SmartHub) -> None:
...
async def test_tapo_intrusion(hass: SmartHub) -> None:
...
async def test_tapo_missing_attributes(hass: SmartHub) -> None:
...
async def test_tapo_unknown_type(hass: SmartHub) -> None:
...
async def test_reolink_package(hass: SmartHub) -> None:
...
async def test_hikvision_alarm(hass: SmartHub) -> None:
