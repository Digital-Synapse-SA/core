...
from smarthub.components.onvif import config_flow
from smarthub.components.onvif.const import CONF_SNAPSHOT_AUTH
from smarthub.components.onvif.models import (
    Capabilities,
    DeviceInfo,
    Profile,
...
from smarthub.const import HTTP_DIGEST_AUTHENTICATION
...
def setup_mock_device(mock_device, capabilities=None, profiles=None):
    ...
    def mock_constructor(
        hass: SmartHub, config: config_entries.ConfigEntry
    ) -> MagicMock:
        """Fake the controller constructor."""
        return mock_device
