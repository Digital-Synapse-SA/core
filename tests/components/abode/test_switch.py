...
from smarthub.components.abode.services import SERVICE_TRIGGER_AUTOMATION
...
async def test_automation_attributes(hass: SmartHub) -> None:
...
async def test_turn_automation_off(hass: SmartHub) -> None:
...
async def test_turn_automation_on(hass: SmartHub) -> None:
...
async def test_trigger_automation(hass: SmartHub) -> None:
