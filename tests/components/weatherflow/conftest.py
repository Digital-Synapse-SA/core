...
from smarthub.components.weatherflow.const import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.weatherflow.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
...
def mock_stop() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.weatherflow.config_flow.WeatherFlowListener.stop_listening",
        autospec=True,
...
def mock_start() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.weatherflow.config_flow.WeatherFlowListener.start_listening",
        autospec=True,
