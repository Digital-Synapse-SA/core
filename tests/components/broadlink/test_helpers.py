...
from smarthub.components.broadlink.helpers import data_packet, mac_address
from smarthub.core import SmartHub


async def test_padding(hass: SmartHub) -> None:
...
async def test_valid_mac_address(hass: SmartHub) -> None:
...
async def test_invalid_mac_address(hass: SmartHub) -> None:
