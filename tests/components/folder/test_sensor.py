...
from smarthub.components.folder.sensor import CONF_FOLDER_PATHS
...
async def test_invalid_path(hass: SmartHub) -> None:
...
async def test_valid_path(hass: SmartHub) -> None:
