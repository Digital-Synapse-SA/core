...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.bosch_alarm.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def mock_panel(
    ...
    with (
        patch(
            "smarthub.components.bosch_alarm.Panel", autospec=True
        ) as mock_panel,
        patch("smarthub.components.bosch_alarm.config_flow.Panel", new=mock_panel),
    ):
