...
from smarthub.components.hue.const import ATTR_HUE_EVENT
from smarthub.components.hue.v1 import sensor_base
...
async def test_no_sensors(hass: SmartHub, mock_bridge_v1: Mock) -> None:
...
async def test_unsupported_sensors(hass: SmartHub, mock_bridge_v1: Mock) -> None:
...
async def test_new_sensor_discovered(hass: SmartHub, mock_bridge_v1: Mock) -> None:
...
async def test_sensor_removed(hass: SmartHub, mock_bridge_v1: Mock) -> None:
