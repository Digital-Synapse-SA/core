...
async def test_flow_works(hass: SmartHub, simple_mock_home) -> None:
    """Test config flow."""

    with (
        patch(
            "smarthub.components.homematicip_cloud.hap.HomematicipAuth.async_checkbutton",
            return_value=False,
        ),
        patch(
            "smarthub.components.homematicip_cloud.hap.HomematicipAuth.get_auth",
            return_value=True,
        ),
    ):
    ...
    with (
        ...
        patch(
            "smarthub.components.homematicip_cloud.hap.HomematicipAuth.async_setup",
            return_value=True,
        ),
        patch(
            "smarthub.components.homematicip_cloud.hap.HomematicipAuth.async_register",
            return_value=True,
        ),
        patch(
            "smarthub.components.homematicip_cloud.hap.HomematicipHAP.async_connect",
        ),
    ):
...
async def test_flow_init_connection_error(hass: SmartHub) -> None:
...
async def test_flow_link_connection_error(hass: SmartHub) -> None:
...
async def test_flow_link_press_button(hass: SmartHub) -> None:
...
async def test_init_flow_show_form(hass: SmartHub) -> None:
...
async def test_init_already_configured(hass: SmartHub) -> None:
...
async def test_import_config(hass: SmartHub, simple_mock_home) -> None:
...
async def test_import_existing_config(hass: SmartHub) -> None:
