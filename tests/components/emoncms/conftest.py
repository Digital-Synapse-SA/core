...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.emoncms.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
async def emoncms_client() -> AsyncGenerator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.emoncms.EmoncmsClient", autospec=True
        ) as mock_client,
        patch(
            "smarthub.components.emoncms.config_flow.EmoncmsClient",
            new=mock_client,
        ),
    ):
