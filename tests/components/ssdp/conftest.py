...
async def silent_ssdp_listener():
    ...
    with (
        patch("smarthub.components.ssdp.scanner.SsdpListener.async_start"),
        patch("smarthub.components.ssdp.scanner.SsdpListener.async_stop"),
        patch("smarthub.components.ssdp.scanner.SsdpListener.async_search"),
    ):
...
async def disabled_upnp_server():
    """Disable UPnpServer."""
    with (
        patch("smarthub.components.ssdp.server.UpnpServer.async_start"),
        patch("smarthub.components.ssdp.server.UpnpServer.async_stop"),
        patch("smarthub.components.ssdp.server._async_find_next_available_port"),
    ):
        yield UpnpServer
