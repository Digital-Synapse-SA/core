...
from smarthub.components.knx.const import CONF_STATE_ADDRESS, KNX_ADDRESS, Platform
from smarthub.components.knx.schema import LightSchema
...
from smarthub.const import CONF_NAME, STATE_OFF, STATE_ON, EntityCategory
...
async def test_light_simple(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_brightness(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_color_temp_absolute(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_color_temp_relative(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_hs_color(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_xyy_color(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_rgb_individual(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_rgb(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_rgbw(hass: SmartHub, knx: KNXTestKit) -> None:
...
async def test_light_rgbw_brightness(hass: SmartHub, knx: KNXTestKit) -> None:
