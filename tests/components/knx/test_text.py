...
from smarthub.components.knx.schema import TextSchema
...
async def test_text(hass: SmartHub, knx: KNXTestKit) -> None:
    """Test KNX text."""
    test_address = "1/1/1"
...
async def test_text_restore_and_respond(hass: SmartHub, knx: KNXTestKit) -> None:
