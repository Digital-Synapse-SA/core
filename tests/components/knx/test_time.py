...
from smarthub.components.knx.schema import TimeSchema
...
async def test_time(hass: SmartHub, knx: KNXTestKit) -> None:
    """Test KNX time."""
    test_address = "1/1/1"
...
async def test_time_restore_and_respond(hass: SmartHub, knx: KNXTestKit) -> None:
