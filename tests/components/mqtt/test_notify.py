...
from smarthub.components import mqtt, notify
from smarthub.components.notify import ATTR_MESSAGE
from smarthub.const import ATTR_ENTITY_ID, ATTR_FRIENDLY_NAME, STATE_UNKNOWN
...
async def test_discovery_update_unchanged_notify(
    ...
    with patch(
        "smarthub.components.mqtt.notify.MqttNotify.discovery_update"
    ) as discovery_update:
