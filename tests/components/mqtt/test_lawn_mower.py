...
from smarthub.components import lawn_mower, mqtt
...
from smarthub.components.mqtt.lawn_mower import MQTT_LAWN_MOWER_ATTRIBUTES_BLOCKED
...
async def test_discovery_update_unchanged_lawn_mower(
    ...
    with patch(
        "smarthub.components.mqtt.lawn_mower.MqttLawnMower.discovery_update"
    ) as discovery_update:
