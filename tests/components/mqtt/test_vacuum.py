...
from smarthub.components import mqtt, vacuum
from smarthub.components.mqtt import vacuum as mqttvacuum
from smarthub.components.mqtt.const import CONF_COMMAND_TOPIC, CONF_STATE_TOPIC
from smarthub.components.mqtt.vacuum import (
    ALL_SERVICES,
...
from smarthub.const import CONF_NAME, ENTITY_MATCH_ALL, STATE_UNKNOWN
...
async def test_discovery_update_unchanged_vacuum(
    ...
    with patch(
        "smarthub.components.mqtt.vacuum.MqttStateVacuum.discovery_update"
    ) as discovery_update:
