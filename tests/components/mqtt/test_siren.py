...
from smarthub.components import mqtt, siren
from smarthub.components.siren import ATTR_VOLUME_LEVEL
...
async def async_turn_on(
    hass: SmartHub, entity_id: str, parameters: dict[str, Any]
) -> None:
...
async def test_discovery_update_unchanged_siren(
    ...
    with patch(
        "smarthub.components.mqtt.siren.MqttSiren.discovery_update"
    ) as discovery_update:
