...
async def anova_api(
    ...
    with (
        patch("smarthub.components.anova.AnovaApi", return_value=api_mock),
        patch(
            "smarthub.components.anova.config_flow.AnovaApi", return_value=api_mock
        ),
    ):
        api = AnovaApi(
            None,
...
async def anova_api_wrong_login(
    ...
    with patch("smarthub.components.anova.AnovaApi", return_value=api_mock):
        api = AnovaApi(
            None,
            "sample@gmail.com",
            "sample",
