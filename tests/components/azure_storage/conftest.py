...
from smarthub.components.azure_storage.const import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.azure_storage.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
...
def mock_client() -> Generator[MagicMock]:
    ...
    with (
        patch(
            "smarthub.components.azure_storage.config_flow.ContainerClient",
            autospec=True,
        ) as container_client,
        patch(
            "smarthub.components.azure_storage.ContainerClient",
