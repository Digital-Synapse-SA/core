...
def mock_setup_notify_platform() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.helpers.discovery.async_load_platform",
...
def mock_version() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.system_bridge.Version",
        autospec=True,
    ) as mock_version:
...
def mock_websocket_client(
    ...
    with (
        patch(
            "smarthub.components.system_bridge.coordinator.WebSocketClient",
            autospec=True,
        ) as mock_websocket_client,
        patch(
            "smarthub.components.system_bridge.config_flow.WebSocketClient",
