...
from smarthub.const import CONF_ACCESS_TOKEN, CONF_HOST, STATE_UNAVAILABLE
...
def patch_setup_entry(domain: str, *, enabled: bool = True):
    ...
    return patch(f"smarthub.components.bond.{domain}.async_setup_entry")
...
async def setup_platform(
    ...
    *,
    ...
    with (
        patch("smarthub.components.bond.PLATFORMS", [platform]),
...
def patch_bond_version(
    ...
    return patch(
        "smarthub.components.bond.Bond.version",
...
def patch_bond_bridge(
    ...
    return patch(
        "smarthub.components.bond.Bond.bridge",
        return_value=return_value,
        side_effect=side_effect,
    )
...
def patch_bond_token(
    ...
    return patch(
        "smarthub.components.bond.Bond.token",
        return_value=return_value,
        side_effect=side_effect,
    )
...
def patch_bond_device_ids(enabled: bool = True, return_value=None, side_effect=None):
    ...
    return patch(
        "smarthub.components.bond.Bond.devices",
        return_value=return_value,
        side_effect=side_effect,
    )
...
def patch_bond_device(return_value=None):
    ...
    return patch(
        "smarthub.components.bond.Bond.device",
        return_value=return_value,
    )
...
def patch_start_bpup():
    """Patch start_bpup."""
    return patch(
        "smarthub.components.bond.start_bpup",
...
def patch_bond_device_properties(return_value=None):
    ...
    return patch(
        "smarthub.components.bond.Bond.device_properties",
        return_value=return_value,
    )
...
def patch_bond_device_state(return_value=None, side_effect=None):
    ...
    return patch(
        "smarthub.components.bond.Bond.device_state",
        return_value=return_value,
        side_effect=side_effect,
    )
...
async def help_test_entity_available(
    hass: core.SmartHub, domain: str, device: dict[str, Any], entity_id: str
):
