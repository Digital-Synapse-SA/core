...
async def test_open_cover(hass: SmartHub) -> None:
...
async def test_close_cover(hass: SmartHub) -> None:
...
async def test_stop_cover(hass: SmartHub) -> None:
...
async def test_tilt_open_cover(hass: SmartHub) -> None:
...
async def test_tilt_close_cover(hass: SmartHub) -> None:
...
async def test_tilt_stop_cover(hass: SmartHub) -> None:
...
async def test_tilt_and_open(hass: SmartHub) -> None:
...
async def test_update_reports_open_cover(hass: SmartHub) -> None:
...
async def test_update_reports_closed_cover(hass: SmartHub) -> None:
...
async def test_cover_available(hass: SmartHub) -> None:
...
async def test_set_position_cover(hass: SmartHub) -> None:
