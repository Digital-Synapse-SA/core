...
from smarthub.components.dlna_dmr.data import DlnaDmrData
...
@pytest.fixture
def domain_data_mock(hass: SmartHub) -> Mock:
...
def async_get_local_ip_mock() -> Generator[Mock]:
    ...
    with patch(
        "smarthub.components.dlna_dmr.media_player.async_get_local_ip",
        autospec=True,
    ) as func:
