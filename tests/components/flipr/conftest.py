...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.flipr.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_flipr_client() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.flipr.FliprAPIRestClient",
            autospec=True,
        ) as mock_client,
        patch(
            "smarthub.components.flipr.config_flow.FliprAPIRestClient",
            new=mock_client,
        ),
    ):
