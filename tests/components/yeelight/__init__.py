...
from smarthub.components.yeelight import (
    CONF_MODE_MUSIC,
...
from smarthub.const import CONF_DEVICES, CONF_ID, CONF_NAME
...
MODULE = "smarthub.components.yeelight"
...
def _patch_discovery(no_device=False, capabilities=None):
    ...
    return patch(
        "smarthub.components.yeelight.scanner.SsdpSearchListener",
