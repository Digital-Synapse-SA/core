...
from smarthub.components.tplink import DOMAIN
...
def mock_discovery():
    ...
    with patch.multiple(
        "smarthub.components.tplink.Discover",
        discover=DEFAULT,
...
def mock_connect():
    ...
    with patch("smarthub.components.tplink.Device.connect") as mock_connect:
        devices = _get_mock_devices()
