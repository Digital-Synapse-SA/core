...
from smarthub.components.group import (
    ATTR_ADD_ENTITIES,
    ATTR_ENTITIES,
    ATTR_OBJECT_ID,
    DOMAIN,
...
from smarthub.const import ATTR_ICON, ATTR_NAME, SERVICE_RELOAD
from smarthub.core import SmartHub, callback
from smarthub.loader import bind_hass


@bind_hass
def reload(hass: SmartHub) -> None:
...
@callback
@bind_hass
def async_reload(hass: SmartHub) -> None:
    """Reload the automation from config."""
...
@callback
@bind_hass
def async_remove(hass: SmartHub, object_id: str) -> None:
    """Remove a user group."""
