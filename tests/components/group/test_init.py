...
from smarthub.components.group.registry import GroupIntegrationRegistry
...
async def help_test_mixed_entity_platforms_on_off_state_test(
    ...
    class MockGroupPlatform1(MockPlatform):
        ...
        def async_describe_on_off_states(
            self, hass: SmartHub, registry: GroupIntegrationRegistry
        ) -> None:
...
async def test_setup_group_with_mixed_groupable_states(hass: SmartHub) -> None:
...
async def test_setup_group_with_a_non_existing_state(hass: SmartHub) -> None:
...
async def test_setup_group_with_non_groupable_states(hass: SmartHub) -> None:
...
async def test_setup_empty_group(hass: SmartHub) -> None:
...
async def test_monitor_group(hass: SmartHub) -> None:
...
async def test_group_turns_off_if_all_off(hass: SmartHub) -> None:
...
async def test_allgroup_turn_on_if_last_turns_on(hass: SmartHub) -> None:
...
async def test_expand_entity_ids(hass: SmartHub) -> None:
...
async def test_expand_entity_ids_recursive(hass: SmartHub) -> None:
...
async def test_expand_entity_ids_ignores_non_strings(hass: SmartHub) -> None:
    """Test that non string elements in lists are ignored."""
    assert group.expand_entity_ids(hass, [5, True]) == []


async def test_get_entity_ids(hass: SmartHub) -> None:
...
async def test_get_entity_ids_with_domain_filter(hass: SmartHub) -> None:
...
async def test_get_entity_ids_with_non_existing_group_name(hass: SmartHub) -> None:
    """Test get_entity_ids with a non existing group."""
    assert group.get_entity_ids(hass, "non_existing") == []


async def test_get_entity_ids_with_non_group_state(hass: SmartHub) -> None:
...
async def test_groups_get_unique_names(hass: SmartHub) -> None:
...
async def test_expand_entity_ids_expands_nested_groups(hass: SmartHub) -> None:
...
async def test_set_assumed_state_based_on_tracked(hass: SmartHub) -> None:
    """Test assumed state."""
    hass.states.async_set("light.Bowl", STATE_ON)
    hass.states.async_set("light.Ceiling", STATE_OFF)
...
async def test_reloading_groups(hass: SmartHub) -> None:
...
async def test_modify_group(hass: SmartHub) -> None:
...
async def test_service_group_services(hass: SmartHub) -> None:
...
async def test_service_group_services_add_remove_entities(hass: SmartHub) -> None:
...
async def test_service_group_set_group_remove_group(hass: SmartHub) -> None:
    """Check if service are available."""
    with assert_setup_component(0, "group"):
        await async_setup_component(hass, "group", {"group": {}})
...
async def test_group_order(hass: SmartHub) -> None:
...
async def test_group_order_with_dynamic_creation(hass: SmartHub) -> None:
    """Test that order gets incremented when creating a new group."""
    hass.states.async_set("light.bowl", STATE_ON)
...
async def test_group_persons(hass: SmartHub) -> None:
...
async def test_group_persons_and_device_trackers(hass: SmartHub) -> None:
...
async def test_group_mixed_domains_on(hass: SmartHub) -> None:
...
async def test_group_mixed_domains_off(hass: SmartHub) -> None:
...
async def test_group_locks(hass: SmartHub, states, group_state) -> None:
    """Test group of locks."""
...
async def test_group_sensors(hass: SmartHub) -> None:
...
async def test_group_climate_mixed(hass: SmartHub) -> None:
...
async def test_group_climate_all_cool(hass: SmartHub) -> None:
...
async def test_group_climate_all_off(hass: SmartHub) -> None:
...
async def test_group_alarm(hass: SmartHub) -> None:
...
async def test_group_alarm_disarmed(hass: SmartHub) -> None:
...
async def test_group_vacuum_off(hass: SmartHub) -> None:
...
async def test_group_vacuum_on(hass: SmartHub) -> None:
    """Test group of vacuums."""
...
async def test_light_removed(hass: SmartHub) -> None:
...
async def test_switch_removed(hass: SmartHub) -> None:
...
async def test_lights_added_after_group(hass: SmartHub) -> None:
...
async def test_lights_added_before_group(hass: SmartHub) -> None:
...
async def test_cover_added_after_group(hass: SmartHub) -> None:
...
async def test_group_that_references_a_group_of_lights(hass: SmartHub) -> None:
...
async def test_group_that_references_a_group_of_covers(hass: SmartHub) -> None:
...
async def test_group_that_references_two_groups_of_covers(hass: SmartHub) -> None:
    """Group that references a group of covers."""
...
async def test_group_that_references_two_types_of_groups(hass: SmartHub) -> None:
...
async def test_plant_group(hass: SmartHub) -> None:
