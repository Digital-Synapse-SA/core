...
from smarthub.components.androidtv_remote.const import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.androidtv_remote.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def mock_unload_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.androidtv_remote.async_unload_entry",
        return_value=True,
...
def mock_api() -> Generator[MagicMock]:
    ...
    with patch(
        "smarthub.components.androidtv_remote.helpers.AndroidTVRemote",
    ) as mock_api_cl:
