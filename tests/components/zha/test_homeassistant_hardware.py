"""Test SmartHub Hardware platform for ZHA."""
...
from smarthub.components.zha.smarthub_hardware import get_firmware_info
...
async def test_get_firmware_info_normal(hass: SmartHub) -> None:
    ...
    # With ZHA running
    with patch(
        "smarthub.components.zha.smarthub_hardware.get_zha_gateway"
...
async def test_get_firmware_info_errors(
    hass: SmartHub, data: dict[str, str | int | None]
) -> None:
