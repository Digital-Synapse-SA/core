...
from smarthub.components.verisure.const import CONF_GIID, DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.verisure.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
...
def mock_verisure_config_flow() -> Generator[MagicMock]:
    ...
    with patch(
        "smarthub.components.verisure.config_flow.Verisure", autospec=True
    ) as verisure_mock:
