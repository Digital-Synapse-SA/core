...
from smarthub.components.webostv.const import LIVE_TV_APP_ID
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.webostv.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def client_fixture():
    ...
    with (
        patch(
            "smarthub.components.webostv.WebOsClient", autospec=True
        ) as mock_client_class,
        patch(
            "smarthub.components.webostv.config_flow.WebOsClient",
