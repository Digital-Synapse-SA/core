...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.aquacell.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_aquacell_api() -> Generator[MagicMock]:
    ...
    with (
        patch(
            "smarthub.components.aquacell.AquacellApi",
            autospec=True,
        ) as mock_client,
        patch(
            "smarthub.components.aquacell.config_flow.AquacellApi",
            new=mock_client,
        ),
    ):
