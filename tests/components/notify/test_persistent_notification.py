...
from smarthub.components.persistent_notification import DOMAIN as PN_DOMAIN
...
async def test_async_send_message(hass: SmartHub) -> None:
...
async def test_async_supports_notification_id(hass: SmartHub) -> None:
