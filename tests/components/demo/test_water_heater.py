...
async def setup_comp(hass: SmartHub, water_heater_only: None):
...
async def test_setup_params(hass: SmartHub) -> None:
...
async def test_set_operation_bad_attr_and_state(hass: SmartHub) -> None:
...
async def test_set_operation(hass: SmartHub) -> None:
...
async def test_set_away_mode_bad_attr(hass: SmartHub) -> None:
...
async def test_set_away_mode_on(hass: SmartHub) -> None:
...
async def test_set_away_mode_off(hass: SmartHub) -> None:
