...
from smarthub.components.filesize.const import DOMAIN, PLATFORMS
from smarthub.const import CONF_FILE_PATH, Platform
...
def mock_setup_entry() -> Generator[None]:
    ...
    with patch(
        "smarthub.components.filesize.async_setup_entry", return_value=True
    ):
        yield
