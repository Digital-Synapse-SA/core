...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.tedee.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
...
def mock_tedee() -> Generator[MagicMock]:
    ...
    with (
        patch(
            "smarthub.components.tedee.coordinator.TedeeClient", autospec=True
        ) as tedee_mock,
        patch(
            "smarthub.components.tedee.config_flow.TedeeClient",
            new=tedee_mock,
        ),
    ):
