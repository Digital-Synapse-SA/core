...
def mock_scan_fixture() -> Generator[AsyncMock]:
    """Mock pyatv.scan."""
    with patch("smarthub.components.apple_tv.config_flow.scan") as mock_scan:
...
def dmap_pin_fixture() -> Generator[MagicMock]:
    """Mock pyatv.scan."""
    with patch("smarthub.components.apple_tv.config_flow.randrange") as mock_pin:
...
def pairing() -> Generator[AsyncMock]:
    """Mock pyatv.scan."""
    with patch("smarthub.components.apple_tv.config_flow.pair") as mock_pair:
