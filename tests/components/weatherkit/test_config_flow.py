...
from smarthub.components.weatherkit.config_flow import (
...
async def test_error_handling(
    hass: SmartHub, exception: Exception, expected_error: str
) -> None:
...
async def test_form_unsupported_location(hass: SmartHub) -> None:
