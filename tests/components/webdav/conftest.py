...
from smarthub.components.webdav.const import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.webdav.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_webdav_client() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.webdav.helpers.Client",
            autospec=True,
