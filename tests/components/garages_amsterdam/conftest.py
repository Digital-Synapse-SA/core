...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.garages_amsterdam.async_setup_entry",
        return_value=True,
    ) as mock_setup_entry:
...
def mock_garages_amsterdam() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "smarthub.components.garages_amsterdam.ODPAmsterdam",
            autospec=True,
        ) as mock_client,
        patch(
            "smarthub.components.garages_amsterdam.config_flow.ODPAmsterdam",
            new=mock_client,
        ),
    ):
