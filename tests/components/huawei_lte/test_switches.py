...
from smarthub.const import ATTR_ENTITY_ID, CONF_URL, STATE_OFF, STATE_ON
...
@patch("smarthub.components.huawei_lte.Connection", MagicMock())
@patch(
    "smarthub.components.huawei_lte.Client",
...
async def test_turn_on_switch_wifi_guest_network(client, hass: SmartHub) -> None:
...
@patch("smarthub.components.huawei_lte.Connection", MagicMock())
@patch("smarthub.components.huawei_lte.Client")
async def test_turn_off_switch_wifi_guest_network(client, hass: SmartHub) -> None:
