...
from smarthub.components.conversation.models import (
    ConversationInput,
    ConversationResult,
)
...
@pytest.fixture
async def mock_chat_log(hass: SmartHub) -> AsyncGenerator[MockChatLog]:
    """Return mock chat logs."""
    # pylint: disable-next=contextmanager-generator-missing-cleanup
    with (
        patch(
            "smarthub.components.conversation.chat_log.ChatLog",
            MockChatLog,
        ),
