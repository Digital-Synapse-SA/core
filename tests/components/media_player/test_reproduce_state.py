...
from smarthub.components.media_player.reproduce_state import async_reproduce_states
...
async def test_state(hass: SmartHub, service, state, supported_feature) -> None:
...
async def test_turn_on_with_mode(hass: SmartHub) -> None:
...
async def test_multiple_same_state(hass: SmartHub) -> None:
...
async def test_multiple_different_state(hass: SmartHub) -> None:
...
async def test_attribute_no_state(hass: SmartHub) -> None:
...
async def test_attribute(
    hass: SmartHub, service, attribute, supported_feature
) -> None:
