...
MODULE = "smarthub.components.steamist"
...
async def test_form(hass: SmartHub) -> None:
    ...
    with (
        ...
        patch(
            "smarthub.components.steamist.config_flow.Steamist.async_get_status"
        ),
        patch(
            "smarthub.components.steamist.async_setup_entry",
            return_value=True,
        ) as mock_setup_entry,
    ):
...
async def test_form_with_discovery(hass: SmartHub) -> None:
...
async def test_discovered_by_dhcp(hass: SmartHub) -> None:
...
async def test_discovered_by_dhcp_discovery_fails(hass: SmartHub) -> None:
