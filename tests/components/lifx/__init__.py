...
from smarthub.components.lifx import discovery
from smarthub.components.lifx.const import TARGET_ANY

MODULE = "smarthub.components.lifx"
MODULE_CONFIG_FLOW = "smarthub.components.lifx.config_flow"
...
def _patch_device(device: Light | None = None, no_device: bool = False):
    ...
    @contextmanager
    def _patcher():
        with patch("smarthub.components.lifx.LIFXConnection", MockLifxConnecton):
            yield
...
def _patch_discovery(device: Light | None = None, no_device: bool = False):
    ...
    def _patcher():
        with (
            ...
            patch(
                "smarthub.components.lifx.discovery.LifxDiscovery",
                MockLifxDiscovery,
            ),
        ):
            yield
