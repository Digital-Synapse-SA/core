...
async def test_async_step_bluetooth_valid_device(hass: SmartHub) -> None:
    ...
    with patch("smarthub.components.aranet.async_setup_entry", return_value=True):
...
async def test_async_step_bluetooth_device_without_name(hass: SmartHub) -> None:
...
async def test_async_step_bluetooth_not_aranet4(hass: SmartHub) -> None:
...
async def test_async_step_user_takes_precedence_over_discovery(
    ...
    with patch(
        "smarthub.components.aranet.config_flow.async_discovered_service_info",
...
async def test_async_step_user_only_other_devices_found(hass: SmartHub) -> None:
...
async def test_async_step_user_old_firmware(hass: SmartHub) -> None:
...
async def test_async_step_user_integrations_disabled(hass: SmartHub) -> None:
...
async def test_user_setup_replaces_ignored_device(hass: SmartHub) -> None:
