...
async def test_support(hass: SmartHub, init_wyoming_stt) -> None:
...
async def test_streaming_audio(
    hass: SmartHub, init_wyoming_stt, metadata, snapshot: SnapshotAssertion
) -> None:
    ...
    with patch(
        "smarthub.components.wyoming.stt.AsyncTcpClient",
...
async def test_streaming_audio_connection_lost(
    hass: SmartHub, init_wyoming_stt, metadata
) -> None:
