...
from smarthub.components.streamlabswater import DOMAIN
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.streamlabswater.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_streamlabswater() -> Generator[AsyncMock]:
    ...
    with patch(
        "smarthub.components.streamlabswater.StreamlabsClient",
        return_value=mock,
    ) as mock_client:
        yield mock_client
