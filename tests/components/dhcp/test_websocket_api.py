...
from smarthub.components.dhcp import DOMAIN
...
async def test_subscribe_discovery(
    ...
    with (
        patch("smarthub.components.dhcp.aiodhcpwatcher.async_start", mock_start),
        patch("smarthub.components.dhcp.DiscoverHosts"),
    ):
