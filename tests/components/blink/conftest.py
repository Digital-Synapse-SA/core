...
from smarthub.components.blink.const import DOMAIN
...
def blink_api_fixture(camera) -> MagicMock:
    ...
    with patch("smarthub.components.blink.Blink") as class_mock:
...
def blink_auth_api_fixture() -> MagicMock:
    ...
    with patch("smarthub.components.blink.Auth", autospec=True) as class_mock:
