...
from smarthub.components.owntracks import helper


@pytest.fixture(name="nacl_imported")
def mock_nacl_imported():
    """Mock a successful import."""
    with patch("smarthub.components.owntracks.helper.nacl"):
        yield
...
def mock_nacl_not_imported():
    ...
    with patch("smarthub.components.owntracks.helper.nacl", new=None):
        yield
