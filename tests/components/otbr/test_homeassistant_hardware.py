"""Test SmartHub Hardware platform for OTBR."""
...
from smarthub.components.otbr.smarthub_hardware import async_get_firmware_info
...
async def test_get_firmware_info(hass: SmartHub) -> None:
    ...
    with (
        ...
        patch(
            "smarthub.components.otbr.smarthub_hardware.AddonManager",
        ),
        patch(
...
async def test_get_firmware_info_ignored(hass: SmartHub) -> None:
...
async def test_get_firmware_info_no_coprocessor_version(hass: SmartHub) -> None:
    ...
    otbr.runtime_data = AsyncMock()
    otbr.runtime_data.get_coprocessor_version.side_effect = SmartHubError()
...
async def test_get_firmware_info_remote_otbr(hass: SmartHub) -> None:
    """Test `async_get_firmware_info` with no coprocessor version support."""
