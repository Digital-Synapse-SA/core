...
def ha_controller_mock():
    """Mock SmartHubController."""
    with patch(
        "smarthub.components.cast.media_player.SmartHubController",
        MagicMock(),
...
def cast_mock(
    ...
    with (
        ...
        patch(
            "smarthub.components.cast.helpers.dial.get_cast_type",
            get_cast_type_mock,
        ),
        patch(
            "smarthub.components.cast.helpers.dial.get_multizone_status",
            get_multizone_status_mock,
        ),
        patch(
            "smarthub.components.cast.media_player.MultizoneManager",
            return_value=mz_mock,
        ),
        patch(
            "smarthub.components.cast.media_player.zeroconf.async_get_instance",
            AsyncMock(),
        ),
        patch(
            "smarthub.components.cast.media_player.quick_play",
            quick_play_mock,
        ),
        patch(
            "smarthub.components.cast.media_player.pychromecast.get_chromecast_from_cast_info",
            get_chromecast_mock,
        ),
    ):
        yield
