...
from smarthub.data_entry_flow import FlowResult
...
__all__ = ["SmartHubSnapshotExtension"]
...
class SmartHubSnapshotSerializer(AmberDataSerializer):
    """SmartHub snapshot serializer for Syrupy.

    Handles special cases for SmartHub data structures.
    """
    ...
    def _serialize(
        ...
        *,
        ...
        This allows us to handle specific cases for SmartHub data structures.
        """
    ...
    def _serializable_area_registry_entry(cls, data: ar.AreaEntry) -> SerializableData:
        """Prepare a SmartHub area registry entry for serialization."""
    ...
    def _serializable_config_entry(cls, data: ConfigEntry) -> SerializableData:
        """Prepare a SmartHub config entry for serialization."""
    ...
    def _serializable_device_registry_entry(
        ...
        """Prepare a SmartHub device registry entry for serialization."""
    ...
    def _serializable_entity_registry_entry(
        ...
        """Prepare a SmartHub entity registry entry for serialization."""
    ...
    def _serializable_issue_registry_entry(
        ...
        """Prepare a SmartHub issue registry entry for serialization."""
    ...
    def _serializable_state(cls, data: State) -> SerializableData:
        """Prepare a SmartHub State for serialization."""
...
class SmartHubSnapshotExtension(AmberSnapshotExtension):
    """SmartHub extension for Syrupy."""

    VERSION = "1"
    """Current version of serialization format.

    Need to be bumped when we change the SmartHubSnapshotSerializer.
    """

    serializer_class: type[AmberDataSerializer] = SmartHubSnapshotSerializer
    ...
    def dirname(cls, *, test_location: PyTestLocation) -> str:
        ...
        folder as the test file. For SmartHub, this is changed to just
