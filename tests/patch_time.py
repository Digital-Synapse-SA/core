...
# Do not add any SmartHub import here
...
# Before importing any other SmartHub functionality, import and replace
# partial dt_util.utcnow with a regular function which can be found by freezegun
from smarthub import util  # noqa: E402
from smarthub.util import dt as dt_util  # noqa: E402

dt_util.utcnow = _utcnow  # type: ignore[assignment]
util.utcnow = _utcnow  # type: ignore[assignment]


# Import other SmartHub functionality which we need to patch
from smarthub import runner  # noqa: E402
from smarthub.helpers import event as event_helper  # noqa: E402
